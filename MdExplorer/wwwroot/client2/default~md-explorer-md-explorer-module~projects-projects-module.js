...
class MdFileService {
    constructor(http) {
        ...
        this._mdFoldersDocument = new rxjs__WEBPACK_IMPORTED_MODULE_2__["BehaviorSubject"]([]);
    ...
    loadDynFolders(path, level) {
        ...
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpParams"]().set('path', path).set('level', String(level));
...
MdFileService.ɵfac = function MdFileService_Factory(t) { return new (t || MdFileService)(_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"])); };
