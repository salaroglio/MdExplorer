...
function loadPremiumModule() {
    return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
        try {
            ...
            const premiumCheckResponse = yield fetch('/client2/premium/main.js', { method: 'HEAD' });
            ...
            const premiumModule = yield loadModule(premiumPath);
...
const versionInfo = {
    version: '2025.10.15.5',
    buildTime: '2025.10.15 17:27:27'
};
