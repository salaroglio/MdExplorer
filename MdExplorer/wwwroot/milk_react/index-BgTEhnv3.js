import { L as s, E as R, a as Y, C as x } from "./index-BObMWTr1.js";
import { s as w, t as O, L as d, a as k, i as h, f, c as l, d as u, b as y, e as g, g as j, N as U, I as G } from "./integration-yhAlFHEe.js";
import { s as X, i as b, c as Z } from "./index-C4Pz1rll.js";
...
], S = /* @__PURE__ */ new U(), T = /* @__PURE__ */ new Set([
  "SourceFile",
  "Block",
  "FunctionDecl",
  "MethodDecl",
...
function m(Q, e) {
  ...
  return e.cursor(G.IncludeAnonymous).iterate((i) => {
    if (t)
      t = !1;
    else if (i.name) {
      let P = cO[i.name];
...
const p = /^[\w$\xa1-\uffff][\w$\d\xa1-\uffff]*$/, W = [
  ...
  let e = j(Q.state).resolveInner(Q.pos, -1);
