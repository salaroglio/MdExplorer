import { P as nt, j, k as v, T as st, l as xe, s as Ae, p as it, t as c, m as E, n as ot, o as at, q as lt, g as _, h as P, r as T, a as ae, u as ht, v as ft, w as ut, f as Be, i as dt, x as pt, y as ct, z as le, A as mt } from "./integration-yCXjdset.js";
import { C as gt } from "./index-Dk_lCZ3z.js";
import { html as kt, htmlCompletionSource as Lt } from "./index-D5yRqwqE.js";
class $ {
...
}, Ge = /* @__PURE__ */ at({ commentTokens: { block: { open: "<!--", close: "-->" } } }), Ve = /* @__PURE__ */ new v(), Ke = /* @__PURE__ */ vt.configure({
  props: [
...
function ie(t) {
  return new ot(Ge, t, [Gt], "markdown");
}
...
function lr(t = {}) {
  ...
  a.push(yt({ codeParser: h, htmlParser: o.language.parser })), n && l.push(ht.high(ft.of(rr)));
...
function sr() {
  if (V)
    return V;
  let t = Lt(new gt(ct.create({ extensions: et }), 0, !0));
