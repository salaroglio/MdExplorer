...
`, Go = (t, e = {}) => {
  t.config(async (r) => {
    ...
    if (!n) {
      const { languages: i } = await import("./integration-Fz_xek3V.js").then((s) => s.bM);
      n = i;
    }
    if (!o) {
      const { oneDark: i } = await import("./index-BM5PXEfg.js");
      o = i;
    }
    r.update(Fn.key, (i) => {
      var s;
