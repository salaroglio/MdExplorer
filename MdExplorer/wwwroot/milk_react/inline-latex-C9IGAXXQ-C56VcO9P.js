import { aP as pa } from "./integration-UpWIHG9l.js";
class u0 {
...
var va = function(e, t) {
  ...
  return e === void 0 ? t : e;
}, ba = /([A-Z])/g, ya = function(e) {
  return e.replace(ba, "-$1").toLowerCase();
}, xa = {
  "&": "&amp;",
  ">": "&gt;",
  "<": "&lt;",
...
function ka(r) {
  return String(r).replace(wa, (e) => xa[e]);
}
var gr = function r(e) {
  ...
  constructor(e) {
    ...
    for (var t in Ae)
      if (Ae.hasOwnProperty(t)) {
        var a = Ae[t];
        this[t] = e[t] !== void 0 ? a.processor ? a.processor(e[t]) : e[t] : Aa(a);
      }
  }
  /**
...
class F0 {
   ...
   */
  cramp() {
    return y0[Na[this.id]];
  }
  /**
   * Get a text or display version of this style.
   */
  text() {
    return y0[qa[this.id]];
  }
  /**
...
var pt = 0, Be = 1, ee = 2, B0 = 3, le = 4, d0 = 5, te = 6, n0 = 7, y0 = [new F0(pt, 0, !1), new F0(Be, 0, !0), new F0(ee, 1, !1), new F0(B0, 1, !0), new F0(le, 2, !1), new F0(d0, 2, !0), new F0(te, 3, !1), new F0(n0, 3, !0)], Ta = [le, d0, le, d0, te, n0, te, n0], Ba = [d0, d0, d0, d0, n0, n0, n0, n0], Da = [ee, B0, le, d0, te, n0, te, n0], Ca = [B0, B0, d0, d0, n0, n0, n0, n0], Na = [Be, Be, B0, B0, d0, d0, n0, n0], qa = [pt, Be, ee, B0, ee, B0, ee, B0], R = {
  DISPLAY: y0[pt],
  TEXT: y0[ee],
  SCRIPT: y0[le],
  SCRIPTSCRIPT: y0[te]
...
function Ea(r) {
  for (var e = 0; e < it.length; e++)
    for (var t = it[e], a = 0; a < t.blocks.length; a++) {
      var n = t.blocks[a];
      if (r >= n[0] && r <= n[1])
        return t.name;
    }
...
var Te = [];
it.forEach((r) => r.blocks.forEach((e) => Te.push(...e)));
function br(r) {
...
function vt(r, e, t) {
  ...
  if (!n && r[0] in Ht && (a = Ht[r[0]].charCodeAt(0), n = x0[e][a]), !n && t === "text" && br(a) && (n = x0[e][77]), n)
    return {
      depth: n[0],
      height: n[1],
      italic: n[2],
...
var Xa = [
  ...
  return t.size < 2 ? e : Xa[e - 1][t.size - 1];
};
class T0 {
   ...
   */
  constructor(e) {
    this.style = void 0, this.color = void 0, this.size = void 0, this.textSize = void 0, this.phantom = void 0, this.font = void 0, this.fontFamily = void 0, this.fontWeight = void 0, this.fontShape = void 0, this.sizeMultiplier = void 0, this.maxSize = void 0, this.minRuleThickness = void 0, this._fontMetrics = void 0, this.style = e.style, this.color = e.color, this.size = e.size || T0.BASESIZE, this.textSize = e.textSize || this.size, this.phantom = !!e.phantom, this.font = e.font || "", this.fontFamily = e.fontFamily || "", this.fontWeight = e.fontWeight || "", this.fontShape = e.fontShape || "", this.sizeMultiplier = Lt[this.size - 1], this.maxSize = e.maxSize, this.minRuleThickness = e.minRuleThickness, this._fontMetrics = void 0;
  }
  /**
   ...
   */
  fontMetrics() {
    return this._fontMetrics || (this._fontMetrics = Ya(this.size)), this._fontMetrics;
  }
  /**
...
var st = {
  ...
  return typeof e != "string" && (e = e.unit), e in st || e in Wa || e === "ex";
}, K = function(e, t) {
  var a;
  if (e.unit in st)
...
class he {
  constructor(e, t, a, n) {
    this.children = void 0, this.attributes = void 0, this.classes = void 0, this.height = void 0, this.depth = void 0, this.width = void 0, this.maxFontSize = void 0, this.style = void 0, xr.call(this, e, a, n), this.children = t || [];
  }
  /**
...
class gt {
  constructor(e, t, a, n) {
    this.children = void 0, this.attributes = void 0, this.classes = void 0, this.height = void 0, this.depth = void 0, this.maxFontSize = void 0, this.style = void 0, xr.call(this, t, n), this.children = a || [], this.setAttribute("href", e);
  }
  setAttribute(e, t) {
    this.attributes[e] = t;
  }
...
class p0 {
  constructor(e, t, a, n, s, o, h, c) {
    ...
    var p = Ea(this.text.charCodeAt(0));
    p && this.classes.push(p + "_fallback"), /[îïíì]/.test(this.text) && (this.text = Ka[this.text]);
  }
  hasClass(e) {
    return q.contains(this.classes, e);
  }
...
var l = "math", k = "text", u = "main", d = "ams", W = "accent-token", D = "bin", i0 = "close", re = "inner", E = "mathord", _ = "op-token", m0 = "open", Ee = "punct", f = "rel", E0 = "spacing", v = "textord";
i(l, u, f, "≡", "\\equiv", !0);
i(l, u, f, "≺", "\\prec", !0);
i(l, u, f, "≻", "\\succ", !0);
i(l, u, f, "∼", "\\sim", !0);
...
var ye = [
  ...
  return X[a][e] && X[a][e].replace && (e = X[a][e].replace), {
    value: e,
    metrics: vt(e, t, a)
  };
}, b0 = function(e, t, a, n, s) {
  var o = Re(e, t, a), h = o.metrics;
  e = o.value;
  var c;
  if (h) {
    var p = h.italic;
  ...
  return n === void 0 && (n = []), a.font === "boldsymbol" && Re(e, "Main-Bold", t).metrics ? b0(e, "Main-Bold", t, a, n.concat(["mathbf"])) : e === "\\" || X[t][e].font === "main" ? b0(e, "Main-Regular", t, a, n) : b0(e, "AMS-Regular", t, a, n.concat(["amsrm"]));
  ...
  if (s.charCodeAt(0) === 55349 && ([p, g] = e1(s, n)), p.length > 0)
  ...
  if (c) {
    ...
    } else h ? (y = Ar[c].fontName, w = [c]) : (y = xe(c, t.fontWeight, t.fontShape), w = [c, t.fontWeight, t.fontShape]);
    if (Re(s, y, n).metrics)
      return b0(s, y, n, t, o.concat(w));
    if (Sr.hasOwnProperty(s) && y.slice(0, 10) === "Typewriter") {
  ...
  for (var e = 0; e < r.length - 1; e++) {
    var t = r[e], a = r[e + 1];
    t instanceof p0 && a instanceof p0 && n1(t, a) && (t.text += a.text, t.height = Math.max(t.height, a.height), t.depth = Math.max(t.depth, a.depth), t.italic = a.italic, r.splice(e + 1, 1), e--);
  }
  return r;
}, bt = function(e) {
  ...
  return bt(s), s;
}, Mr = (r, e, t, a) => new he(r, e, t, a), s1 = function(e, t, a) {
  var n = l0([e], [], t);
  ...
  var [a, n, s] = Tr[e], o = new G0(a), h = new C0([o], {
    width: A(n),
    height: A(s),
...
var qe = function(e) {
...
}, N0 = b.makeSpan, p1 = ["leftmost", "mbin", "mopen", "mrel", "mop", "mpunct"], v1 = ["rightmost", "mrel", "mclose", "mpunct"], g1 = {
  display: R.DISPLAY,
  text: R.TEXT,
  script: R.SCRIPT,
  ...
  if (e.length === 1) {
    var g = e[0];
    g.type === "sizing" ? p = t.havingSize(g.size) : g.type === "styling" && (p = t.havingStyle(g1[g.style]));
  }
  var y = N0([n[0] || "leftmost"], [], t), w = N0([n[1] || "rightmost"], [], t), x = a === "root";
  return Wt(s, (z, T) => {
    var C = T.classes[0], N = z.classes[0];
    C === "mbin" && q.contains(v1, N) ? T.classes[0] = "mord" : N === "mbin" && q.contains(p1, C) && (z.classes[0] = "mord");
  }, {
    node: y
  }, w, x), Wt(s, (z, T) => {
    var C = ut(T), N = ut(z), O = C && N ? z.hasClass("mtight") ? f1[C][N] : d1[C][N] : null;
    if (O)
      return b.makeGlue(O, p);
  }, {
    node: y
  }, w, x), s;
}, Wt = function r(e, t, a, n, s) {
  n && e.push(n);
  ...
  return e instanceof ue || e instanceof gt || e instanceof he && e.hasClass("enclosing") ? e : null;
}, y1 = function r(e, t) {
  var a = Dr(e);
  if (a) {
    var n = a.children;
...
var S = {
  ...
  TextNode: w0,
  SpaceNode: x1,
  newDocumentFragment: Cr
}, v0 = function(e, t, a) {
  return X[t][e] && X[t][e].replace && e.charCodeAt(0) !== 55349 && !(Sr.hasOwnProperty(e) && a && (a.fontFamily && a.fontFamily.slice(4, 6) === "tt" || a.font && a.font.slice(4, 6) === "tt")) && (e = X[t][e].replace), new S.TextNode(e);
}, yt = function(e) {
  ...
  return vt(s, o, n) ? b.fontMap[a].variant : null;
};
function Ze(r) {
  if (!r)
    return !1;
  ...
  for (var s = [], o, h = 0; h < e.length; h++) {
    ...
    if (c instanceof h0 && o instanceof h0) {
      if (c.type === "mtext" && o.type === "mtext" && c.getAttribute("mathvariant") === o.getAttribute("mathvariant")) {
        ...
        o.children.push(...c.children);
        continue;
      } else if (Ze(c) && o.type === "mn") {
        o.children.push(...c.children);
        continue;
      } else if (c.type === "mn" && Ze(o))
        c.children = [...o.children, ...c.children], s.pop();
      else if ((c.type === "msup" || c.type === "msub") && c.children.length >= 1 && (o.type === "mn" || Ze(o))) {
        var p = c.children[0];
...
var Nr = function(e) {
  ...
  if (a.output === "html") {
    ...
    var h = jt(e, t, n, a.displayMode, !1), c = ht(e, n);
    s = b.makeSpan(["katex"], [h, c]);
  }
  return qr(s, a);
}, k1 = function(e, t, a) {
  var n = Nr(a), s = ht(e, n), o = b.makeSpan(["katex"], [s]);
  return qr(o, a);
}, S1 = {
  widehat: "^",
  widecheck: "ˇ",
  ...
  var t = new S.MathNode("mo", [new S.TextNode(S1[e.replace(/^\\/, "")])]);
  ...
  function a() {
    ...
    if (q.contains(["widehat", "widecheck", "widetilde", "utilde"], c)) {
      ...
      var N = [], O = z1[c], [F, V, L] = O, U = L / 1e3, G = F.length, j, $;
      if (G === 1) {
        var z0 = O[3];
        j = ["hide-tail"], $ = [z0];
      } else if (G === 2)
      ...
      for (var r0 = 0; r0 < G; r0++) {
        var e0 = new G0(F[r0]), $0 = new C0([e0], {
          width: "400em",
          height: A(U),
          viewBox: "0 0 " + h + " " + L,
          preserveAspectRatio: $[r0] + " slice"
        }), s0 = b.makeSvgSpan([j[r0]], [$0], t);
        if (G === 1)
          return {
            span: s0,
            minWidth: V,
  ...
  if (/fbox|color|angl/.test(t)) {
    ...
    var p = [];
    /^[bx]cancel$/.test(t) && p.push(new lt({
      x1: "0",
      y1: "0",
      x2: "100%",
      y2: "100%",
      "stroke-width": "0.046em"
    })), /^x?cancel$/.test(t) && p.push(new lt({
      x1: "0",
      y1: "100%",
      x2: "100%",
      y2: "0",
...
var kt = (r, e) => {
  var t, a, n;
  r && r.type === "supsub" ? (a = H(r.base, "accent"), t = a.base, r.base = t, n = Ja(P(r, e)), r.base = a) : (a = H(r, "accent"), t = a.base);
  ...
  if (a.isStretchy)
    ...
    a.label === "\\vec" ? (x = b.staticSvg("vec", e), z = b.svgData.vec[1]) : (x = b.makeOrd({
      mode: a.mode,
      text: a.label
    }, e, "textord"), x = Gt(x), x.italic = 0, z = x.width, g && (y += x.depth)), w = b.makeSpan(["accent-body"], [x]);
  ...
  var t = r.isStretchy ? q0.mathMLnode(r.label) : new S.MathNode("mo", [v0(r.label, r.mode)]), a = new S.MathNode("mover", [Y(r.base, e), t]);
  return a.setAttribute("accent", "true"), a;
}, D1 = new RegExp(["\\acute", "\\grave", "\\ddot", "\\tilde", "\\bar", "\\breve", "\\check", "\\hat", "\\vec", "\\dot", "\\mathring"].map((r) => "\\" + r).join("|"));
B({
  type: "accent",
  ...
  handler: (r, e) => {
    var t = qe(e[0]), a = !D1.test(r.funcName), n = !a || r.funcName === "\\widehat" || r.funcName === "\\widetilde" || r.funcName === "\\widecheck";
    return {
      type: "accent",
      mode: r.parser.mode,
      label: r.funcName,
...
B({
  ...
  mathmlBuilder: (r, e) => {
    var t = q0.mathMLnode(r.label), a = new S.MathNode("munder", [Y(r.base, e), t]);
...
var N1 = {
  ...
  mode: "math",
  style: "display"
}), Kt = (r) => r.type === "textord" && r.text === "@", q1 = (r, e) => (r.type === "mathord" || r.type === "atom") && r.text === e;
function E1(r, e, t) {
  var a = N1[r];
  switch (a) {
    case "\\\\cdrightarrow":
...
function R1(r) {
  ...
  for (var a = [], n = [a], s = 0; s < e.length; s++) {
    for (var o = e[s], h = Zt(), c = 0; c < o.length; c++)
      if (!Kt(o[c]))
        h.body.push(o[c]);
      else {
        a.push(h), c += 1;
        var p = wt(o[c]).text, g = new Array(2);
        if (g[0] = {
          type: "ordgroup",
          mode: "math",
          body: []
...
B({
  ...
  handler(r) {
    ...
    var a = e.fetch();
    if (mt[a.text])
      return (t === "\\global" || t === "\\\\globallong") && (a.text = mt[a.text]), H(e.parseFunction(), "internal");
...
B({
  ...
  handler(r) {
    var {
      parser: e,
      funcName: t
    } = r, a = Hr(e.gullet.popToken());
    e.gullet.consumeSpaces();
    var n = I1(e);
    return Lr(e, a, n, t === "\\\\globallet"), {
      type: "internal",
      mode: e.mode
    };
  }
...
B({
  ...
  handler(r) {
    var {
      parser: e,
      funcName: t
    } = r, a = Hr(e.gullet.popToken()), n = e.gullet.popToken(), s = e.gullet.popToken();
    return Lr(e, a, s, t === "\\\\globalfuture"), e.gullet.pushToken(s), e.gullet.pushToken(n), {
      type: "internal",
      mode: e.mode
    };
  }
...
var ie = function(e, t, a) {
  var n = X.math[e] && X.math[e].replace, s = vt(n || e, t, a);
  if (!s)
...
}, O1 = function(e, t, a, n, s, o) {
  var h = b.makeSymbol(e, "Main-Regular", s, n), c = St(h, t, n, o);
  return a && Pr(c, n, t), c;
}, F1 = function(e, t, a, n) {
  return b.makeSymbol(e, "Size" + t + "-Regular", a, n);
}, Gr = function(e, t, a, n, s, o) {
  var h = F1(e, t, s, n), c = St(b.makeSpan(["delimsizing", "size" + t], [h], n), R.TEXT, n, o);
  return a && Pr(c, n, R.TEXT), c;
}, Ke = function(e, t, a) {
  var n;
  ...
  var n = x0["Size4-Regular"][e.charCodeAt(0)] ? x0["Size4-Regular"][e.charCodeAt(0)][4] : x0["Size1-Regular"][e.charCodeAt(0)][4], s = new G0("inner", Va(e, Math.round(1e3 * t))), o = new C0([s], {
    width: A(n),
    height: A(t),
    // Override CSS rule `.katex svg { width: 100% }`
    style: "width:" + A(n),
  ...
  type: "kern",
  size: -1 * ct
}, H1 = ["|", "\\lvert", "\\rvert", "\\vert"], L1 = ["\\|", "\\lVert", "\\rVert", "\\Vert"], Vr = function(e, t, a, n, s, o) {
  var h, c, p, g, y = "", w = 0;
  h = p = g = e, c = null;
  var x = "Size1-Regular";
  e === "\\uparrow" ? p = g = "⏐" : e === "\\Uparrow" ? p = g = "‖" : e === "\\downarrow" ? h = p = "⏐" : e === "\\Downarrow" ? h = p = "‖" : e === "\\updownarrow" ? (h = "\\uparrow", p = "⏐", g = "\\downarrow") : e === "\\Updownarrow" ? (h = "\\Uparrow", p = "‖", g = "\\Downarrow") : q.contains(H1, e) ? (p = "∣", y = "vert", w = 333) : q.contains(L1, e) ? (p = "∥", y = "doublevert", w = 556) : e === "[" || e === "\\lbrack" ? (h = "⎡", p = "⎢", g = "⎣", x = "Size4-Regular", y = "lbrack", w = 667) : e === "]" || e === "\\rbrack" ? (h = "⎤", p = "⎥", g = "⎦", x = "Size4-Regular", y = "rbrack", w = 667) : e === "\\lfloor" || e === "⌊" ? (p = h = "⎢", g = "⎣", x = "Size4-Regular", y = "lfloor", w = 667) : e === "\\lceil" || e === "⌈" ? (h = "⎡", p = g = "⎢", x = "Size4-Regular", y = "lceil", w = 667) : e === "\\rfloor" || e === "⌋" ? (p = h = "⎥", g = "⎦", x = "Size4-Regular", y = "rfloor", w = 667) : e === "\\rceil" || e === "⌉" ? (h = "⎤", p = g = "⎥", x = "Size4-Regular", y = "rceil", w = 667) : e === "(" || e === "\\lparen" ? (h = "⎛", p = "⎜", g = "⎝", x = "Size4-Regular", y = "lparen", w = 875) : e === ")" || e === "\\rparen" ? (h = "⎞", p = "⎟", g = "⎠", x = "Size4-Regular", y = "rparen", w = 875) : e === "\\{" || e === "\\lbrace" ? (h = "⎧", c = "⎨", g = "⎩", p = "⎪", x = "Size4-Regular") : e === "\\}" || e === "\\rbrace" ? (h = "⎫", c = "⎬", g = "⎭", p = "⎪", x = "Size4-Regular") : e === "\\lgroup" || e === "⟮" ? (h = "⎧", g = "⎩", p = "⎪", x = "Size4-Regular") : e === "\\rgroup" || e === "⟯" ? (h = "⎫", g = "⎭", p = "⎪", x = "Size4-Regular") : e === "\\lmoustache" || e === "⎰" ? (h = "⎧", g = "⎭", p = "⎪", x = "Size4-Regular") : (e === "\\rmoustache" || e === "⎱") && (h = "⎫", g = "⎩", p = "⎪", x = "Size4-Regular");
  var z = ie(h, x, s), T = z.height + z.depth, C = ie(p, x, s), N = C.height + C.depth, O = ie(g, x, s), F = O.height + O.depth, V = 0, L = 1;
  if (c !== null) {
    var U = ie(c, x, s);
    V = U.height + U.depth, L = 2;
  }
  var G = T + F + V, j = Math.max(0, Math.ceil((t - G) / (L * N))), $ = G + j * L * N, z0 = n.fontMetrics().axisHeight;
  a && (z0 *= n.sizeMultiplier);
  var r0 = $ / 2 - z0, e0 = [];
  if (y.length > 0) {
    var $0 = $ - T - F, s0 = Math.round($ * 1e3), g0 = Ua(y, Math.round($0 * 1e3)), R0 = new G0(y, g0), j0 = (w / 1e3).toFixed(3) + "em", Z0 = (s0 / 1e3).toFixed(3) + "em", Pe = new C0([R0], {
      width: j0,
      height: Z0,
      viewBox: "0 0 " + w + " " + s0
    }), I0 = b.makeSvgSpan([], [Pe], n);
    I0.height = s0 / 1e3, I0.style.width = j0, I0.style.height = Z0, e0.push({
      type: "elem",
      elem: I0
    });
  } else {
    if (e0.push(Ke(g, x, s)), e0.push(Se), c === null) {
      var O0 = $ - T - F + 2 * ct;
      e0.push(Je(p, O0, n));
    } else {
      var c0 = ($ - T - F - V) / 2 + 2 * ct;
      e0.push(Je(p, c0, n)), e0.push(Se), e0.push(Ke(c, x, s)), e0.push(Se), e0.push(Je(p, c0, n));
    }
    e0.push(Se), e0.push(Ke(h, x, s));
  }
  var ne = n.havingBaseStyle(R.TEXT), Ge = b.makeVList({
    positionType: "bottom",
    positionData: r0,
    children: e0
  }, ne);
  return St(b.makeSpan(["delimsizing", "mult"], [Ge], ne), R.TEXT, n, o);
}, Qe = 80, _e = 0.08, et = function(e, t, a, n, s) {
  var o = Ga(e, n, a), h = new G0(e, o), c = new C0([h], {
  ...
  return n.type === "small" ? (g = 1e3 + 1e3 * o + Qe, e < 1 ? s = 1 : e < 1.4 && (s = 0.7), c = (1 + o + _e) / s, p = (1 + o) / s, h = et("sqrtMain", c, g, o, t), h.style.minWidth = "0.853em", y = 0.833 / s) : n.type === "large" ? (g = (1e3 + Qe) * se[n.size], p = (se[n.size] + o) / s, c = (se[n.size] + o + _e) / s, h = et("sqrtSize" + n.size, c, g, o, t), h.style.minWidth = "1.02em", y = 1 / s) : (c = e + o + _e, p = e + o, g = Math.floor(1e3 * e + o) + Qe, h = et("sqrtTall", c, g, o, t), h.style.minWidth = "0.742em", y = 1.056), h.height = p, h.style.height = A(c), {
    span: h,
    advanceWidth: y,
...
}, Ur = ["(", "\\lparen", ")", "\\rparen", "[", "\\lbrack", "]", "\\rbrack", "\\{", "\\lbrace", "\\}", "\\rbrace", "\\lfloor", "\\rfloor", "⌊", "⌋", "\\lceil", "\\rceil", "⌈", "⌉", "\\surd"], G1 = ["\\uparrow", "\\downarrow", "\\updownarrow", "\\Uparrow", "\\Downarrow", "\\Updownarrow", "|", "\\|", "\\vert", "\\Vert", "\\lvert", "\\rvert", "\\lVert", "\\rVert", "\\lgroup", "\\rgroup", "⟮", "⟯", "\\lmoustache", "\\rmoustache", "⎰", "⎱"], $r = ["<", ">", "\\langle", "\\rangle", "/", "\\backslash", "\\lt", "\\gt"], se = [0, 1.2, 1.8, 2.4, 3], V1 = function(e, t, a, n, s) {
  if (e === "<" || e === "\\lt" || e === "⟨" ? e = "\\langle" : (e === ">" || e === "\\gt" || e === "⟩") && (e = "\\rangle"), q.contains(Ur, e) || q.contains($r, e))
    return Gr(e, t, !1, a, n, s);
  if (q.contains(G1, e))
  ...
  for (var s = Math.min(2, 3 - n.style.size), o = s; o < a.length && a[o].type !== "stack"; o++) {
    var h = ie(e, Y1(a[o]), "math"), c = h.height + h.depth;
    if (a[o].type === "small") {
  ...
  return a[a.length - 1];
}, Wr = function(e, t, a, n, s, o) {
  e === "<" || e === "\\lt" || e === "⟨" ? e = "\\langle" : (e === ">" || e === "\\gt" || e === "⟩") && (e = "\\rangle");
  var h;
  q.contains($r, e) ? h = U1 : q.contains(Ur, e) ? h = Yr : h = $1;
  var c = Xr(e, t, h, n);
  return c.type === "small" ? O1(e, c.style, a, n, s, o) : c.type === "large" ? Gr(e, c.size, a, n, s, o) : Vr(e, t, a, n, s, o);
}, X1 = function(e, t, a, n, s, o) {
...
}, W1 = ["(", "\\lparen", ")", "\\rparen", "[", "\\lbrack", "]", "\\rbrack", "\\{", "\\lbrace", "\\}", "\\rbrace", "\\lfloor", "\\rfloor", "⌊", "⌋", "\\lceil", "\\rceil", "⌈", "⌉", "<", ">", "\\langle", "⟨", "\\rangle", "⟩", "\\lt", "\\gt", "\\lvert", "\\rvert", "\\lVert", "\\rVert", "\\lgroup", "\\rgroup", "⟮", "⟯", "\\lmoustache", "\\rmoustache", "⎰", "⎱", "/", "\\backslash", "|", "\\vert", "\\|", "\\Vert", "\\uparrow", "\\Uparrow", "\\downarrow", "\\Downarrow", "\\updownarrow", "\\Updownarrow", "."];
function Fe(r, e) {
  var t = Ie(r);
  if (t && q.contains(W1, t.text))
    return t;
...
B({
  ...
  handler: (r, e) => {
    ...
    return {
      type: "delimsizing",
      mode: r.parser.mode,
      size: Jt[r.funcName].size,
      mclass: Jt[r.funcName].mclass,
      delim: t.text
    };
  },
...
var Mt = (r, e) => {
  ...
  if (a === "sout")
    ...
    var w = Math.floor(1e3 * y * n), x = La(w), z = new C0([new G0("phase", x)], {
      width: "400em",
      height: A(w / 1e3),
  ...
  var t = 0, a = new S.MathNode(r.label.indexOf("colorbox") > -1 ? "mpadded" : "menclose", [Y(r.body, e)]);
  switch (r.label) {
    case "\\cancel":
...
function U0(r, e, t) {
  ...
  for (F(), N.push(_t(r)); ; ) {
    ...
    if (U === "&") {
      ...
      r.consume();
      var G = void 0;
      r.gullet.future().text !== " " && (G = r.parseSizeGroup(!0)), C.push(G ? G.value : null), V(), N.push(_t(r)), z = [], T.push(z), F();
    } else
...
var S0 = function(e, t) {
  ...
  for (V(o[0]), a = 0; a < e.body.length; ++a) {
    ...
    z0 && (r0 = K(z0, t), r0 > 0 && (r0 += O, G < r0 && (G = r0), r0 = 0)), e.addJot && (G += T), j.height = U, j.depth = G, F += U, j.pos = F, F += G + r0, c[a] = j, V(o[a + 1]);
  }
  var e0 = F / 2 + t.fontMetrics().axisHeight, $0 = e.cols || [], s0 = [], g0, R0, j0 = [];
  if (e.tags && e.tags.some((fe) => fe))
    for (a = 0; a < s; ++a) {
      var Z0 = c[a], Pe = Z0.pos - e0, I0 = e.tags[a], O0 = void 0;
      I0 === !0 ? O0 = b.makeSpan(["eqn-num"], [], t) : I0 === !1 ? O0 = b.makeSpan([], [], t) : O0 = b.makeSpan([], t0(I0, t, !0), t), O0.depth = Z0.depth, O0.height = Z0.height, j0.push({
        type: "elem",
        elem: O0,
        shift: Pe
      });
  ...
  for (
    ...
    for (var c0 = $0[R0] || {}, ne = !0; c0.type === "separator"; ) {
      if (ne || (g0 = b.makeSpan(["arraycolsep"], []), g0.style.width = A(t.fontMetrics().doubleRuleSep), s0.push(g0)), c0.separator === "|" || c0.separator === ":") {
        var Ge = c0.separator === "|" ? "solid" : "dashed", K0 = b.makeSpan(["vertical-separator"], [], t);
        K0.style.height = A(F), K0.style.borderRightWidth = A(g), K0.style.borderRightStyle = Ge, K0.style.margin = "0 " + A(-g / 2);
        var Rt = F - e0;
  ...
  if (c = b.makeSpan(["mtable"], s0), p.length > 0) {
    for (var da = b.makeLineSpan("hline", t, g), fa = b.makeLineSpan("hdashline", t, g), Ve = [{
      type: "elem",
      elem: c,
      shift: 0
    }]; p.length > 0; ) {
      var It = p.pop(), Ot = It.pos - e0;
      It.isDashed ? Ve.push({
        type: "elem",
        elem: fa,
        shift: Ot
  ...
  return Ue = b.makeSpan(["tag"], [Ue], t), b.makeFragment([c, Ue]);
}, j1 = {
  c: "center ",
  l: "left ",
  r: "right "
  ...
  if (e.cols && e.cols.length > 0) {
    ...
    for (var F = N; F < O; F++)
      z[F].type === "align" ? (x += j1[z[F].align], C && (T += "none "), C = !0) : z[F].type === "separator" && C && (T += z[F].separator === "|" ? "solid " : "dashed ", C = !1);
...
k0({
  ...
  handler(r, e) {
    var t = Ie(e[0]), a = t ? [e[0]] : H(e[0], "ordgroup").body, n = a.map(function(o) {
      var h = wt(o), c = h.text;
      if ("lcr".indexOf(c) !== -1)
        return {
          type: "align",
    ...
    return U0(r.parser, s, Tt(r.envName));
  },
  htmlBuilder: S0,
  mathmlBuilder: M0
});
k0({
  ...
  handler(r) {
    ...
    var s = U0(r.parser, a, Tt(r.envName)), o = Math.max(0, ...s.body.map((h) => h.length));
...
var _r = (r, e) => {
  ...
  var t = _r(r.size, e.style), a = t.fracNum(), n = t.fracDen(), s;
  s = e.havingStyle(a);
  var o = P(r.numer, s, e);
  if (r.continued) {
...
var rr = ["display", "text", "script", "scriptscript"], ar = function(e) {
  var t = null;
...
B({
  ...
  handler(r, e) {
    var {
      parser: t
    } = r, a = e[4], n = e[5], s = qe(e[0]), o = s.type === "atom" && s.family === "open" ? ar(s.text) : null, h = qe(e[1]), c = h.type === "atom" && h.family === "close" ? ar(h.text) : null, p = H(e[2], "size"), g, y = null;
    ...
    if (x.type === "ordgroup") {
      ...
      x = H(x, "textord"), w = rr[Number(x.text)];
    return {
      type: "genfrac",
      mode: t.mode,
      numer: a,
...
B({
  ...
  handler: (r, e) => {
    var {
      parser: t,
      funcName: a
    } = r, n = e[0], s = Ma(H(e[1], "infix").size), o = e[2], h = s.number > 0;
    return {
      type: "genfrac",
      mode: t.mode,
      numer: n,
...
var ta = (r, e, t, a, n, s, o) => {
  ...
  var o = e.style, h = !1;
  o.size === R.DISPLAY.size && s.symbol && !q.contains(ra, s.name) && (h = !0);
  var c;
  if (s.symbol) {
  ...
  var C = 0, N = 0;
  return (c instanceof p0 || s.name === "\\oiint" || s.name === "\\oiiint") && !s.suppressBaseShift && (C = (c.height - c.depth) / 2 - e.fontMetrics().axisHeight, N = c.italic), n ? ta(c, t, a, e, o, N, C) : (C && (c.style.position = "relative", c.style.top = A(C)), c);
}, me = (r, e) => {
  var t;
  if (r.symbol)
    t = new h0("mo", [v0(r.name, r.mode)]), q.contains(ra, r.name) && t.setAttribute("largeop", "false");
  else if (r.body)
    t = new h0("mo", o0(r.body, e));
  else {
    t = new h0("mi", [new w0(r.name.slice(1))]);
    var a = new h0("mo", [v0("⁡", "text")]);
    r.parentIsSupSub ? t = new h0("mrow", [t, a]) : t = Cr([t, a]);
  }
  return t;
}, K1 = {
  "∏": "\\prod",
...
var aa = (r, e) => {
  ...
  if (s.body.length > 0) {
    ...
    o = b.makeSpan(["mop"], [], e);
  return n ? ta(o, t, a, e, e.style, 0, 0) : o;
}, Q1 = (r, e) => {
...
B({
  ...
  mathmlBuilder(r, e) {
    var t = new S.MathNode("mpadded", [Y(r.body, e)]), a = r.dy.number + r.dy.unit;
...
var ir = ["\\tiny", "\\sixptsize", "\\scriptsize", "\\footnotesize", "\\small", "\\normalsize", "\\large", "\\Large", "\\LARGE", "\\huge", "\\Huge"], _1 = (r, e) => {
  var t = e.havingSize(r.size);
  return na(r.body, t, e);
};
B({
  type: "sizing",
  names: ir,
...
B({
  ...
  htmlBuilder(r, e) {
    var t = sr[r.style], a = e.havingStyle(t).withFont("");
    return na(r.body, a, e);
  },
  mathmlBuilder(r, e) {
    var t = sr[r.style], a = e.havingStyle(t), n = o0(r.body, a), s = new S.MathNode("mstyle", n), o = {
      display: ["0", "true"],
      text: ["0", "false"],
      script: ["1", "false"],
...
var e4 = function(e, t) {
  ...
  if (a)
    if (a.type === "op") {
      ...
      if (a.type === "accent")
        return q.isCharacterBox(a.base) ? kt : null;
      if (a.type === "horizBrace") {
        var o = !e.sub;
        return o === a.isOver ? ea : null;
      } else
        return null;
    }
  else return null;
...
W0({
  ...
  mathmlBuilder(r, e) {
    var t = new S.MathNode("mi", [v0(r.text, r.mode, e)]), a = xt(r, e) || "italic";
    return a !== ia[t.type] && t.setAttribute("mathvariant", a), t;
  }
});
W0({
  type: "textord",
  ...
  mathmlBuilder(r, e) {
    var t = v0(r.text, r.mode, e), a = xt(r, e) || "normal", n;
    return r.mode === "text" ? n = new S.MathNode("mtext", [t]) : /[0-9]/.test(r.text) ? n = new S.MathNode("mn", [t]) : r.text === "\\prime" ? n = new S.MathNode("mo", [t]) : n = new S.MathNode("mi", [t]), a !== ia[n.type] && n.setAttribute("mathvariant", a), n;
  }
});
var rt = {
  "\\nobreak": "nobreak",
  ...
  htmlBuilder(r, e) {
    if (at.hasOwnProperty(r.text)) {
      ...
      if (rt.hasOwnProperty(r.text))
        return b.makeSpan(["mspace", rt[r.text]], [], e);
...
W0({
  type: "tag",
  mathmlBuilder(r, e) {
    var t = new S.MathNode("mtable", [new S.MathNode("mtr", [lr(), new S.MathNode("mtd", [V0(r.body, e)]), lr(), new S.MathNode("mtd", [V0(r.tag, e)])])]);
...
B({
  ...
  htmlBuilder(r, e) {
    for (var t = mr(r), a = [], n = e.havingStyle(e.style.text()), s = 0; s < t.length; s++) {
      var o = t[s];
  ...
  mathmlBuilder(r, e) {
    var t = new S.TextNode(mr(r)), a = new S.MathNode("mtext", [t]);
    return a.setAttribute("mathvariant", "monospace"), a;
  }
});
var mr = (r) => r.body.replace(/ /g, r.star ? "␣" : " "), L0 = Br, sa = `[ \r
	]`, r4 = "\\\\[a-zA-Z@]+", a4 = "\\\\[^\uD800-\uDFFF]", n4 = "(" + r4 + ")" + sa + "*", i4 = `\\\\(
|[ \r	]+
?)[ \r	]*`, dt = "[̀-ͯ]", s4 = new RegExp(dt + "+$"), l4 = "(" + sa + "+)|" + // whitespace
(i4 + "|") + // \whitespace
"([!-\\[\\]-‧‪-퟿豈-￿]" + // single codepoint
(dt + "*") + // ...plus accents
"|[\uD800-\uDBFF][\uDC00-\uDFFF]" + // surrogate pair
...
m("\\char", function(r) {
  ...
  if (e.text === "'")
    ...
    t = 10;
  if (t) {
    if (a = dr[e.text], a == null || a >= t)
      throw new M("Invalid base-" + t + " digit " + e.text);
    for (var n; (n = dr[r.future().text]) != null && n < t; )
      a *= t, a += n, r.popToken();
  }
  return "\\@char{" + a + "}";
});
...
m("\\newcommand", (r) => Ct(r, !1, !0, !1));
m("\\renewcommand", (r) => Ct(r, !0, !1, !1));
m("\\providecommand", (r) => Ct(r, !0, !0, !0));
m("\\message", (r) => {
...
m("\\show", (r) => {
  ...
  return console.log(e, r.macros.get(t), L0[t], X.math[t], X.text[t]), "";
});
m("\\bgroup", "{");
m("\\egroup", "}");
m("~", "\\nobreakspace");
...
m("\\dots", function(r) {
  ...
  return t in fr ? e = fr[t] : (t.slice(0, 4) === "\\not" || t in X.math && q.contains(["bin", "rel"], X.math[t].group)) && (e = "\\dotsb"), e;
});
var Nt = {
...
var la = A(x0["Main-Regular"][84][1] - 0.7 * x0["Main-Regular"][65][1]);
m("\\LaTeX", "\\textrm{\\html@mathml{" + ("L\\kern-.36em\\raisebox{" + la + "}{\\scriptstyle A}") + "\\kern-.15em\\TeX}{LaTeX}}");
m("\\KaTeX", "\\textrm{\\html@mathml{" + ("K\\kern-.17em\\raisebox{" + la + "}{\\scriptstyle A}") + "\\kern-.15em\\TeX}{KaTeX}}");
...
class h4 {
  constructor(e, t, a) {
    this.settings = void 0, this.expansionCount = void 0, this.lexer = void 0, this.macros = void 0, this.stack = void 0, this.mode = void 0, this.settings = t, this.expansionCount = 0, this.feed(e), this.macros = new o4(u4, t.macros), this.mode = a, this.stack = [];
  }
  /**
   ...
   */
  feed(e) {
    this.lexer = new cr(e, this.settings);
  }
  /**
    ...
    if (typeof n == "string") {
      ...
      if (n.indexOf("#") !== -1)
        for (var o = n.replace(/##/g, ""); o.indexOf("#" + (s + 1)) !== -1; )
          ++s;
      for (var h = new cr(n, this.settings), c = [], p = h.lex(); p.text !== "EOF"; )
        c.push(p), p = h.lex();
      c.reverse();
      var g = {
        tokens: c,
   ...
   */
  isDefined(e) {
    return this.macros.has(e) || L0.hasOwnProperty(e) || X.math.hasOwnProperty(e) || X.text.hasOwnProperty(e) || ua.hasOwnProperty(e);
  }
  /**
...
var pr = /^[₊₋₌₍₎₀₁₂₃₄₅₆₇₈₉ₐₑₕᵢⱼₖₗₘₙₒₚᵣₛₜᵤᵥₓᵦᵧᵨᵩᵪ]/, Me = Object.freeze({
  "₊": "+",
  "₋": "-",
  "₌": "=",
  "₍": "(",
...
class Le {
  ...
  parseSymbol() {
    ...
    vr.hasOwnProperty(t[0]) && !X[this.mode][t[0]] && (this.settings.strict && this.mode === "math" && this.settings.reportNonstrict("unicodeTextInMathMode", 'Accented Unicode text character "' + t[0] + '" used in math mode', e), t = vr[t[0]] + t.slice(1));
    var s = s4.exec(t);
    s && (t = t.substring(0, s.index), t === "i" ? t = "ı" : t === "j" && (t = "ȷ"));
    var o;
    if (X[this.mode][t]) {
      this.settings.strict && this.mode === "math" && ot.indexOf(t) >= 0 && this.settings.reportNonstrict("unicodeTextInMathMode", 'Latin-1/Unicode text character "' + t[0] + '" used in math mode', e);
      var h = X[this.mode][t].group, c = u0.range(e), p;
      ...
      this.settings.strict && (br(t.charCodeAt(0)) ? this.mode === "math" && this.settings.reportNonstrict("unicodeTextInMathMode", 'Unicode text character "' + t[0] + '" used in math mode', e) : this.settings.reportNonstrict("unknownSymbol", 'Unrecognized Unicode character "' + t[0] + '"' + (" (" + t.charCodeAt(0) + ")"), e)), o = {
        type: "textord",
        mode: "text",
        loc: u0.range(e),
        text: t
    ...
    if (this.consume(), s)
      for (var y = 0; y < s[0].length; y++) {
        ...
        var x = nt[w][this.mode] || nt[w].text;
        if (!x)
...
const ze = "math_inline", b4 = pa(ze, () => ({
  ...
  parseDOM: [
    {
      tag: `span[data-type="${ze}"]`,
      getAttrs: (r) => {
        var e;
        return {
          value: (e = r.dataset.value) != null ? e : ""
        };
      }
    }
  ],
  toDOM: (r) => {
    const e = r.attrs.value, t = document.createElement("span");
    return t.dataset.type = ze, t.dataset.value = e, v4.render(e, t, {
      throwOnError: !1
    }), t;
  },
  parseMarkdown: {
    match: (r) => r.type === "inlineMath",
    runner: (r, e, t) => {
      r.addNode(t, { value: e.value });
    }
  },
  toMarkdown: {
    match: (r) => r.type.name === ze,
    runner: (r, e) => {
      r.addNode("inlineMath", void 0, e.attrs.value);
    }
  }
}));
export {
