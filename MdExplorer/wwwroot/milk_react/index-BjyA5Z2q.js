import { E as h, l as b, a as v, L as y, p as k, j as u, s as T, i as _, f as W, t, d as R } from "./integration-BGuMRo5r.js";
import { html as Y } from "./index-2s9tUwEj.js";
import { L as w, E as P } from "./index-BTpBQF85.js";
...
function M(O) {
  var a;
  let { state: e, pos: r } = O, $ = u(e).resolveInner(r, -1).enterUnfinishedNodesBefore(r), i = ((a = $.childBefore(r)) === null || a === void 0 ? void 0 : a.name) || $.name;
  if ($.name == "FilterName")
...
const OO = /* @__PURE__ */ h.inputHandler.of((O, a, e, r) => r != "%" || a != e || O.state.doc.sliceString(a - 1, e + 1) != "{}" ? !1 : (O.dispatch(O.state.changeByRange(($) => ({
