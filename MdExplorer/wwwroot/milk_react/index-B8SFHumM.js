import { E as h, h as b, a as v, L as y, p as k, g as u, s as T, i as _, f as W, t, d as R } from "./integration-x1Kt76xC.js";
import { html as Y } from "./index-DoiA72Si.js";
import { L as w, E as P } from "./index-Do0yv1G9.js";
...
const q = /* @__PURE__ */ l("abs append at_least at_most capitalize ceil compact concat date default divided_by downcase escape escape_once first floor join last lstrip map minus modulo newline_to_br plus prepend remove remove_first replace replace_first reverse round rstrip size slice sort sort_natural split strip strip_html strip_newlines sum times truncate truncatewords uniq upcase url_decode url_encode where", "function"), p = /* @__PURE__ */ l("cycle comment endcomment raw endraw echo increment decrement liquid if elsif else endif unless endunless case endcase for endfor tablerow endtablerow break continue assign capture endcapture render include", "keyword"), d = /* @__PURE__ */ l("empty forloop tablerowloop in with as contains", "keyword"), B = /* @__PURE__ */ l("first index index0 last length rindex", "property"), H = /* @__PURE__ */ l("col col0 col_first col_last first index index0 last length rindex rindex0 row", "property");
function M(O) {
  var a;
