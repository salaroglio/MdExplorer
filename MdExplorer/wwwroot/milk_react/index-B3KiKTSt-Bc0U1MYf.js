...
`, Go = (t, e = {}) => {
  t.config(async (r) => {
    ...
    if (!n) {
      const { languages: i } = await import("./integration-C4QHh9CT.js").then((s) => s.bM);
      n = i;
    }
    if (!o) {
      const { oneDark: i } = await import("./index-CoeuNGX3.js");
      o = i;
    }
    r.update(Fn.key, (i) => {
      var s;
