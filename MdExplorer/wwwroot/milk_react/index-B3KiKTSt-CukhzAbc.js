...
`, Go = (t, e = {}) => {
  t.config(async (r) => {
    ...
    if (!n) {
      const { languages: i } = await import("./integration-BZBxhbjI.js").then((s) => s.bM);
      n = i;
    }
    if (!o) {
      const { oneDark: i } = await import("./index-LP8ci2Ci.js");
      o = i;
    }
    r.update(Fn.key, (i) => {
      var s;
