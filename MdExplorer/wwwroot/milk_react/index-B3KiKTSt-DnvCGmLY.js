...
`, Go = (t, e = {}) => {
  t.config(async (r) => {
    ...
    if (!n) {
      const { languages: i } = await import("./integration-UpWIHG9l.js").then((s) => s.bM);
      n = i;
    }
    if (!o) {
      const { oneDark: i } = await import("./index-H42Eqhgs.js");
      o = i;
    }
    r.update(Fn.key, (i) => {
      var s;
