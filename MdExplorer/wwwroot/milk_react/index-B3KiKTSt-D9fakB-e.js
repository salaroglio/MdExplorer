...
`, Go = (t, e = {}) => {
  t.config(async (r) => {
    ...
    if (!n) {
      const { languages: i } = await import("./integration-BRMPl_dg.js").then((s) => s.bM);
      n = i;
    }
    if (!o) {
      const { oneDark: i } = await import("./index-DItUktkL.js");
      o = i;
    }
    r.update(Fn.key, (i) => {
      var s;
