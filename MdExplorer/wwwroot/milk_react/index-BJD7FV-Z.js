import { L as G, E as z, C as N } from "./index-Crfuao6v.js";
import { c as I, t as p, b as Y, h as k, a as j, i as U, f as Z, A as B } from "./index-B3KiKTSt-Dla4yOC_.js";
import { E as D, i as M } from "./index.es-Dganzb1x.js";
...
function Te(e = {}) {
  ...
  return e.autoCloseTags !== !1 && t.push(fe), new j(w, t);
}
...
const fe = /* @__PURE__ */ D.inputHandler.of((e, t, o, O, r) => {
  ...
  let a = r(), { state: s } = a, f = s.changeByRange((n) => {
    ...
    if (d && O == ">" && S.name == "EndTag") {
      let m = S.parent;
      if (((c = ($ = m.parent) === null || $ === void 0 ? void 0 : $.lastChild) === null || c === void 0 ? void 0 : c.name) != "CloseTag" && (i = A(s.doc, m.parent, l))) {
        let g = l + (s.doc.sliceString(l, l + 1) === ">" ? 1 : 0), q = `</${i}>`;
        return { range: n, changes: { from: l, to: g, insert: q } };
      }
    } else if (d && O == "/" && S.name == "StartCloseTag") {
      let m = S.parent;
      if (S.from == l - 2 && ((u = m.lastChild) === null || u === void 0 ? void 0 : u.name) != "CloseTag" && (i = A(s.doc, m, l))) {
        let g = l + (s.doc.sliceString(l, l + 1) === ">" ? 1 : 0), q = `${i}>`;
        return {
          range: M.cursor(l + q.length, -1),
