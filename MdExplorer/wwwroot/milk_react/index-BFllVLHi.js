import { L as be, E as $, C as Pe } from "./index-D7u9Hvm0.js";
import { p as xe, s as Te, t as h, E as Ve, L as we, j as K, l as ye, a as ve, i as Xe, f as ke, G as $e } from "./integration-CsedU1kD.js";
import { cssLanguage as J, css as _e } from "./index-Bqatb2Sr.js";
import { typescriptLanguage as qe, jsxLanguage as Ce, tsxLanguage as Qe, javascriptLanguage as R, javascript as Ae } from "./index-Yw0ovSYY.js";
const Ye = 54, Me = 1, Re = 55, Ee = 2, Ze = 56, Be = 3, z = 4, ze = 5, X = 6, ee = 7, te = 8, ae = 9, le = 10, We = 11, De = 12, Ne = 13, _ = 57, Ge = 14, W = 58, re = 20, je = 22, ne = 23, Ie = 24, Y = 26, se = 27, Ue = 28, Le = 31, Fe = 34, He = 36, Ke = 37, Je = 0, et = 1, tt = {
  area: !0,
  base: !0,
  br: !0,
  col: !0,
...
const ot = [X, le, ee, te, ae], ut = new Pe({
  start: null,
  shift(e, a, r, l) {
    return ot.indexOf(a) > -1 ? new I(M(l, 1) || "", e) : e;
  },
  reduce(e, a) {
  ...
  reuse(e, a, r, l) {
    let t = a.type.id;
    return t == X || t == He ? new I(M(l, 1) || "", e) : e;
  },
  strict: !1
}), Ot = new $((e, a) => {
  if (e.next != ue) {
...
const pt = Z("script", Ye, Me), mt = Z("style", Re, Ee), ft = Z("textarea", Ze, Be), St = Te({
...
function Oe(e, a) {
  ...
  for (let l of e.getChildren(ne)) {
    let t = l.getChild(Ie), s = l.getChild(Y) || l.getChild(se);
...
].concat(/* @__PURE__ */ de.map((e) => ({ name: e, parser: R.parser }))), he = /* @__PURE__ */ we.define({
  name: "html",
...
const H = /* @__PURE__ */ new Set(/* @__PURE__ */ "area base br col command embed frame hr img input keygen link meta param source track wbr menuitem".split(" ")), wt = /* @__PURE__ */ Ve.inputHandler.of((e, a, r, l, t) => {
