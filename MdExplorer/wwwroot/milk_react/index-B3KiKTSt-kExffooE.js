...
`, Go = (t, e = {}) => {
  t.config(async (r) => {
    ...
    if (!n) {
      const { languages: i } = await import("./integration-CF5vYAhf.js").then((s) => s.bM);
      n = i;
    }
    if (!o) {
      const { oneDark: i } = await import("./index-TJNHMPg_.js");
      o = i;
    }
    r.update(Fn.key, (i) => {
      var s;
