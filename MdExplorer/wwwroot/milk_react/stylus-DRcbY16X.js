...
var J = p(B), j = /^(a|b|i|s|col|em)$/i, Q = p(O), ee = p(W), ie = p(S), re = p(N), ne = p($), oe = F($), te = p(I), ae = p(R), le = p(C), ce = /^\s*([.]{2,3}|&&|\|\||\*\*|[?!=:]?=|[-+*\/%<>]=?|\?:|\~)/, de = F(T), se = p(E), X = new RegExp(/^\-(moz|ms|o|webkit)-/i), ue = p(U), q = "", c = {}, g, m, P, t;
function fe(i, e) {
...
const ge = {
  ...
  indent: function(i, e, r) {
    var o = i.context, l = e && e.charAt(0), f = o.indent, z = u(e), h = o.line.indent, d = i.context.prev ? i.context.prev.line.firstWord : "", s = i.context.prev ? i.context.prev.line.indent : h;
