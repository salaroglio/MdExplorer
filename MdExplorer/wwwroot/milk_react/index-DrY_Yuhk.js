import { L as M, E as X, a as k, C as E } from "./index-BULpsC9f.js";
import { s as A, t as i, E as C, L as J, g as f, h as I, a as B, i as D, f as N, c as g, d as K, b as H, e as F, a2 as T, o as OO, N as aO, I as QO } from "./integration-Bxed0ynC.js";
import { s as l, i as iO, c as eO } from "./index-09Mqew_G.js";
const $O = 314, rO = 315, q = 1, ZO = 2, tO = 3, pO = 4, lO = 316, nO = 318, PO = 319, oO = 5, sO = 6, SO = 0, y = [
  9,
  10,
  11,
  12,
  ...
  8287,
  12288
], W = 125, cO = 59, m = 47, XO = 42, hO = 43, bO = 45, xO = 60, gO = 44, dO = 63, uO = 46, yO = 91, mO = new E({
  start: !1,
  shift(O, a) {
  ...
  let { next: Q } = O, e;
  y.indexOf(Q) > -1 || Q == m && ((e = O.peek(1)) == m || e == XO) || Q != W && Q != cO && Q != -1 && !a.context && O.acceptToken($O);
}, { contextual: !0 }), jO = new X((O, a) => {
  O.next == yO && !a.context && O.acceptToken(rO);
...
const qO = new X((O, a) => {
  if (O.next != xO || !a.dialectEnabled(SO) || (O.advance(), O.next == m)) return;
  let Q = 0;
...
const IO = typeof navigator == "object" && /* @__PURE__ */ /Android\b/.test(navigator.userAgent), BO = /* @__PURE__ */ C.inputHandler.of((O, a, Q, e, r) => {
    ...
    if (P.name == "JSXStartTag" && (P = P.parent), !($.doc.sliceString(p - 1, p) != e || P.name == "JSXAttributeValue" && P.to > p)) {
      ...
      if (e == "/" && P.name == "JSXStartCloseTag") {
        ...
        if (x && S.from == p - 2 && ((h = Y($.doc, x.firstChild, p)) || ((s = x.firstChild) === null || s === void 0 ? void 0 : s.name) == "JSXFragmentTag")) {
          let j = `${h}>`;
          return { range: I.cursor(p + j.length, -1), changes: { from: p, insert: j } };
        }
      } else if (e == ">") {
        let S = JO(P);
