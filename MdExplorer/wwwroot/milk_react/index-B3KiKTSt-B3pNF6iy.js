...
`, Go = (t, e = {}) => {
  t.config(async (r) => {
    ...
    if (!n) {
      const { languages: i } = await import("./integration-x1Kt76xC.js").then((s) => s.bM);
      n = i;
    }
    if (!o) {
      const { oneDark: i } = await import("./index-BE-fft3L.js");
      o = i;
    }
    r.update(Fn.key, (i) => {
      var s;
