import { L as D, E as h, C as L } from "./index-Do0yv1G9.js";
import { s as H, t as n, L as B, g as K, a as M, i as OO, f as eO, d as X, e as iO, N as aO, I as nO } from "./integration-x1Kt76xC.js";
import { i as rO, c as QO, s as d } from "./index-F5ZHvtxR.js";
const tO = 1, j = 194, w = 195, oO = 196, x = 197, dO = 198, sO = 199, lO = 200, TO = 2, E = 3, u = 201, SO = 24, pO = 25, qO = 49, gO = 50, PO = 55, mO = 56, $O = 57, hO = 59, cO = 60, XO = 61, fO = 62, yO = 63, zO = 65, WO = 238, vO = 71, RO = 241, kO = 242, _O = 243, xO = 244, uO = 245, UO = 246, bO = 247, VO = 248, Y = 72, GO = 249, ZO = 250, jO = 251, wO = 252, EO = 253, YO = 254, FO = 255, CO = 256, JO = 73, AO = 77, NO = 263, IO = 112, DO = 130, LO = 151, HO = 152, BO = 155, p = 10, q = 13, k = 32, c = 9, _ = 35, KO = 40, MO = 46, R = 123, U = 125, F = 39, C = 34, b = 92, Oe = 111, ee = 120, ie = 78, ae = 117, ne = 85, re = /* @__PURE__ */ new Set([
  pO,
  qO,
  gO,
  NO,
...
const Qe = new h((O, e) => {
  ...
  if (O.next < 0)
    ...
    f(O.next) && O.acceptToken(dO, 1);
  else if (((i = O.peek(-1)) < 0 || f(i)) && e.canShift(x)) {
    let a = 0;
    for (; O.next == k || O.next == c; )
      O.advance(), a++;
    (O.next == p || O.next == q || O.next == _) && O.acceptToken(x, -a);
  } else f(O.next) && O.acceptToken(oO, 1);
  ...
  if (a == p || a == q) {
    ...
    r != i.indent && O.next != p && O.next != q && O.next != _ && (r < i.indent ? O.acceptToken(w, -Q) : O.acceptToken(j));
  }
...
const V = new Map([
  ...
  shift(O, e, i, a) {
    return e == j ? new $(O, de(a.read(a.pos, i.pos)), 0) : e == w ? O.parent : e == SO || e == PO || e == hO || e == E ? new $(O, 0, m) : V.has(e) ? new $(O, 0, V.get(e) | O.flags & m) : O;
  },
  hash(O) {
    return O.hash;
  }
...
const pe = H({
  ...
  tokenPrec: 7675
}), G = /* @__PURE__ */ new aO(), A = /* @__PURE__ */ new Set([
  "Script",
  "Body",
  "FunctionDefinition",
  "ClassDefinition",
...
function N(O, e) {
  ...
  return e.cursor(nO.IncludeAnonymous).iterate((t) => {
    if (t.name) {
      let o = Pe[t.name];
...
const Z = /^[\w\xa1-\uffff][\w\d\xa1-\uffff]*$/, I = ["String", "FormatString", "Comment", "PropertyName"];
function me(O) {
  let e = K(O.state).resolveInner(O.pos, -1);
  if (I.indexOf(e.name) > -1)
    return null;
  let i = e.name == "VariableName" || e.to - e.from < 20 && Z.test(O.state.sliceDoc(e.from, e.to));
  if (!i && !O.explicit)
    return null;
  let a = [];
...
], ce = /* @__PURE__ */ rO(I, /* @__PURE__ */ QO(/* @__PURE__ */ $e.concat(he)));
function z(O) {
