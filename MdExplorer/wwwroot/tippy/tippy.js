var tippy = function(t) {
    ...
    function D(t, e, n) {
        ...
        return Object.keys(r).reduce((function(r, i) {
            return r[i] = "number" == typeof e ? e : e[i],
    ...
    function j(t, n) {
        ...
        return r.interactive && (r.aria = null),
        r
    }
    function _(t) {
        return t.split("-")[0]
    ...
    function K(t, e) {
        ...
        e.interactive && X(r),
        e.arrow && (r.setAttribute("data-arrow", ""),
        r.appendChild(G(e.arrow))),
        e.inertia && W(r),
        Y(i, e),
        r.appendChild(i),
        n.appendChild(r),
    ...
    function Q(t, e, n) {
        ...
        !e.arrow && n.arrow ? (o.appendChild(G(n.arrow)),
        o.setAttribute("data-arrow", "")) : e.arrow && !n.arrow ? (o.removeChild(p),
        o.removeAttribute("data-arrow")) : e.arrow !== n.arrow && (o.removeChild(p),
        o.appendChild(G(n.arrow))),
        !e.interactive && n.interactive ? X(o) : e.interactive && !n.interactive && function(t) {
            t.removeAttribute("data-interactive")
        }(o),
        !e.inertia && n.inertia ? W(o) : e.inertia && !n.inertia && function(t) {
            t.removeAttribute("data-inertia")
        }(o),
        e.theme !== n.theme && ($(o, "remove", e.theme),
        $(o, "add", n.theme))
    }
    function Z(t, e, n) {
    ...
    function rt(r, i) {
        ...
        var k, M, S, P, V, B = !1, U = !1, R = !1, W = 0, X = [], Y = h(Dt, v.interactiveDebounce), G = C(v.triggerTarget || r), $ = tt++, rt = K($, v), it = J(rt), ot = (V = v.plugins).filter((function(t, e) {
            ...
            setProps: function(t) {
                if (st.state.isDestroyed)
                    return;
                gt("onBeforeUpdate", [st, t]),
                It();
                var n = st.props
                  , i = j(r, e({}, st.props, {}, t, {
                    ignoreAttributes: !0
                ...
                st.props = i,
                Ct(),
                n.interactiveDebounce !== i.interactiveDebounce && (yt(),
                Y = h(Dt, i.interactiveDebounce));
                Q(rt, n, i),
                st.popperChildren = J(rt),
                n.triggerTarget && !i.triggerTarget ? x(n.triggerTarget).forEach((function(t) {
                    t.removeAttribute("aria-expanded")
                }
                )) : i.triggerTarget && r.removeAttribute("aria-expanded");
                if (bt(),
                st.popperInstance)
                    if (q.some((function(e) {
            ...
            show: function(t) {
                ...
                if (e || n || r || i)
                    return;
                if (vt().hasAttribute("disabled"))
                    return;
                st.popperInstance || St();
                if (gt("onShow", [st], !1),
                !1 === st.props.onShow(st))
                    return;
                Et(),
                ...
                M = function() {
                    st.state.isVisible && (m([rt], st.props.updateDuration),
                    m(ut, t),
                    g(ut, "visible"),
                    ht(),
                    bt(),
        ...
        rt.addEventListener("mouseleave", (function(t) {
            st.props.interactive && E(st.props.trigger, "mouseenter") && (Y(t),
        ...
        function wt(t) {
            if (!st.props.interactive || !rt.contains(t.target)) {
                if (vt().contains(t.target)) {
                    if (L.isTouch)
                        return;
                    if (st.state.isVisible && E(st.props.trigger, "click"))
                        return
                }
                !0 === st.props.hideOnClick && (U = !1,
                st.clearDelayTimeouts(),
                st.hide(),
                R = !0,
                setTimeout((function() {
        ...
        function Ot(t) {
            ...
            if (st.state.isEnabled && !Mt(t) && !R) {
                ...
                P = t.currentTarget,
                bt(),
                !st.state.isVisible && l(t) && et.forEach((function(e) {
                    return e(t)
                }
                )),
        ...
        function Lt(t) {
            if (!(Mt(t) || E(st.props.trigger, "click") && U))
                return st.props.interactive ? (G.body.addEventListener("mouseleave", Bt),
                G.addEventListener("mousemove", Y),
                I(et, Y),
                void Y(t)) : void Bt(t)
        }
        ...
        function St() {
            ...
            function s(t) {
                ...
                st.props.flip && !st.props.flipOnUpdate && (t.flipped && (st.popperInstance.options.placement = t.placement),
                d(st.popperInstance.modifiers, "flip", "enabled", !1)),
                at.setAttribute("data-placement", t.placement),
                !1 !== t.attributes["x-out-of-boundaries"] ? at.setAttribute("data-out-of-boundaries", "") : at.removeAttribute("data-out-of-boundaries");
                var r = _(t.placement)
                  , i = E(["top", "bottom"], r)
                  , o = E(["bottom", "right"], r);
                at.style.top = "0",
            ...
            var c = e({
                ...
                modifiers: e({}, i && i.modifiers, {
                    tippyDistance: {
                        ...
                        fn: function(t) {
                            ...
                            return d(o, "preventOverflow", "padding", r),
                            d(o, "flip", "padding", i),
                            t
                        }
                    },
                ...
                onCreate: function(t) {
                    s(t),
                    b(i && i.onCreate, c.onCreate, [t]),
                    Pt()
                },
                onUpdate: function(t) {
                    s(t),
                    b(i && i.onUpdate, c.onUpdate, [t]),
                    Pt()
                }
            });
        ...
        function Pt() {
            0 === W ? (W++,
            st.popperInstance.update()) : M && 1 === W && (W++,
            rt.offsetHeight,
            M())
        }
        function Vt(t) {
    ...
    function it(t, r, i) {
        ...
        document.addEventListener("touchstart", M, e({}, n, {
            capture: !0
        })),
            ...
            function y(o) {
                ...
                if (t.popperInstance && t.state.currentPlacement) {
                    var s = w(o.target, (function(t) {
                      ...
                      , h = m.x
                      , y = m.y;
                    !s && t.props.interactive || (null === i && (i = t.popperInstance.reference),
    ...
    }(".tippy-tooltip[data-animation=fade][data-state=hidden]{opacity:0}.tippy-iOS{cursor:pointer!important;-webkit-tap-highlight-color:transparent}.tippy-popper{pointer-events:none;max-width:calc(100vw - 10px);transition-timing-function:cubic-bezier(.165,.84,.44,1);transition-property:transform}.tippy-tooltip{position:relative;color:#fff;border-radius:4px;font-size:14px;line-height:1.4;background-color:#333;transition-property:visibility,opacity,transform;outline:0}.tippy-tooltip[data-placement^=top]>.tippy-arrow{border-width:8px 8px 0;border-top-color:#333;margin:0 3px;transform-origin:50% 0;bottom:-7px}.tippy-tooltip[data-placement^=bottom]>.tippy-arrow{border-width:0 8px 8px;border-bottom-color:#333;margin:0 3px;transform-origin:50% 7px;top:-7px}.tippy-tooltip[data-placement^=left]>.tippy-arrow{border-width:8px 0 8px 8px;border-left-color:#333;margin:3px 0;transform-origin:0 50%;right:-19px}.tippy-tooltip[data-placement^=right]>.tippy-arrow{border-width:8px 8px 8px 0;border-right-color:#333;margin:3px 0;transform-origin:7px 50%;left:-19px}.tippy-tooltip[data-interactive][data-state=visible]{pointer-events:auto}.tippy-tooltip[data-inertia][data-state=visible]{transition-timing-function:cubic-bezier(.54,1.5,.38,1.11)}.tippy-arrow{position:absolute;border-color:transparent;border-style:solid}.tippy-content{padding:5px 9px}"),
    it.setDefaultProps({
        plugins: [at, pt, ut, st]
    }),
    ...
    it.delegate = function(t, n, r) {
        void 0 === r && (r = []),
        r = n.plugins || r;
        var i, o, a = [], p = [], u = n.target, s = (i = ["target"],
        o = e({}, n),
        ...
        function d(t) {
            if (t.target) {
                ...
                if (e)
                    if (E(e.getAttribute("data-tippy-trigger") || n.trigger || z.trigger, ot[t.type])) {
                        var r = it(e, l);
                        r && (p = p.concat(r))
                    }
            }
    ...
    ,
    it.roundArrow = '<svg viewBox="0 0 18 7" xmlns="http://www.w3.org/2000/svg"><path d="M0 7s2.021-.015 5.253-4.218C6.584 1.051 7.797.007 9 0c1.203-.007 2.416 1.035 3.761 2.782C16.012 7.005 18 7 18 7H0z"/></svg>',
    it
}(Popper);
