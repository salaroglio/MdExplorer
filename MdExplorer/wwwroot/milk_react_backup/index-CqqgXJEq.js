import { P as nt, m as j, n as v, T as st, o as xe, s as Ae, p as it, t as c, q as E, r as ot, u as at, v as lt, e as _, l as P, w as T, a as ae, x as ht, y as ft, z as ut, f as Be, i as dt, A as pt, C as ct, B as mt, D as le, F as gt } from "./integration-lfS1LUpZ.js";
import { html as kt, htmlCompletionSource as Lt } from "./index-CrTx00Al.js";
class $ {
...
const Pt = Ae({
  ...
  LinkTitle: c.string,
  Paragraph: c.content
}), vt = new q(new xe(ze).extend(Pt), Object.keys(F).map((t) => F[t]), Object.keys(F).map((t) => Re[t]), Object.keys(F), xt, Ie, Object.keys(Q).map((t) => Q[t]), Object.keys(Q), []);
function Nt(t, e, r) {
  let n = [];
...
}, me = /(www\.)|(https?:\/\/)|([\w.+-]{1,100}@)|(mailto:|xmpp:)/gy, ge = /[\w-]+(\.[\w-]+)+(\/[^\s<]*)?/gy, Ft = /[\w-]+\.[\w-]+($|\/)/, ke = /[\w.+-]+@[\w-]+(\.[\w.-]+)+/gy, Le = /\/[a-zA-Z\d@.]+/gy;
function be(t, e, r, n) {
  let s = 0;
  for (let i = e; i < r; i++)
    t[i] == n && s++;
...
function sr() {
  if (V)
    return V;
  let t = Lt(new ct(mt.create({ extensions: et }), 0, !0));
