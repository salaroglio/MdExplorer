...
var qt = (t, e, n) => Og(t, typeof e != "symbol" ? e + "" : e, n);
...
let Vg = class {
  /// @internal
  constructor(e, n, r) {
    ue(this, kt), ue(this, Jt), ue(this, _r), Q(this, kt, []), Q(this, _r, () => {
      P(this, kt).forEach((i) => i(P(this, Jt)));
    }), this.set = (i) => {
      Q(this, Jt, i), P(this, _r).call(this);
    }, this.get = () => P(this, Jt), this.update = (i) => {
      Q(this, Jt, i(P(this, Jt))), P(this, _r).call(this);
    }, this.type = r, Q(this, Jt, n), e.set(r.id, this);
  }
...
class Hg {
  ...
  constructor(e, n, r) {
    ue(this, so), ue(this, lo), ue(this, ao), ue(this, er), ue(this, $r), ue(this, Nn), ue(this, Vr), ue(this, Wr), ue(this, Hr), Q(this, er, /* @__PURE__ */ new Set()), Q(this, $r, /* @__PURE__ */ new Set()), Q(this, Nn, /* @__PURE__ */ new Map()), Q(this, Vr, /* @__PURE__ */ new Map()), this.read = () => ({
      metadata: P(this, so),
      ...
      P(this, Nn).set(i, { start: Date.now(), duration: 0 });
    }, this.onClear = (i) => {
      P(this, Nn).delete(i);
    }, this.onDone = (i) => {
      const o = P(this, Nn).get(i);
...
const jg = class pf {
  ...
  constructor(e, n, r) {
    ue(this, Ut), ue(this, Gt), ue(this, co), ue(this, ct), this.produce = (i) => i && Object.keys(i).length ? new pf(P(this, Ut), P(this, Gt), { ...i }) : this, this.inject = (i, o) => {
      var s;
      const l = i.create(P(this, Ut).sliceMap);
      return o != null && l.set(o), (s = P(this, ct)) == null || s.onInject(i), this;
    }, this.remove = (i) => {
      var o;
      return P(this, Ut).remove(i), (o = P(this, ct)) == null || o.onRemove(i), this;
    }, this.record = (i) => {
      var o;
      return i.create(P(this, Gt).store), (o = P(this, ct)) == null || o.onRecord(i), this;
    }, this.clearTimer = (i) => {
      var o;
      return P(this, Gt).remove(i), (o = P(this, ct)) == null || o.onClear(i), this;
    }, this.isInjected = (i) => P(this, Ut).has(i), this.isRecorded = (i) => P(this, Gt).has(i), this.use = (i) => {
      var o;
      return (o = P(this, ct)) == null || o.onUse(i), P(this, Ut).get(i);
    }, this.get = (i) => this.use(i).get(), this.set = (i, o) => this.use(i).set(o), this.update = (i, o) => this.use(i).update(o), this.timer = (i) => P(this, Gt).get(i), this.done = (i) => {
      var o;
    ...
    }, Q(this, Ut, e), Q(this, Gt, n), Q(this, co, r), r && Q(this, ct, new Hg(e, n, r));
  }
...
class Jg {
  /// @internal
  constructor(e, n) {
    ue(this, tr), ue(this, Tn), ue(this, jr), ue(this, Yt), ue(this, qr), ue(this, uo), Q(this, tr, null), Q(this, Tn, null), Q(this, Yt, "pending"), this.start = () => (P(this, tr) ?? Q(this, tr, new Promise((r, i) => {
      Q(this, Tn, (o) => {
        o instanceof CustomEvent && o.detail.id === P(this, jr) && (Q(this, Yt, "resolved"), P(this, qr).call(this), o.stopImmediatePropagation(), r());
      }), P(this, uo).call(this, () => {
        P(this, Yt) === "pending" && Q(this, Yt, "rejected"), P(this, qr).call(this), i(new Error(`Timing ${this.type.name} timeout.`));
      }), Q(this, Yt, "pending"), addEventListener(this.type.name, P(this, Tn));
    })), P(this, tr)), this.done = () => {
      ...
      P(this, Tn) && removeEventListener(this.type.name, P(this, Tn));
    }), Q(this, uo, (r) => {
      setTimeout(() => {
        r();
      }, this.type.timeout);
...
function bf(t, e, n, r) {
  ...
  if (i == e.index(r) && r < t.depth - n.openStart) {
    ...
    if (!n.openStart && !n.openEnd && t.depth == r && e.depth == r) {
      ...
      return zn(s, l.cut(0, t.parentOffset).append(n.content).append(l.cut(e.parentOffset)));
    } else {
      let { start: s, end: l } = Yg(n, t);
      return zn(o, xf(t, s, l, e, r));
    }
  else return zn(o, Ho(t, e, r));
}
function wf(t, e) {
...
function li(t, e, n, r) {
  ...
  t && (o = t.index(n), t.depth > n ? o++ : t.textOffset && (Pn(t.nodeAfter, r), o++));
  for (let l = o; l < s; l++)
    Pn(i.child(l), r);
  e && e.depth == n && e.textOffset && Pn(e.nodeBefore, r);
}
function zn(t, e) {
...
function xf(t, e, n, r, i) {
  ...
  return li(null, t, i, l), o && s && e.index(i) == n.index(i) ? (wf(o, s), Pn(zn(o, xf(t, e, n, r, i + 1)), l)) : (o && Pn(zn(o, Ho(t, e, i + 1)), l), li(e, n, i, l), s && Pn(zn(s, Ho(n, r, i + 1)), l)), li(r, null, i, l), new T(l);
}
function Ho(t, e, n) {
  let r = [];
  if (li(null, t, n, r), t.depth > n) {
    let i = bl(t, e, n + 1);
    Pn(zn(i, Ho(t, e, n + 1)), r);
  }
...
class Jn {
  ...
  */
  static fromSchema(e) {
    return e.cached.domSerializer || (e.cached.domSerializer = new Jn(this.nodesFromSchema(e), this.marksFromSchema(e)));
  }
  /**
...
const Ct = gn(/[A-Za-z]/), ft = gn(/[\dA-Za-z]/), Ny = gn(/[#-'*+\--9=?A-Z^-~]/);
function xl(t) {
  return (
...
const Cl = gn(/\d/), Ty = gn(/[\dA-Fa-f]/), Iy = gn(/[!-/:-@[-`{-~]/);
function F(t) {
  return t !== null && t < -2;
}
function Fe(t) {
...
const Ay = gn(new RegExp("\\p{P}|\\p{S}", "u")), Ey = gn(/\s/);
function gn(t) {
  return e;
  function e(n) {
...
function C1(t) {
  ...
  function r(M) {
    ...
    for (A.position = {
      start: Kt(M.length > 0 ? M[0][1].start : {
        line: 1,
        column: 1,
        offset: 0
      }),
      end: Kt(M.length > 0 ? M[M.length - 2][1].end : {
        line: 1,
        column: 1,
        offset: 0
      })
  ...
  function i(M, A, V) {
    let U = A - 1, ne = -1, at = !1, Cn, vt, Pr, zr;
    for (; ++U <= V; ) {
      const je = M[U];
      switch (je[1].type) {
        case "listUnordered":
        ...
        case "lineEndingBlank": {
          je[0] === "enter" && (Cn && !zr && !ne && !Pr && (Pr = U), zr = void 0);
          break;
        }
        case "linePrefix":
        case "listItemValue":
      ...
      if (!ne && je[0] === "enter" && je[1].type === "listItemPrefix" || ne === -1 && je[0] === "exit" && (je[1].type === "listUnordered" || je[1].type === "listOrdered")) {
        if (Cn) {
          ...
          for (vt = void 0; Qn--; ) {
            ...
            if (Pt[1].type === "lineEnding" || Pt[1].type === "lineEndingBlank") {
              ...
              vt && (M[vt][1].type = "lineEndingBlank", at = !0), Pt[1].type = "lineEnding", vt = Qn;
          ...
          Pr && (!vt || Pr < vt) && (Cn._spread = !0), Cn.end = Object.assign({}, vt ? M[vt][1].start : je[1].end), M.splice(vt || U, 0, ["exit", Cn, je[2]]), U++, V++;
        }
        if (je[1].type === "listItemPrefix") {
          ...
          Cn = Qn, M.splice(U, 0, ["enter", Qn, je[2]]), U++, V++, Pr = void 0, zr = !0;
        }
      }
    }
  ...
  function x(M) {
    ...
    A.value += this.sliceSerialize(M), A.position.end = Kt(M.end);
  }
  function R(M) {
    const A = this.stack[this.stack.length - 1];
    if (this.data.atHardBreak) {
      const V = A.children[A.children.length - 1];
      V.position.end = Kt(M.end), this.data.atHardBreak = void 0;
      return;
    }
...
`,
  ...
  return /^[\t ]/.test(c) && (c = fn(c.charCodeAt(0)) + c.slice(1)), c = c ? s + " " + c : s, n.options.closeAtx && (c += " " + s), a(), l(), c;
}
td.peek = G1;
function td(t) {
  return t.value || "";
...
*])` },
  { character: "*", inConstruct: "phrasing", notInConstruct: Sn },
...
-])` },
  ...
  { character: "_", inConstruct: "phrasing", notInConstruct: Sn },
...
`) && u.type === "html" && (o[o.length - 1] = o[o.length - 1].replace(
    ...
    a && a === f.slice(0, 1) && (f = fn(a.charCodeAt(0)) + f.slice(1));
    const d = e.attentionEncodeSurroundingInfo;
    e.attentionEncodeSurroundingInfo = void 0, a = void 0, d && (o.length > 0 && d.before && l === o[o.length - 1].slice(-1) && (o[o.length - 1] = o[o.length - 1].slice(0, -1) + fn(l.charCodeAt(0))), d.after && (a = h)), c.move(f), o.push(f), l = f.slice(-1);
  }
  return r.pop(), o.join("");
}
function Mb(t, e, n) {
...
function Ab(t, e, n) {
  ...
  for (l = -1; ++l < i.length; ) {
    const u = i[l];
    u < a || u >= c || u + 1 < c && i[l + 1] === u + 1 && s[u].after && !s[u + 1].before && !s[u + 1].after || i[l - 1] === u - 1 && s[u].before && !s[u - 1].before && !s[u - 1].after || (a !== u && o.push(vu(r.slice(a, u), "\\")), a = u, /[!-/:-@[-`{-~]/.test(r.charAt(u)) && (!n.encode || !n.encode.includes(r.charAt(u))) ? o.push("\\") : (o.push(fn(r.charCodeAt(u))), a++));
  }
...
const l0 = (t) => Object.prototype.hasOwnProperty.call(t, "size"), Ll = class extends pd {
  /// @internal
  constructor(e) {
    super(), de(this, Lt), de(this, Gr), de(this, bo), de(this, wo), de(this, Yr), de(this, xo), de(this, Qr), de(this, Co), de(this, So), de(this, nr), de(this, In), de(this, Mo), de(this, Xr), oe(this, Lt, G.none), oe(this, Gr, (n) => {
      const r = Object.values({
        ...this.schema.nodes,
        ...this.schema.marks
      ...
      i.length && q(this, In).call(this, "text", void 0, i);
      const u = r();
      return o.length && q(this, In).call(this, "text", void 0, o), u;
    }), oe(this, nr, (n = !1) => {
      const r = this.close(), i = () => q(this, In).call(this, r.type, r.children, r.value, r.props);
      return n ? q(this, So).call(this, r, i) : i();
    }), this.closeNode = () => (q(this, nr).call(this), this), oe(this, In, (n, r, i, o) => {
      const s = Vu.create(n, r, i, o), l = q(this, Qr).call(this, q(this, Co).call(this, s));
      return this.push(l), l;
    }), this.addNode = (n, r, i, o) => (q(this, In).call(this, n, r, i, o), this), oe(this, Mo, (n, r, i, o) => n.isInSet(q(this, Lt)) ? this : (oe(this, Lt, n.addToSet(q(this, Lt))), this.openNode(r, i, { ...o, isMark: !0 }))), oe(this, Xr, (n) => {
...
class sn extends Ee {
  ...
  */
      ...
      if (r.length == n.marks.length) {
        for (let i = 0; i < n.marks.length; i++)
          if (!n.marks[i].isInSet(r))
            return new sn(this.pos, n.marks[i]);
        return new sn(this.pos, this.mark);
      }
    }
  ...
  map(e) {
    ...
    return n.deletedAfter ? null : new sn(n.pos, this.mark);
  }
  toJSON() {
  ...
  */
  static fromJSON(e, n) {
    ...
    return new sn(n.pos, e.markFromJSON(n.mark));
  }
}
Ee.jsonID("addNodeMark", sn);
class Cr extends Ee {
  /**
  Create a mark-removing step.
  */
  ...
  invert(e) {
    let n = e.nodeAt(this.pos);
    return !n || !this.mark.isInSet(n.marks) ? this : new sn(this.pos, this.mark);
  }
  map(e) {
    let n = e.mapResult(this.pos, 1);
...
const dn = typeof navigator < "u" ? navigator : null, Qu = typeof document < "u" ? document : null, yn = dn && dn.userAgent || "", _l = /Edge\/(\d+)/.exec(yn), vd = /MSIE \d/.exec(yn), $l = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(yn), ds = !!(vd || $l || _l), $0 = vd ? document.documentMode : $l ? +$l[1] : _l ? +_l[1] : 0, Pd = !ds && /gecko\/(\d+)/i.test(yn), V0 = Pd && +(/Firefox\/(\d+)/.exec(yn) || [0, 0])[1], Vl = !ds && /Chrome\/(\d+)/.exec(yn), W0 = !!Vl, H0 = Vl ? +Vl[1] : 0, zd = !ds && !!dn && /Apple Computer/.test(dn.vendor), Ld = zd && (/Mobile\/\w+/.test(yn) || !!dn && dn.maxTouchPoints > 2), j0 = Ld || (dn ? /Mac/.test(dn.platform) : !1), q0 = /Android \d/.test(yn), Fd = !!Qu && "webkitFontSmoothing" in Qu.documentElement.style, K0 = Fd ? +(/\bAppleWebKit\/(\d+)/.exec(navigator.userAgent) || [0, 0])[1] : 0;
...
for (var Ce = 0; Ce < 10; Ce++) pn[48 + Ce] = pn[96 + Ce] = String(Ce);
for (var Ce = 1; Ce <= 24; Ce++) pn[Ce + 111] = "F" + Ce;
for (var Ce = 65; Ce <= 90; Ce++)
  pn[Ce] = String.fromCharCode(Ce + 32), Jo[Ce] = String.fromCharCode(Ce);
for (var Js in pn) Jo.hasOwnProperty(Js) || (Jo[Js] = pn[Js]);
function Tw(t) {
  var e = Mw && t.metaKey && t.shiftKey && !t.ctrlKey && !t.altKey || Nw && t.shiftKey && t.key && t.key.length == 1 || t.key == "Unidentified", n = !e && t.key || (t.shiftKey ? Jo : pn)[t.keyCode] || t.key || "Unidentified";
...
function Kd(t) {
  ...
  return function(n, r) {
    ...
    if (i.length == 1 && i != " ") {
      ...
      if ((r.shiftKey || r.altKey || r.metaKey || i.charCodeAt(0) > 127) && (o = pn[r.keyCode]) && o != i) {
        let l = e[Us(o, r)];
        if (l && l(n.state, n.dispatch, n))
          return !0;
      }
...
const ys = function(t) {
  return t.focusNode && jn(t.focusNode, t.focusOffset, t.anchorNode, t.anchorOffset);
};
function On(t, e) {
...
const Nt = typeof navigator < "u" ? navigator : null, rh = typeof document < "u" ? document : null, kn = Nt && Nt.userAgent || "", Hl = /Edge\/(\d+)/.exec(kn), Jd = /MSIE \d/.exec(kn), jl = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(kn), _e = !!(Jd || jl || Hl), cn = Jd ? document.documentMode : jl ? +jl[1] : Hl ? +Hl[1] : 0, mt = !_e && /gecko\/(\d+)/i.test(kn);
mt && +(/Firefox\/(\d+)/.exec(kn) || [0, 0])[1];
const ql = !_e && /Chrome\/(\d+)/.exec(kn), Ie = !!ql, Ud = ql ? +ql[1] : 0, De = !_e && !!Nt && /Apple Computer/.test(Nt.vendor), Tr = De && (/Mobile\/\w+/.test(kn) || !!Nt && Nt.maxTouchPoints > 2), Ze = Tr || (Nt ? /Mac/.test(Nt.platform) : !1), Fw = Nt ? /Win/.test(Nt.platform) : !1, Vt = /Android \d/.test(kn), Pi = !!rh && "webkitFontSmoothing" in rh.documentElement.style, Bw = Pi ? +(/\bAppleWebKit\/(\d+)/.exec(navigator.userAgent) || [0, 0])[1] : 0;
function _w(t) {
...
function Zd(t, e, n) {
  ...
  if (r.nodeType == 3)
    if (s && (Gw.test(r.nodeValue) || (n < 0 ? !i : i == r.nodeValue.length))) {
      ...
      if (mt && i && /\s/.test(r.nodeValue[i - 1]) && i < r.nodeValue.length) {
        let c = Qt(Bt(r, i - 1, i - 1), -1);
        if (c.top == a.top) {
          let u = Qt(Bt(r, i, i + 1), -1);
          if (u.top != a.top)
      ...
      return n < 0 && !i ? (c++, u = -1) : n >= 0 && i == r.nodeValue.length ? (a--, u = 1) : n < 0 ? a-- : c++, Fr(Qt(Bt(r, a, c), u), u < 0);
    }
  ...
  return Fr(Qt(r.nodeType == 3 ? Bt(r) : r, -n), n >= 0);
}
function Fr(t, e) {
  if (t.width == 0)
    return t;
...
`), h && p == d.nodeValue.length)
    ...
    if (!(i || h && De) && jn(l.node, l.offset, u.anchorNode, u.anchorOffset) && jn(a.node, a.offset, u.focusNode, u.focusOffset))
      return;
    let f = !1;
    if ((c.extend || e == n) && !h) {
  ...
  markDirty(e, n) {
    for (let r = 0, i = 0; i < this.children.length; i++) {
      ...
      if (r == s ? e <= s && n >= r : e < s && n > r) {
        ...
        if (e >= l && n <= a) {
          this.dirty = e == r || n == s ? Rn : ch, e == l && n == a && (o.contentLost || o.dom.parentNode != this.contentDOM) ? o.dirty = Tt : o.markDirty(e - l, n - l);
          return;
        } else
          o.dirty = o.dom == o.contentDOM && o.dom.parentNode == this.contentDOM && !o.children.length ? Rn : Tt;
      }
      r = s;
    }
    this.dirty = Rn;
...
class qn extends zi {
  ...
  static create(e, n, r, i) {
    ...
    return (!s || !s.dom) && (s = Jn.renderSpec(document, n.type.spec.toDOM(n, r), null, n.attrs)), new qn(e, n, s.dom, s.contentDOM || s.dom, s);
  }
  parseRule() {
  ...
  slice(e, n, r) {
    let i = qn.create(this.parent, this.mark, !0, r), o = this.children, s = this.size;
...
class un extends zi {
  ...
  static create(e, n, r, i, o, s) {
    ...
    } else u || ({ dom: u, contentDOM: h } = Jn.renderSpec(document, n.type.spec.toDOM(n), null, n.attrs));
    !h && !n.isText && u.nodeName != "BR" && (u.hasAttribute("contenteditable") || (u.contentEditable = "false"), n.type.spec.draggable && (u.draggable = !0));
    let f = u;
    return u = op(u, r, n), c ? a = new tx(e, n, r, i, u, h || null, f, c, o, s + 1) : n.isText ? new ks(e, n, r, i, u, f, o) : new un(e, n, r, i, u, h || null, f, o, s + 1);
  }
  parseRule() {
  ...
  updateChildren(e, n) {
    ...
    }), a.syncToMarks([], r, e), this.node.isTextblock && a.addTextblockHacks(), a.destroyRest(), (a.changed || this.dirty == Rn) && (s && this.protectLocalComposition(e, s), rp(this.contentDOM, this.children, e), Tr && lx(this.dom));
  }
...
function uh(t, e, n, r, i) {
  op(r, e, t);
  let o = new un(void 0, t, e, n, r, r, r, i, 0);
...
function ip(t, e, n, r) {
  ...
  for (let o = 0; o < r.length; o++) {
    ...
    if (o) {
      let a;
      l && l.nodeName == s.nodeName && i != t && (a = i.parentNode) && a.nodeName.toLowerCase() == s.nodeName || (a = document.createElement(s.nodeName), a.pmIsDeco = !0, a.appendChild(i), l = vn[0]), i = a;
    }
    nx(i, l || vn[0], s);
  }
  return i;
...
function op(t, e, n) {
  return ip(t, t, vn, Kl(e, n, t.nodeType != 1));
}
function Uo(t, e) {
  if (t.length != e.length)
    return !1;
...
class rx {
  ...
  syncToMarks(e, n, r) {
    ...
    for (; o < e.length; ) {
      ...
      if (l > -1)
        ...
        let a = qn.create(this.top, e[o], n, r);
  ...
  updateNodeAt(e, n, r, i, o) {
    ...
    return s.dirty == Tt && s.dom == s.contentDOM && (s.dirty = Rn), s.update(e, n, r, o) ? (this.destroyBetween(this.index, i), this.index++, !0) : !1;
  }
    ...
    for (let l = this.index; l < this.top.children.length; l++) {
      ...
      if (a instanceof un) {
        ...
        if (!f && (h = this.recreateWrapper(a, e, n, r, i, s)))
          return this.destroyBetween(this.index, l), this.top.children[this.index] = h, h.contentDOM && (h.dirty = Rn, h.updateChildren(i, s + 1), h.dirty = nt), this.changed = !0, this.index++, !0;
        break;
      }
    }
    return !1;
  ...
  recreateWrapper(e, n, r, i, o, s) {
    if (e.dirty || n.isAtom || !e.children.length || !e.node.content.eq(n.content) || !Uo(r, e.outerDeco) || !i.eq(e.innerDeco))
      return null;
    let l = un.create(this.top, n, r, i, o, s);
    if (l.contentDOM) {
  ...
  addNode(e, n, r, i, o) {
    let s = un.create(this.top, e, n, r, i, o);
...
function ux(t) {
  ...
  i ? n.setStart(r.parentNode, Se(r) + 1) : n.setStart(r, 0), n.collapse(!0), e.removeAllRanges(), e.addRange(n), !i && !t.state.selection.visible && _e && cn <= 11 && (r.disabled = !0, r.disabled = !1);
}
function lp(t, e) {
  if (e instanceof _) {
...
function hx(t) {
  ...
  return jn(e.node, e.offset, n.anchorNode, n.anchorOffset);
}
function Ul(t, e) {
...
function yh(t, e, n) {
  ...
  if (r instanceof H)
    if (n.indexOf("s") > -1) {
      ...
      return en(t, new H(r.$anchor, s));
    } else if (r.empty) {
      if (t.endOfTextblock(e > 0 ? "forward" : "backward")) {
        let i = Ul(t.state, e);
        return i && i instanceof _ ? en(t, i) : !1;
      } else if (!(Ze && n.indexOf("m") > -1)) {
        let i = r.$head, o = i.textOffset ? null : e < 0 ? i.nodeBefore : i.nodeAfter, s;
        if (!o || o.isText)
          return !1;
        let l = e < 0 ? i.pos - o.nodeSize : i.pos;
        return o.isAtom || (s = t.docView.descAt(l)) && !s.contentDOM ? _.isSelectable(o) ? en(t, new _(e < 0 ? t.state.doc.resolve(i.pos - o.nodeSize) : i)) : Pi ? en(t, new H(t.state.doc.resolve(e < 0 ? l : l + o.nodeSize))) : !1 : !1;
      }
    } else return !1;
  else {
    if (r instanceof _ && r.node.isInline)
      return en(t, new H(e > 0 ? r.$to : r.$from));
    {
      let i = Ul(t.state, e);
      return i ? en(t, i) : !1;
    }
...
function Da(t, e) {
  ...
  let s = t.someProp("clipboardSerializer") || Jn.fromSchema(t.state.schema), l = mp(), a = l.createElement("div");
...
`))), 0, 0) : E.empty;
    ...
    if (h)
      ...
      let f = i.marks(), { schema: d } = t.state, p = Jn.fromSchema(d);
  ...
  if (l || (l = (t.someProp("clipboardParser") || t.someProp("domParser") || Hn.fromSchema(t.state.schema)).parseSlice(s, {
  ...
  if (t.input.shiftKey = n.keyCode == 16 || n.shiftKey, !yp(t, n) && (t.input.lastKeyCode = n.keyCode, t.input.lastKeyCodeTime = Date.now(), !(Vt && Ie && n.keyCode == 13)))
    if (n.keyCode != 229 && t.domObserver.forceFlush(), Tr && n.keyCode == 13 && !n.ctrlKey && !n.altKey && !n.metaKey) {
      ...
      t.input.lastIOSEnter = r, t.input.lastIOSEnterFallbackTimeout = setTimeout(() => {
        t.input.lastIOSEnter == r && (t.someProp("handleKeyDown", (i) => i(t, On(13, "Enter"))), t.input.lastIOSEnter = 0);
      }, 200);
    } else t.someProp("handleKeyDown", (r) => r(t, n)) || kx(t, n) ? n.preventDefault() : ln(t, "key");
};
ve.keyup = (t, e) => {
...
Re.mousedown = (t, e) => {
  ...
  s && (o == "singleClick" ? (t.input.mouseDown && t.input.mouseDown.done(), t.input.mouseDown = new Bx(t, s, n, !!r)) : (o == "doubleClick" ? zx : Lx)(t, s.pos, s.inside, n) ? n.preventDefault() : ln(t, "pointer"));
};
class Bx {
  constructor(e, n, r, i) {
  ...
  up(e) {
    if (this.done(), !this.view.dom.contains(e.target))
      return;
    let n = this.pos;
    this.view.state.doc != this.startDoc && (n = this.view.posAtCoords(bs(e))), this.updateAllowDefault(e), this.allowDefault || !n ? ln(this.view, "pointer") : Px(this.view, n.pos, n.inside, e, this.selectNode) ? e.preventDefault() : e.button == 0 && (this.flushed || // Safari ignores clicks on draggable elements
    ...
    // works around that.
    Ie && !this.view.state.selection.visible && Math.min(Math.abs(n.pos - this.view.state.selection.from), Math.abs(n.pos - this.view.state.selection.to)) <= 2) ? (mr(this.view, $.near(this.view.state.doc.resolve(n.pos))), e.preventDefault()) : ln(this.view, "pointer");
  }
  move(e) {
    this.updateAllowDefault(e), ln(this.view, "pointer"), e.buttons == 0 && this.done();
  }
...
Re.touchstart = (t) => {
  t.input.lastTouch = Date.now(), Pa(t), ln(t, "pointer");
};
Re.touchmove = (t) => {
  t.input.lastTouch = Date.now(), ln(t, "pointer");
};
...
Re.beforeinput = (t, e) => {
  if (Ie && Vt && e.inputType == "deleteContentBackward") {
    ...
    setTimeout(() => {
      if (t.input.domChangeCount != r || (t.dom.blur(), t.focus(), t.someProp("handleKeyDown", (o) => o(t, On(8, "Backspace")))))
        return;
...
class Qo {
  constructor(e, n) {
    this.toDOM = e, this.spec = n || Ln, this.side = this.spec.side || 0;
  }
  map(e, n, r, i) {
...
class hn {
  ...
  eq(e) {
    return this == e || e instanceof hn && Mi(this.attrs, e.attrs) && Mi(this.spec, e.spec);
  }
  static is(e) {
...
class le {
  ...
  */
  static create(e, n) {
    return n.length ? Xo(n, e, 0, Ln) : Te;
  }
  /**
  ...
  */
  map(e, n, r) {
    return this == Te || e.maps.length == 0 ? this : this.mapInner(e, n, 0, 0, r || Ln);
  }
  /**
  @internal
  */
  mapInner(e, n, r, i, o) {
    ...
    return this.children.length ? Kx(this.children, s || [], e, n, r, i, o) : s ? new le(s.sort(Fn), ir) : Te;
  }
  /**
    ...
    e.forEach((l, a) => {
      ...
      if (u = Mp(n, l, c)) {
        for (i || (i = this.children.slice()); o < i.length && i[o] < a; )
          o += 3;
        i[o] == a ? i[o + 2] = i[o + 2].addInner(l, u, c + 1) : i.splice(o, 0, a, a + l.nodeSize, Xo(u, l, c + 1, Ln)), o += 3;
      }
    });
    let s = Sp(o ? Np(n) : n, -r);
    for (let l = 0; l < s.length; l++)
      s[l].type.valid(e, s[l]) || s.splice(l--, 1);
    return new le(s.length ? this.local.concat(s).sort(Fn) : this.local, i || this.children);
  }
  /**
  ...
  */
  ...
  forChild(e, n) {
    ...
    for (let l = 0; l < this.local.length; l++) {
      let a = this.local[l];
      if (a.from < s && a.to > o && a.type instanceof hn) {
        let c = Math.max(o, a.from) - o, u = Math.min(s, a.to) - o;
        c < u && (i || (i = [])).push(a.copy(c, u));
      }
    }
    if (i) {
      let l = new le(i.sort(Fn), ir);
      return r ? new rn([l, r]) : l;
    }
    return r || Te;
  }
  /**
  ...
  */
  localsInner(e) {
    ...
    for (let r = 0; r < this.local.length; r++)
      this.local[r].type instanceof hn || n.push(this.local[r]);
    return n;
  }
  forEachSet(e) {
    e(this);
...
class rn {
  ...
  map(e, n) {
    const r = this.members.map((i) => i.map(e, n, Ln));
    return rn.from(r);
  }
  forChild(e, n) {
    if (n.isLeaf)
    ...
    for (let i = 0; i < this.members.length; i++) {
      ...
      o != Te && (o instanceof rn ? r = r.concat(o.members) : r.push(o));
    }
    return rn.from(r);
  }
  eq(e) {
    if (!(e instanceof rn) || e.members.length != this.members.length)
      return !1;
  ...
  static from(e) {
    switch (e.length) {
      ...
      case 1:
        return e[0];
      default:
        return new rn(e.every((n) => n instanceof le) ? e : e.reduce((n, r) => n.concat(r instanceof le ? r : r.members), []));
    }
  }
  forEachSet(e) {
    for (let n = 0; n < this.members.length; n++)
...
function Xs(t) {
  ...
  return t.someProp("decorations", (n) => {
    let r = n(t.state);
    r && r != Te && e.push(r);
  }), t.cursorWrapper && e.push(le.create(t.state.doc, [t.cursorWrapper.deco])), rn.from(e);
}
const Ux = {
  childList: !0,
  characterData: !0,
...
class Qx {
  constructor(e, n) {
    this.view = e, this.handleDOMChange = n, this.queue = [], this.flushingSoon = -1, this.observer = null, this.currentSelection = new Yx(), this.onCharData = null, this.suppressingSelectionUpdates = !1, this.lastChangedTextNode = null, this.observer = window.MutationObserver && new window.MutationObserver((r) => {
      for (let i = 0; i < r.length; i++)
        this.queue.push(r[i]);
      _e && cn <= 11 && r.some((i) => i.type == "childList" && i.removedNodes.length || i.type == "characterData" && i.oldValue.length > i.target.nodeValue.length) ? this.flushSoon() : this.flush();
  ...
  onSelectionChange() {
    if (gh(this.view)) {
      if (this.suppressingSelectionUpdates)
        return Wt(this.view);
      if (_e && cn <= 11 && !this.view.state.selection.empty) {
  ...
  registerMutation(e, n) {
    ...
    if (e.type == "childList") {
      ...
      if (_e && cn <= 11 && e.addedNodes.length)
        for (let u = 0; u < e.addedNodes.length; u++) {
...
function Ih(t, e) {
  ...
  return jn(s.node, s.offset, i, o) && ([n, r, i, o] = [i, o, n, r]), { anchorNode: n, anchorOffset: r, focusNode: i, focusOffset: o };
}
function Zx(t, e) {
...
function tC(t, e, n) {
  ...
  let h = t.state.doc, f = t.someProp("domParser") || Hn.fromSchema(t.state.schema), d = h.resolve(s), p = null, m = f.parse(r, {
    topNode: d.parent,
...
function iC(t, e, n, r, i) {
  ...
  if (t.input.compositionPendingChanges = 0, e < 0) {
    ...
    if (x && !t.state.selection.eq(x)) {
      if (Ie && Vt && t.input.lastKeyCode === 13 && Date.now() - 100 < t.input.lastKeyCodeTime && t.someProp("handleKeyDown", (D) => D(t, On(13, "Enter"))))
        return;
  ...
  if (p && t.input.domChangeCount++, (Tr && t.input.lastIOSEnter > Date.now() - 225 || Vt) && i.some((O) => O.nodeType == 1 && !rC.test(O.nodeName)) && (!p || p.endA >= p.endB) && t.someProp("handleKeyDown", (O) => O(t, On(13, "Enter")))) {
  ...
  t.state.selection.from < t.state.selection.to && p.start == p.endB && t.state.selection instanceof H && (p.start > t.state.selection.from && p.start <= t.state.selection.from + 2 && t.state.selection.from >= c.from ? p.start = t.state.selection.from : p.endA < t.state.selection.to && p.endA >= t.state.selection.to - 2 && t.state.selection.to <= c.to && (p.endB += t.state.selection.to - p.endA, p.endA = t.state.selection.to)), _e && cn <= 11 && p.endB == p.start + 1 && p.endA == p.start && p.start > c.from && c.doc.textBetween(p.start - c.from - 1, p.start - c.from + 1) == "  " && (p.start--, p.endA--, p.endB--);
  ...
  if ((Tr && t.input.lastIOSEnter > Date.now() - 225 && (!N || i.some((O) => O.nodeName == "DIV" || O.nodeName == "P")) || !N && m.pos < c.doc.content.size && (!m.sameParent(y) || !m.parent.inlineContent) && !/\S/.test(c.doc.textBetween(m.pos, y.pos, "", "")) && (C = $.findFrom(c.doc.resolve(m.pos + 1), 1, !0)) && C.head > m.pos) && t.someProp("handleKeyDown", (O) => O(t, On(13, "Enter")))) {
    t.input.lastIOSEnter = 0;
    return;
  }
  if (t.state.selection.anchor > p.start && sC(u, p.start, p.endA, m, y) && t.someProp("handleKeyDown", (O) => O(t, On(8, "Backspace")))) {
  ...
  Ie && p.endB == p.start && (t.input.lastChromeDelete = Date.now()), Vt && !N && m.start() != y.start() && y.parentOffset == 0 && m.depth == y.depth && c.sel && c.sel.anchor == c.sel.head && c.sel.head == p.endA && (p.endB -= 2, y = c.doc.resolveNoCache(p.endB - c.from), setTimeout(() => {
    t.someProp("handleKeyDown", function(O) {
      return O(t, On(13, "Enter"));
    });
  }, 20));
  let v = p.start, I = p.endA, w, z, W;
  if (N) {
    if (m.pos == y.pos)
      _e && cn <= 11 && m.parentOffset == 0 && (t.domObserver.suppressSelectionUpdates(), setTimeout(() => Wt(t), 20)), w = t.state.tr.delete(v, I), z = u.resolve(p.start).marksAcross(u.resolve(p.endA));
    else if (
...
var Tp = (t) => {
  throw TypeError(t);
}, Ip = (t, e, n) => e.has(t) || Tp("Cannot " + n), L = (t, e, n) => (Ip(t, e, "read from private field"), n ? n.call(t) : e.get(t)), be = (t, e, n) => e.has(t) ? Tp("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, n), ae = (t, e, n, r) => (Ip(t, e, "write to private field"), e.set(t, n), n), or, An, sr, Xe, Xt, ni, To, Io, qe, Zt, lr, Ao, ar, ri, Eo, En, ii;
function bn(t, e) {
  return t.meta = {
...
const Ap = {
  ...
  [],
  "remarkPlugins"
), Ii = Y([], "nodeView"), Ai = Y([], "markView"), Bn = Y(
  vl().use(Nl).use(El),
  "remark"
), fi = Y(
  {
...
function fC(t) {
  const e = (n) => (n.inject(zh, t).inject(It, []).inject(Ti, []).inject(Ni, []).inject(Ii, []).inject(Ai, []).inject(fi, {
    ...
    return n.set(
      ...
      n.remove(zh).remove(It).remove(Ti).remove(Ni).remove(Ii).remove(Ai).remove(fi).remove(Bn).remove(el).clearTimer(_n);
    };
  });
  return bn(e, {
    displayName: "Init"
...
const pt = mn("SchemaReady"), tl = Y([], "schemaTimer"), Ht = Y({}, "schema"), yr = Y([], "nodes"), kr = Y([], "marks");
function Lh(t) {
  var e;
  return {
    ...t,
...
const Ep = (t) => (t.inject(Ht, {}).inject(yr, []).inject(kr, []).inject(tl, [_n]).record(pt), async () => {
  await t.waitTimers(tl);
  const e = t.get(Bn), r = t.get(Ti).reduce(
...
class Op {
  constructor() {
    be(this, or), be(this, An), ae(this, or, new df()), ae(this, An, null), this.setCtx = (e) => {
      ae(this, An, e);
    };
  }
  get ctx() {
  ...
  call(e, n) {
    if (L(this, An) == null) throw Bg();
    const i = this.get(e)(n), o = L(this, An).get(gr);
...
const X = Y(new Op(), "commands"), nl = Y([pt], "commandsTimer"), di = mn("CommandsReady"), Dp = (t) => {
  const e = new Op();
...
const mi = mn("SerializerReady"), il = Y(
  [],
  "serializerTimer"
), Pp = () => {
  throw ha();
...
const Ro = Y("", "defaultValue"), ol = Y(
  ...
  [],
  "editorStateTimer"
), vo = mn("EditorStateReady");
function pC(t, e, n) {
  if (typeof t == "string") return e(t);
  if (t.type === "html")
    return Hn.fromSchema(n).parse(t.dom);
  if (t.type === "json")
...
const Po = mn("EditorViewReady"), ll = Y(
  [],
  "editorViewTimer"
), gi = Y(
  {},
...
const wC = class _p {
  constructor() {
    be(this, sr), be(this, Xe), be(this, Xt), be(this, ni), be(this, To), be(this, Io), be(this, qe), be(this, Zt), be(this, lr), be(this, Ao), be(this, ar), be(this, ri), be(this, Eo), be(this, En), be(this, ii), ae(this, sr, !1), ae(this, Xe, "Idle"), ae(this, Xt, []), ae(this, ni, () => {
    }), ae(this, To, new df()), ae(this, Io, new Kg()), ae(this, qe, /* @__PURE__ */ new Map()), ae(this, Zt, /* @__PURE__ */ new Map()), ae(this, lr, new qg(L(this, To), L(this, Io))), ae(this, Ao, () => {
      const e = hC(async (r) => {
        await Promise.all(L(this, Xt).map((i) => i(r)));
      }), n = [
        Ep,
        vp,
        zp,
      ...
      L(this, ar).call(this, n, L(this, Zt));
    }), ae(this, ar, (e, n) => {
      e.forEach((r) => {
      ...
      await Promise.all(
        [...L(this, Zt).entries()].map(([e, { cleanup: n }]) => typeof n == "function" ? n() : n)
      ), L(this, Zt).clear();
    }), ae(this, En, (e) => {
    ...
    })), this.enableInspector = (e = !0) => (ae(this, sr, e), this), this.onStatusChange = (e) => (ae(this, ni, e), this), this.config = (e) => (L(this, Xt).push(e), this), this.removeConfig = (e) => (ae(this, Xt, L(this, Xt).filter((n) => n !== e)), this), this.use = (e) => {
      const n = [e].flat();
    ...
    })) : (await L(this, ri).call(this, [e].flat(), !0), this), this.create = async () => L(this, Xe) === "OnCreate" ? this : (L(this, Xe) === "Created" && await this.destroy(), L(this, En).call(this, "OnCreate"), L(this, Ao).call(this), L(this, ar).call(this, [...L(this, qe).keys()], L(this, qe)), await Promise.all(
      [
        L(this, ii).call(this, L(this, Zt)),
        L(this, ii).call(this, L(this, qe))
      ].flat()
    ), L(this, En).call(this, "Created"), this), this.destroy = async (e = !1) => L(this, Xe) === "Destroyed" || L(this, Xe) === "OnDestroy" ? this : L(this, Xe) === "OnCreate" ? new Promise((n) => {
      setTimeout(() => {
        n(this.destroy(e));
      }, 50);
    }) : (e && ae(this, Xt, []), L(this, En).call(this, "OnDestroy"), await L(this, ri).call(this, [...L(this, qe).keys()], e), await L(this, Eo).call(this), L(this, En).call(this, "Destroyed"), this), this.action = (e) => e(L(this, lr)), this.inspect = () => L(this, sr) ? [...L(this, Zt).values(), ...L(this, qe).values()].map(({ ctx: e }) => {
      var n;
...
function DC(t) {
  ...
  return Un(t, "definition", function(r) {
...
const qa = j(
  ...
  (t) => () => (e, n) => {
    ...
    if (r.empty) return !1;
    const { from: o, to: s } = r;
    return e.doc.rangeHasMark(o, s, an.type(t)) ? (n == null || n(i.removeMark(o, s, an.type(t))), !0) : (Object.keys(e.schema.marks).filter(
      (c) => c !== an.type.name
    ).map((c) => e.schema.marks[c]).forEach((c) => {
      i.removeMark(o, s, c);
    }), n == null || n(i.addMark(o, s, an.type(t).create())), !0);
  }
);
S(qa, {
...
const tn = j("WrapInHeading", (t) => (e) => (e ?? (e = 1), e < 1 ? xi(wn.type(t)) : xi(Yn.type(t), { level: e })));
S(tn, {
...
const Xa = j(
  ...
  (t) => () => (e, n, r) => {
    ...
    if (o.type !== Yn.type(t) || !e.selection.empty || i.parentOffset !== 0)
      return !1;
...
const lc = j(
  ...
  (t) => () => (e, n) => {
    ...
    return n == null || n(
      o.setMeta("hardbreak", !0).replaceSelectionWith($n.type(t).create()).scrollIntoView()
    ), !0;
  }
);
S(lc, {
...
const nm = j(
  ...
  (t) => () => (e, n) => {
    if (!n) return !0;
    const r = wn.node.type(t).create(), { tr: i, selection: o } = e, { from: s } = o, l = Vi.type(t).create();
    if (!l) return !0;
  ...
  appendTransaction: (e, n, r) => {
    ...
    if (o instanceof $t) {
      ...
      return r.doc.nodesBetween(c, u, (h, f) => {
        h.type === $n.type(t) && (a = a.setNodeMarkup(
          f,
          $n.type(t),
          void 0,
          []
...
function xS(t) {
  return function(e, n) {
    if (!st(e)) return !1;
    if (n) {
      const r = rt(e.schema), i = xn(e), o = e.tr, s = i.map.cellsInRect(
        t == "column" ? {
          left: i.left,
          top: 0,
          right: i.right,
...
function Dc(t, e) {
  return e = e || { useDeprecatedLogic: !1 }, e.useDeprecatedLogic ? xS(t) : function(n, r) {
    if (!st(n)) return !1;
    if (r) {
      const i = rt(n.schema), o = xn(n), s = n.tr, l = $h("row", o, i), a = $h(
        "column",
        o,
        i
...
function DS(t, e) {
  ...
  function o(a, c) {
    let u = al(t, c);
    const h = on.getState(t.state) == null;
    if (!u || !Oc(a, u))
      if (h) u = a;
      else return;
    const f = new se(a, u);
    if (h || !t.state.selection.eq(f)) {
      ...
      h && d.setMeta(on, a.pos), t.dispatch(d);
    }
  }
  function s() {
    t.root.removeEventListener("mouseup", s), t.root.removeEventListener("dragstart", s), t.root.removeEventListener("mousemove", l), on.getState(t.state) != null && t.dispatch(t.state.tr.setMeta(on, -1));
  }
  function l(a) {
    const c = a, u = on.getState(t.state);
    let h;
    if (u != null)
  ...
  return new Ne({
    ...
    props: {
      ...
      createSelectionBetween(e) {
        return on.getState(e.state) != null ? e.state.selection : null;
      },
...
let Mn = 48;
for (; Mn < 123; )
  Ot[Mn] = jt, Mn++, Mn === 58 ? Mn = 65 : Mn === 91 && (Mn = 97);
Ot[43] = jt;
Ot[45] = jt;
Ot[46] = jt;
Ot[95] = jt;
...
function Br(t, e, n, r) {
  ...
  return s;
  function s(a) {
    return Dn(a) ? (t.enter(n), l(a)) : e(a);
  }
  function l(a) {
    return Dn(a) && o++ < i ? (t.consume(a), l) : (t.exit(n), e(a));
  }
}
class DN {
  /**
...
function zN(t, e, n) {
  ...
  function u(x) {
    return x === null ? n(x) : no(x) ? o > 1 ? (o = 0, r.interrupt = !0, t.exit("tableRow"), t.enter("lineEnding"), t.consume(x), t.exit("lineEnding"), d) : n(x) : Dn(x) ? Br(t, u, "whitespace")(x) : (o += 1, s && (s = !1, i += 1), x === 124 ? (t.enter("tableCellDivider"), t.consume(x), t.exit("tableCellDivider"), s = !0, u) : (t.enter("data"), h(x)));
  }
  function h(x) {
  ...
  function d(x) {
    return r.interrupt = !1, r.parser.lazy[r.now().line] ? n(x) : (t.enter("tableDelimiterRow"), s = !1, Dn(x) ? Br(t, p, "linePrefix", r.parser.constructs.disable.null.includes("codeIndented") ? void 0 : 4)(x) : p(x));
  }
  function p(x) {
    return x === 45 || x === 58 ? y(x) : x === 124 ? (s = !0, t.enter("tableCellDivider"), t.consume(x), t.exit("tableCellDivider"), m) : I(x);
  }
  function m(x) {
    return Dn(x) ? Br(t, y, "whitespace")(x) : y(x);
  }
  function y(x) {
  ...
  function C(x) {
    return Dn(x) ? Br(t, v, "whitespace")(x) : v(x);
  }
  function v(x) {
  ...
  function z(x) {
    return x === 124 ? (t.enter("tableCellDivider"), t.consume(x), t.exit("tableCellDivider"), z) : x === null || no(x) ? (t.exit("tableRow"), e(x)) : Dn(x) ? Br(t, z, "whitespace")(x) : (t.enter("data"), W(x));
  }
  function W(x) {
...
const pT = 20;
function mT(t, e, n, r) {
  let i = n.getMeta(Vn), o;
  if (i)
    return i.historyState;
  n.getMeta(kT) && (t = new nn(t.done, t.undone, null, 0, -1));
  let s = n.getMeta("appendedTransaction");
  if (n.steps.length == 0)
    return t;
  if (s && s.getMeta(Vn))
    return s.getMeta(Vn).redo ? new nn(t.done.addTransform(n, void 0, r, Bo(e)), t.undone, lf(n.mapping.maps), t.prevTime, t.prevComposition) : new nn(t.done, t.undone.addTransform(n, void 0, r, Bo(e)), null, t.prevTime, t.prevComposition);
  if (n.getMeta("addToHistory") !== !1 && !(s && s.getMeta("addToHistory") === !1)) {
    ...
    return new nn(t.done.addTransform(n, a ? e.selection.getBookmark() : void 0, r, Bo(e)), ht.empty, c, n.time, l ?? t.prevComposition);
  } else return (o = n.getMeta("rebased")) ? new nn(t.done.rebased(n, o), t.undone.rebased(n, o), gl(t.prevRanges, n.mapping), t.prevTime, t.prevComposition) : new nn(t.done.addMaps(n.mapping.maps), t.undone.addMaps(n.mapping.maps), gl(t.prevRanges, n.mapping), t.prevTime, t.prevComposition);
}
function gT(t, e) {
  if (!e)
    return !1;
...
function yT(t, e, n) {
  let r = Bo(e), i = Vn.get(e).spec.config, o = (n ? t.undone : t.done).popEvent(e, r);
  if (!o)
    return null;
  let s = o.selection.resolve(o.transform.doc), l = (n ? t.done : t.undone).addTransform(o.transform, e.selection.getBookmark(), i, r), a = new nn(n ? l : o.remaining, n ? o.remaining : l, null, 0, -1);
  return o.transform.setSelection(s).setMeta(Vn, { redo: n, historyState: a });
}
let yl = !1, af = null;
function Bo(t) {
  let e = t.plugins;
...
const Vn = new ge("history"), kT = new ge("closeHistory");
function bT(t = {}) {
  return t = {
    depth: t.depth || 100,
    ...
    state: {
      init() {
        return new nn(ht.empty, ht.empty, null, 0, -1);
      },
      apply(e, n, r) {
        return mT(n, r, e, t);
      }
...
`)), i.dispatch(I), !0;
        ...
        const m = Hn.fromSchema(e);
        let y;
        if (p.length === 0) {
          const C = a(f);
          if (!C || typeof C == "string") return !1;
          y = Jn.fromSchema(e).serializeFragment(
            C.content
          );
        } else {
...
async function OT(t, e, n) {
  switch (t) {
    case "code-mirror": {
      const { defineFeature: r } = await import("./index-B3KiKTSt-OxBhrVGz.js").then((i) => i.E);
      return r(e, n);
    }
    case "list-item": {
      const { defineFeature: r } = await import("./index-Cuk7cL-r-CvOU05ri.js");
      return r(e, n);
    }
    case "link-tooltip": {
      const { defineFeature: r } = await import("./index-DcRgwPLd-BUPhyazX.js");
      return r(e, n);
    }
    case "image-block": {
      const { defineFeature: r } = await import("./index-BFsG6770-C8NGpKs8.js");
      return r(e, n);
    }
    case "cursor": {
      const { defineFeature: r } = await import("./index-CxJ9fxJm-CqVsyBbP.js");
      return r(e, n);
    }
    case "block-edit": {
      const { defineFeature: r } = await import("./index-uHWmZXqe-CPKIINf2.js");
      return r(e, n);
    }
    case "placeholder": {
      const { defineFeature: r } = await import("./index-DOrkOhki-L_QaWckk.js");
      return r(e, n);
    }
    case "toolbar": {
      const { defineFeature: r } = await import("./index-CsEtSFhk-CNdBje75.js");
      return r(e, n);
    }
    case "table": {
      const { defineFeature: r } = await import("./index-CBrOT1fW-mRG4QCK2.js");
      return r(e, n);
    }
    case "latex": {
      const { defineFeature: r } = await import("./index-s33c_M2f-XGc11tjM.js");
      return r(e, n);
    }
  }
}
...
class bg extends HTMLElement {
  constructor() {
    super(...arguments);
    qt(this, "editor", null);
    qt(this, "editorContainer", null);
    qt(this, "shadowRoot", null);
    qt(this, "defaultMarkdown", "<calc>");
    ...
    qt(this, "isInitializing", !1);
    // Flag per indicare che l'update viene dall'editor stesso (non da Angular)
    qt(this, "isInternalUpdate", !1);
    // Ultimo valore markdown conosciuto dall'editor (per evitare refresh inutili)
    qt(this, "lastKnownEditorMarkdown", null);
  }
  ...
  attributeChangedCallback(n, r, i) {
    var o;
    if (n === "markdown" && r !== i) {
      if (this.isInternalUpdate || this.isInitializing || typeof i != "string" || !this.editor || this.lastKnownEditorMarkdown !== null && i === this.lastKnownEditorMarkdown)
        return;
    ...
    this.editor && this.editor.on((n) => {
      n.markdownUpdated(() => {
        if (!this.editor || typeof this.editor.getMarkdown != "function")
          return;
        const r = this.editor.getMarkdown();
        this.lastKnownEditorMarkdown = r, this.getAttribute("markdown") !== r && (this.isInternalUpdate = !0, this.setAttribute("markdown", r), this.isInternalUpdate = !1);
        const o = new CustomEvent("markdownChange", {
          detail: { markdown: r },
          bubbles: !0,
          composed: !0
        });
  ...
  async initEditor() {
    if (this.editorContainer)
      try {
        ...
        const n = this.markdown;
        this.lastKnownEditorMarkdown = n, this.editor = new ua({
          root: this.editorContainer,
          defaultValue: n
