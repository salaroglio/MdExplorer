import { L as w, E as m, a as v } from "./index-Crfuao6v.js";
import { c as Z, t as o, b as R, a as z, h as W, i as x, f as T, d as U, l as E, N as Y, I as _ } from "./index-B3KiKTSt-Dla4yOC_.js";
const G = 101, S = 1, C = 102, q = 103, h = 2, $ = [
  9,
  10,
  11,
  12,
  ...
  8287,
  12288
], N = 58, V = 40, P = 95, D = 91, p = 45, I = 46, F = 35, B = 37, K = 38, j = 92, L = 10;
function d(e) {
...
const A = new m((e, t) => {
  for (let l = !1, a = 0, O = 0; ; O++) {
    ...
    else if (r == j && e.peek(1) != L)
      e.advance(), e.next > -1 && e.advance(), l = !0;
    else {
      l && e.acceptToken(r == V ? C : a == 2 && t.canShift(h) ? h : q);
      break;
    }
  }
}), J = new m((e) => {
  if ($.includes(e.peek(-1))) {
    let { next: t } = e;
    (d(t) || t == P || t == F || t == I || t == D || t == N && d(e.peek(1)) || t == p || t == K) && e.acceptToken(G);
  }
}), H = new m((e) => {
  if (!$.includes(e.peek(-1))) {
    let { next: t } = e;
  ...
  tokenizers: [J, H, A, 1, 2, 3, 4, new v("m~RRYZ[z{a~~g~aO#`~~dP!P!Qg~lO#a~~", 28, 107)],
  topRules: { StyleSheet: [0, 4], Styles: [1, 87] },
  specialized: [{ term: 102, get: (e) => ee[e] || -1 }, { term: 59, get: (e) => Oe[e] || -1 }, { term: 103, get: (e) => ae[e] || -1 }],
  tokenPrec: 1246
});
let Q = null;
function u() {
  if (!Q && typeof document == "object" && document.body) {
    ...
    Q = t.sort().map((a) => ({ type: "property", label: a, apply: a + ": " }));
  }
  return Q || [];
}
const f = /* @__PURE__ */ [
  ...
  "visited",
  "where"
].map((e) => ({ type: "class", label: e })), y = /* @__PURE__ */ [
  "above",
  "absolute",
  "activeborder",
  "additive",
...
const g = /* @__PURE__ */ new Y(), ne = ["Declaration"];
function se(e) {
  for (let t = e; ; ) {
    if (t.type.isTop)
      return t;
...
const de = (e) => (t) => {
  ...
  return n && n.name == ":" && i.name == "PseudoClassSelector" ? { from: a, options: f, validFor: s } : n && n.name == ":" && i.name == "Declaration" || i.name == "ArgList" ? { from: a, options: y, validFor: s } : i.name == "Block" || i.name == "Styles" ? { from: a, options: u(), validFor: s } : null;
}, ce = /* @__PURE__ */ de((e) => e.name == "VariableName"), b = /* @__PURE__ */ R.define({
  name: "css",
...
function ue() {
  return new z(b, b.data.of({ autocomplete: ce }));
}
export {
  ue as css,
