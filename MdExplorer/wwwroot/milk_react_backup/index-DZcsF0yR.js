import { L as n, a, S as s } from "./index-B3KiKTSt-OxBhrVGz.js";
function t(e) {
  return new a(s.define(e));
}
function o(e) {
  return import("./index-DKwvP297.js").then((r) => r.sql({ dialect: r[e] }));
}
const m = [
  ...
  /* @__PURE__ */ n.of({
    ...
    extensions: ["c", "h", "ino"],
    load() {
      return import("./index-0rJGkPS1.js").then((e) => e.cpp());
    }
  }),
  /* @__PURE__ */ n.of({
    name: "C++",
  ...
  /* @__PURE__ */ n.of({
    ...
    extensions: ["css"],
    load() {
      return import("./index-DD5uvdY0.js").then((e) => e.css());
    }
  }),
  /* @__PURE__ */ n.of({
    name: "Go",
    extensions: ["go"],
    load() {
      return import("./index-u0HCCujA.js").then((e) => e.go());
    }
  }),
  /* @__PURE__ */ n.of({
    name: "HTML",
    ...
    load() {
      return import("./index-eQn9z457.js").then((e) => e.html());
    }
  }),
  /* @__PURE__ */ n.of({
    name: "Java",
    extensions: ["java"],
    load() {
      return import("./index-i6x5htAN.js").then((e) => e.java());
    }
  }),
  /* @__PURE__ */ n.of({
    name: "JavaScript",
    ...
    load() {
      return import("./index-B201zIVb.js").then((e) => e.javascript());
    }
  }),
  /* @__PURE__ */ n.of({
    name: "JSON",
    ...
    extensions: ["json", "map"],
    load() {
      return import("./index-BKdbeoKr.js").then((e) => e.json());
    }
  }),
  /* @__PURE__ */ n.of({
    name: "JSX",
    extensions: ["jsx"],
    load() {
      return import("./index-B201zIVb.js").then((e) => e.javascript({ jsx: !0 }));
    }
  }),
  /* @__PURE__ */ n.of({
    name: "LESS",
    extensions: ["less"],
    load() {
      return import("./index-DocFNEg8.js").then((e) => e.less());
    }
  }),
  /* @__PURE__ */ n.of({
    name: "Liquid",
    extensions: ["liquid"],
    load() {
      return import("./index-BpIfDScv.js").then((e) => e.liquid());
    }
  }),
  /* @__PURE__ */ n.of({
    name: "MariaDB SQL",
  ...
  /* @__PURE__ */ n.of({
    ...
    load() {
      return import("./index-C2vL5dVl.js").then((e) => e.markdown());
    }
  }),
  /* @__PURE__ */ n.of({
    name: "MS SQL",
  ...
  /* @__PURE__ */ n.of({
    ...
    load() {
      return import("./index-DSVO_NBp.js").then((e) => e.php());
    }
  }),
  /* @__PURE__ */ n.of({
    name: "PLSQL",
  ...
  /* @__PURE__ */ n.of({
    ...
    filename: /^(BUCK|BUILD)$/,
    load() {
      return import("./index-CiKrp5Ox.js").then((e) => e.python());
    }
  }),
  /* @__PURE__ */ n.of({
    name: "Rust",
    extensions: ["rs"],
    load() {
      return import("./index-DIKsnkDP.js").then((e) => e.rust());
    }
  }),
  /* @__PURE__ */ n.of({
    name: "Sass",
    extensions: ["sass"],
    load() {
      return import("./index-DPQlGYFu.js").then((e) => e.sass({ indented: !0 }));
    }
  }),
  /* @__PURE__ */ n.of({
    name: "SCSS",
    extensions: ["scss"],
    load() {
      return import("./index-DPQlGYFu.js").then((e) => e.sass());
    }
  }),
  /* @__PURE__ */ n.of({
    name: "SQL",
  ...
  /* @__PURE__ */ n.of({
    ...
    extensions: ["tsx"],
    load() {
      return import("./index-B201zIVb.js").then((e) => e.javascript({ jsx: !0, typescript: !0 }));
    }
  }),
  /* @__PURE__ */ n.of({
    name: "TypeScript",
    ...
    load() {
      return import("./index-B201zIVb.js").then((e) => e.javascript({ typescript: !0 }));
    }
  }),
  /* @__PURE__ */ n.of({
    name: "WebAssembly",
    extensions: ["wat", "wast"],
    load() {
      return import("./index-DnK91IHO.js").then((e) => e.wast());
    }
  }),
  /* @__PURE__ */ n.of({
    name: "XML",
    ...
    load() {
      return import("./index-DnxQznc6.js").then((e) => e.xml());
    }
  }),
  /* @__PURE__ */ n.of({
    name: "YAML",
    ...
    extensions: ["yaml", "yml"],
    load() {
      return import("./index-CDkjB7zj.js").then((e) => e.yaml());
    }
  }),
  ...
  /* @__PURE__ */ n.of({
    ...
    extensions: ["vue"],
    load() {
      return import("./index-D8X-Esdj.js").then((e) => e.vue());
    }
  }),
  /* @__PURE__ */ n.of({
    name: "Angular Template",
    load() {
      return import("./index-CfMg0p0W.js").then((e) => e.angular());
    }
  })
];
export {
