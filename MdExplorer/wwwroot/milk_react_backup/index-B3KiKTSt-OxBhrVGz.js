...
`, bf = (n, e = {}) => {
  n.config(async (t) => {
    ...
    if (!i) {
      const { languages: s } = await import("./index-DZcsF0yR.js");
      i = s;
    }
    if (!r) {
      const { oneDark: s } = await import("./index-BBgzZFeP.js");
      r = s;
    }
    t.update(Zs.key, (s) => {
      var o;
