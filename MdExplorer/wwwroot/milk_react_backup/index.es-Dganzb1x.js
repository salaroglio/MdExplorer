import { ai as ro, aj as oo, ak as lo, $ as ho, a as ao, y as co, T as li, ah as fo, ag as ys, al as uo } from "./integration-BHt4Ncdo.js";
import { h as Fe, b as po, u as go, d as Se, p as Ce, f as mo, i as vt, T as wo } from "./functions-Bsik6ikd-DhlhsyMB.js";
import { u as hi, a as ke } from "./hooks-CCspbR-r.js";
import { c as bo } from "./floating-ui.dom-C8djGRJz.js";
let xi = [], Dn = [];
(() => {
  ...
  for (let t = 0, e = 0; t < n.length; t++)
    (t % 2 ? Dn : xi).push(e = e + n[t]);
})();
function yo(n) {
  if (n < 768) return !1;
  for (let t = 0, e = xi.length; ; ) {
    let i = t + e >> 1;
    if (n < xi[i]) e = i;
    else if (n >= Dn[i]) t = i + 1;
    else return !0;
    if (t == e) return !1;
  }
}
...
const xs = 8205;
function vo(n, t, e = !0, i = !0) {
  return (e ? Tn : xo)(n, t, i);
}
function Tn(n, t, e) {
  if (t == n.length) return t;
  t && En(n.charCodeAt(t)) && Rn(n.charCodeAt(t - 1)) && t--;
  let i = ai(n, t);
  for (t += Ss(i); t < n.length; ) {
    let s = ai(n, t);
    if (i == xs || s == xs || e && yo(s))
      t += Ss(s), i = s;
    else if (vs(s)) {
...
function ai(n, t) {
  ...
  if (!Rn(e) || t + 1 == n.length) return e;
  let i = n.charCodeAt(t + 1);
  return En(i) ? (e - 55296 << 10) + (i - 56320) + 65536 : e;
}
function En(n) {
...
class E {
  ...
  */
  replace(t, e, i) {
    ...
    return this.decompose(
      ...
      1
      /* Open.From */
    ), at.from(s, this.length - (e - t) + i.length);
  }
  /**
  ...
  */
  slice(t, e = this.length) {
    [t, e] = zt(this, t, e);
    let i = [];
    return this.decompose(t, e, i, 0), at.from(i, e - t);
  }
  /**
  ...
  */
  eq(t) {
    ...
    if (t.length != this.length || t.lines != this.lines)
      return !1;
    let e = this.scanIdentical(t, 1), i = this.length - this.scanIdentical(t, -1), s = new ne(this), r = new ne(t);
    for (let o = e, l = e; ; ) {
  ...
  */
  static of(t) {
    ...
    return t.length == 1 && !t[0] ? E.empty : t.length <= 32 ? new V(t) : at.from(V.split(t, []));
  }
}
class V extends E {
  constructor(t, e = So(t)) {
  ...
  lineInner(t, e, i, s) {
    for (let r = 0; ; r++) {
      ...
      if ((e ? i : l) >= t)
        return new Co(s, l, i, o);
      s = l + 1, i++;
    }
  }
  decompose(t, e, i, s) {
    let r = t <= 0 && e >= this.length ? this : new V(Cs(this.text, t, e), Math.min(e, this.length) - Math.max(0, t));
    if (s & 1) {
      let o = i.pop(), l = We(r.text, o.text.slice(), 0, r.length);
      if (l.length <= 32)
        i.push(new V(l, o.length + r.length));
      else {
        let h = l.length >> 1;
        i.push(new V(l.slice(0, h)), new V(l.slice(h)));
      }
    } else
      i.push(r);
  }
  replace(t, e, i) {
    ...
    [t, e] = zt(this, t, e);
    let s = We(this.text, We(i.text, Cs(this.text, 0, t)), e), r = this.length + i.length - (e - t);
    return s.length <= 32 ? new V(s, r) : at.from(V.split(s, []), r);
  }
...
`) {
  ...
  static split(t, e) {
    let i = [], s = -1;
    for (let r of t)
      i.push(r), s += r.length + 1, i.length == 32 && (e.push(new V(i, s)), i = [], s = -1);
    return s > -1 && e.push(new V(i, s)), e;
  }
}
class at extends E {
  constructor(t, e) {
  ...
  replace(t, e, i) {
    if ([t, e] = zt(this, t, e), i.lines < this.lines)
      for (let s = 0, r = 0; s < this.children.length; s++) {
        ...
        if (t >= r && e <= l) {
          ...
          if (h.lines < a >> 4 && h.lines > a >> 6) {
            ...
            return c[s] = h, new at(c, this.length - (e - t) + i.length);
          }
    ...
    function f(d) {
      ...
      if (d.lines > r && d instanceof at)
        for (let g of d.children)
          f(g);
      else d.lines > o && (h > o || !h) ? (u(), l.push(d)) : d instanceof V && h && (p = c[c.length - 1]) instanceof V && d.lines + p.lines <= 32 ? (h += d.lines, a += d.length + 1, c[c.length - 1] = new V(p.text.concat(d.text), p.length + 1 + d.length)) : (h + d.lines > s && u(), h += d.lines, a += d.length + 1, c.push(d));
    }
    function u() {
      h != 0 && (l.push(c.length == 1 ? c[0] : at.from(c, a)), a = -1, h = c.length = 0);
    }
    for (let d of t)
      f(d);
    return u(), l.length == 1 ? l[0] : new at(l, e);
  }
}
E.empty = /* @__PURE__ */ new V([""], 0);
function So(n) {
  let t = -1;
  for (let e of n)
    t += e.length + 1;
...
class ne {
  constructor(t, e = 1) {
    this.dir = e, this.done = !1, this.lineBreak = !1, this.value = "", this.nodes = [t], this.offsets = [e > 0 ? 1 : (t instanceof V ? t.text.length : t.children.length) << 1];
  }
  nextInner(t, e) {
    for (this.done = this.lineBreak = !1; ; ) {
      let i = this.nodes.length - 1, s = this.nodes[i], r = this.offsets[i], o = r >> 1, l = s instanceof V ? s.text.length : s.children.length;
      if (o == (e > 0 ? l : 0)) {
        if (i == 0)
...
`, this;
        ...
        t > h.length ? (t -= h.length, this.offsets[i] += e) : (e < 0 && this.offsets[i]--, this.nodes.push(h), this.offsets.push(e > 0 ? 1 : (h instanceof V ? h.text.length : h.children.length) << 1));
      }
    }
  }
  next(t = 0) {
...
typeof Symbol < "u" && (E.prototype[Symbol.iterator] = function() {
  return this.iter();
}, ne.prototype[Symbol.iterator] = Pn.prototype[Symbol.iterator] = Ln.prototype[Symbol.iterator] = function() {
  return this;
});
class Co {
  /**
...
function Bn(n, t) {
  let e = n.charCodeAt(t);
  if (!Mo(e) || t + 1 == n.length)
    return e;
  let i = n.charCodeAt(t + 1);
  return ko(i) ? (e - 55296 << 10) + (i - 56320) + 65536 : e;
}
function Sa(n) {
...
class wt {
  ...
  */
  mapDesc(t, e = !1) {
    return t.empty ? this : ki(this, t, e);
  }
  mapPos(t, e = -1, i = Z.Simple) {
    let s = 0, r = 0;
    for (let o = 0; o < this.sections.length; ) {
      ...
      if (h < 0) {
        ...
        if (i != Z.Simple && a >= t && (i == Z.TrackDel && s < t && a > t || i == Z.TrackBefore && s < t || i == Z.TrackAfter && a > t))
          return null;
        if (a > t || a == t && e < 0 && !l)
...
class q extends wt {
  ...
  */
  apply(t) {
    ...
    return Ci(this, (e, i, s, r, o) => t = t.replace(s, s + (i - e), o), !1), t;
  }
  mapDesc(t, e = !1) {
  ...
  */
  map(t, e = !1) {
    return t.empty ? this : ki(this, t, e, !0);
  }
  /**
  ...
  filter(t) {
    ...
    t: for (let o = 0, l = 0; ; ) {
      ...
      for (; l < h || l == h && r.len == 0; ) {
        ...
        Y(e, c, f), f > 0 && St(i, e, r.text), r.forward(c), l += c;
      }
      let a = t[o++];
      for (; l < a; ) {
        if (r.done)
        ...
        Y(e, c, -1), Y(s, c, r.ins == -1 ? -1 : r.off == 0 ? r.ins : 0), r.forward(c), l += c;
      }
    }
    return {
      changes: new q(e, i),
      filtered: wt.create(s)
    };
  }
  /**
  ...
  static of(t, e, i) {
    ...
    function a(c) {
      if (Array.isArray(c))
        ...
        let p = d ? typeof d == "string" ? E.of(d.split(i || Si)) : d : E.empty, g = p.length;
        if (f == u && g == 0)
          return;
        f < o && h(), f > o && Y(s, f - o, -1), Y(s, u - f, g), St(r, s, p), o = u;
      }
    }
    return a(t), h(!l), l;
  }
    ...
    for (let s = 0; s < t.length; s++) {
      ...
      if (typeof r == "number")
        ...
        if (r.length == 1)
          ...
          for (; i.length < s; )
            i.push(E.empty);
          i[s] = E.of(r.slice(1)), e.push(r[0], i[s].length);
        }
      }
    }
    return new q(e, i);
...
function ki(n, t, e, i = !1) {
  let s = [], r = i ? [] : null, o = new ae(n), l = new ae(t);
  for (let h = -1; ; ) {
    if (o.done && l.len || l.done && o.len)
      throw new Error("Mismatched change set lengths");
    if (o.ins == -1 && l.ins == -1) {
      let a = Math.min(o.len, l.len);
      Y(s, a, -1), o.forward(a), l.forward(a);
    } else if (l.ins >= 0 && (o.ins < 0 || h == o.i || o.off == 0 && (l.len < o.len || l.len == o.len && !e))) {
      let a = l.len;
      for (Y(s, l.ins, -1); a; ) {
        let c = Math.min(o.len, a);
        o.ins >= 0 && h < o.i && o.len <= c && (Y(s, 0, o.ins), r && St(r, s, o.text), h = o.i), o.forward(c), a -= c;
      }
      l.next();
    } else if (o.ins >= 0) {
      let a = 0, c = o.len;
      for (; c; )
        if (l.ins == -1) {
          ...
          break;
      Y(s, a, h < o.i ? o.ins : 0), r && h < o.i && St(r, s, o.text), h = o.i, o.forward(o.len - c);
    } else {
      if (o.done && l.done)
        return r ? q.createSet(s, r) : wt.create(s);
      throw new Error("Mismatched change set lengths");
    }
  }
}
function Nn(n, t, e = !1) {
  let i = [], s = e ? [] : null, r = new ae(n), o = new ae(t);
  for (let l = !1; ; ) {
    if (r.done && o.done)
      return s ? q.createSet(i, s) : wt.create(i);
    if (r.ins == 0)
      Y(i, r.len, 0, l), r.next();
    else if (o.len == 0 && !o.done)
      Y(i, 0, o.ins, l), s && St(s, i, o.text), o.next();
    else {
      if (r.done || o.done)
        throw new Error("Mismatched change set lengths");
      {
        ...
        if (r.ins == -1) {
          ...
          Y(i, h, c, l), s && c && St(s, i, o.text);
        } else o.ins == -1 ? (Y(i, r.off ? 0 : r.len, h, l), s && St(s, i, r.textBit(h))) : (Y(i, r.off ? 0 : r.len, o.off ? 0 : o.ins, l), s && !o.off && St(s, i, o.text));
...
class Tt {
  ...
  */
  map(t, e = -1) {
    let i, s;
    return this.empty ? i = s = t.mapPos(this.from, e) : (i = t.mapPos(this.from, 1), s = t.mapPos(this.to, -1)), i == this.from && s == this.to ? this : new Tt(i, s, this.flags);
  }
  /**
...
class x {
  ...
  */
  static fromJSON(t) {
    ...
    return new x(t.ranges.map((e) => Tt.fromJSON(e)), t.main);
  }
  /**
  ...
  */
  static cursor(t, e = 0, i, s) {
    return Tt.create(t, t, (e == 0 ? 0 : e < 0 ? 8 : 16) | (i == null ? 7 : Math.min(6, i)) | (s ?? 16777215) << 6);
  }
  /**
  ...
  */
  static range(t, e, i, s) {
    ...
    return e < t ? Tt.create(e, t, 48 | r) : Tt.create(t, e, (e > t ? 8 : 0) | r);
  }
  /**
  @internal
  */
  static normalized(t, e = 0) {
    ...
    for (let s = 1; s < t.length; s++) {
      ...
      if (r.empty ? r.from <= o.to : r.from < o.to) {
        ...
        s <= e && e--, t.splice(--s, 2, r.anchor > r.head ? x.range(h, l) : x.range(l, h));
      }
    }
    return new x(t, e);
  }
...
class M {
  constructor(t, e, i, s, r) {
    this.combine = t, this.compareInput = e, this.compare = i, this.isStatic = s, this.id = is++, this.default = t([]), this.extensions = typeof r == "function" ? r(this) : r;
  }
  /**
  ...
  */
  static define(t = {}) {
    return new M(t.combine || ((e) => e), t.compareInput || ((e, i) => e === i), t.compare || (t.combine ? (e, i) => e === i : ss), !!t.static, t.enables);
  }
  /**
  Returns an extension that adds the given value to this facet.
  */
  of(t) {
    return new ze([], this, 0, t);
  }
  /**
...
class ze {
  constructor(t, e, i, s) {
    this.dependencies = t, this.facet = e, this.type = i, this.value = s, this.id = is++;
  }
  dynamicSlot(t) {
    var e;
    ...
    return {
      ...
      update(f, u) {
        if (h && u.docChanged || a && (u.docChanged || u.selection) || Mi(f, c)) {
          let d = i(f);
          if (l ? !ks(d, f.values[o], s) : !s(d, f.values[o]))
      ...
      reconfigure: (f, u) => {
        ...
        if (p != null) {
          let g = _e(u, p);
          if (this.dependencies.every((m) => m instanceof M ? u.facet(m) === f.facet(m) : m instanceof Ot ? u.field(m, !1) == f.field(m, !1) : !0) || (l ? ks(d = i(f), g, s) : s(d = i(f), g)))
...
function Oo(n, t, e) {
  ...
  return {
    ...
    reconfigure(h, a) {
      let c = Mi(h, i), f = a.config.facets[t.id], u = a.facet(t);
      if (f && !c && ss(e, f))
...
const Me = /* @__PURE__ */ M.define({ static: !0 });
class Ot {
  constructor(t, e, i, s, r) {
  ...
  */
  static define(t) {
    let e = new Ot(is++, t.create, t.update, t.compare || ((i, s) => i === s), t);
    return t.provide && (e.provides = t.provide(e)), e;
  }
  create(t) {
    let e = t.facet(Me).find((i) => i.field == this);
  ...
  */
  slot(t) {
    ...
    return {
      ...
      reconfigure: (i, s) => {
        let r = i.facet(Me), o = s.facet(Me), l;
        return (l = r.find((h) => h.field == this)) && l != o.find((h) => h.field == this) ? (i.values[e] = l.create(i), 1) : s.config.address[this.id] != null ? (i.values[e] = s.field(this), 0) : (i.values[e] = this.create(i), 1);
      }
    };
  }
  /**
  ...
  */
  init(t) {
    return [this, Me.of({ field: this, create: t })];
  }
  /**
...
const ns = {
  ...
  */
  highest: /* @__PURE__ */ _t(Dt.highest),
  /**
  A higher-than-default precedence, for extensions that should
  come before those with default precedence.
  */
  high: /* @__PURE__ */ _t(Dt.high),
  /**
  The default precedence, which is also used for extensions
  without an explicit precedence.
  */
  default: /* @__PURE__ */ _t(Dt.default),
  /**
  A lower-than-default precedence.
  */
  low: /* @__PURE__ */ _t(Dt.low),
  /**
  The lowest precedence level. Meant for things that should end up
  near the end of the extension order.
  */
  lowest: /* @__PURE__ */ _t(Dt.lowest)
};
class In {
  constructor(t, e) {
...
class $t {
  ...
  */
  reconfigure(t) {
    return $t.reconfigure.of({ compartment: this, extension: t });
  }
  /**
...
class Ue {
  ...
  static resolve(t, e, i) {
    ...
    for (let u of Do(t, e, o))
      u instanceof Ot ? s.push(u) : (r[u.facet.id] || (r[u.facet.id] = [])).push(u);
    ...
    for (let u in r) {
      ...
      if (d.every(
        ...
        if (l[p.id] = h.length << 1 | 1, ss(g, d))
          h.push(i.facet(p));
        else {
          let m = p.combine(d.map((w) => w.value));
          h.push(i && p.compare(m, i.facet(p)) ? i.facet(p) : m);
        }
      else {
        for (let m of d)
          m.type == 0 ? (l[m.id] = h.length << 1 | 1, h.push(m.value)) : (l[m.id] = a.length << 1, a.push((w) => m.dynamicSlot(w)));
        l[p.id] = a.length << 1, a.push((m) => Oo(m, p, d));
      }
    }
    let f = a.map((u) => u(l));
    return new Ue(t, o, f, l, h, r);
  }
}
function Do(n, t, e) {
  ...
  function r(o, l) {
    ...
    if (h != null) {
      if (h <= l)
        return;
      let a = i[h].indexOf(o);
      a > -1 && i[h].splice(a, 1), o instanceof Ai && e.delete(o.compartment);
    }
...
const Vn = /* @__PURE__ */ M.define(), Oi = /* @__PURE__ */ M.define({
  combine: (n) => n.some((t) => t),
  static: !0
}), Fn = /* @__PURE__ */ M.define({
  combine: (n) => n.length ? n[0] : void 0,
  static: !0
}), Wn = /* @__PURE__ */ M.define(), zn = /* @__PURE__ */ M.define(), $n = /* @__PURE__ */ M.define(), qn = /* @__PURE__ */ M.define({
...
class X {
  constructor(t, e, i, s, r, o) {
    this.startState = t, this.changes = e, this.selection = i, this.effects = s, this.annotations = r, this.scrollIntoView = o, this._doc = null, this._state = null, i && Hn(i, e.newLength), r.some((l) => l.type == X.time) || (this.annotations = r.concat(X.time.of(Date.now())));
  }
  /**
  @internal
  */
  static create(t, e, i, s, r, o) {
    return new X(t, e, i, s, r, o);
  }
  /**
  ...
  */
  isUserEvent(t) {
    let e = this.annotation(X.userEvent);
    return !!(e && (e == t || e.length > t.length && e.slice(0, t.length) == t && e[t.length] == "."));
  }
}
X.time = /* @__PURE__ */ Xt.define();
X.userEvent = /* @__PURE__ */ Xt.define();
X.addToHistory = /* @__PURE__ */ Xt.define();
X.remote = /* @__PURE__ */ Xt.define();
function Ro(n, t) {
  let e = [];
  for (let i = 0, s = 0; ; ) {
    let r, o;
...
function Di(n, t, e) {
  let i = t.selection, s = Vt(t.annotations);
  return t.userEvent && (s = s.concat(X.userEvent.of(t.userEvent))), {
    changes: t.changes instanceof q ? t.changes : q.of(t.changes || [], e, n.facet(Fn)),
    selection: i && (i instanceof x ? i : x.single(i.anchor, i.head)),
    effects: Vt(t.effects),
    annotations: s,
    scrollIntoView: !!t.scrollIntoView
  };
}
function jn(n, t, e) {
  let i = Di(n, t.length ? t[0] : {}, n.doc.length);
  t.length && t[0].filter === !1 && (e = !1);
  for (let r = 1; r < t.length; r++) {
    t[r].filter === !1 && (e = !1);
    let o = !!t[r].sequential;
    i = Kn(i, Di(n, t[r], o ? i.changes.newLength : n.doc.length), o);
  }
  let s = X.create(n, i.changes, i.selection, i.effects, i.annotations, i.scrollIntoView);
  return Lo(e ? Po(s) : s);
}
function Po(n) {
  let t = n.startState, e = !0;
  for (let s of t.facet(Wn)) {
    let r = s(n);
    if (r === !1) {
      e = !1;
      break;
    }
    Array.isArray(r) && (e = e === !0 ? r : Ro(e, r));
  }
  if (e !== !0) {
    let s, r;
    if (e === !1)
    ...
    n = X.create(t, s, n.selection && n.selection.map(r), F.mapEffects(n.effects, r), n.annotations, n.scrollIntoView);
  }
  let i = t.facet(zn);
  for (let s = i.length - 1; s >= 0; s--) {
    let r = i[s](n);
    r instanceof X ? n = r : Array.isArray(r) && r.length == 1 && r[0] instanceof X ? n = r[0] : n = jn(t, Vt(r), !1);
  }
  return n;
}
function Lo(n) {
  let t = n.startState, e = t.facet($n), i = n;
  for (let s = e.length - 1; s >= 0; s--) {
    let r = e[s](n);
    r && Object.keys(r).length && (i = Kn(i, Di(t, r, n.changes.newLength), !0));
  }
  return i == n ? n : X.create(t, n.changes, n.selection, i.effects, i.annotations, i.scrollIntoView);
}
const Bo = [];
function Vt(n) {
  return n == null ? Bo : Array.isArray(n) ? n : [n];
}
var mt = /* @__PURE__ */ function(n) {
  return n[n.Word = 0] = "Word", n[n.Space = 1] = "Space", n[n.Other = 2] = "Other", n;
}(mt || (mt = {}));
const No = /[\u00df\u0587\u0590-\u05f4\u0600-\u06ff\u3040-\u309f\u30a0-\u30ff\u3400-\u4db5\u4e00-\u9fcc\uac00-\ud7af]/;
let Ti;
try {
  Ti = /* @__PURE__ */ new RegExp("[\\p{Alphabetic}\\p{Number}_]", "u");
} catch {
}
function Ho(n) {
  if (Ti)
  ...
  for (let t = 0; t < n.length; t++) {
    let e = n[t];
    if (/\w/.test(e) || e > "" && (e.toUpperCase() != e.toLowerCase() || No.test(e)))
      return !0;
  }
  return !1;
}
...
class R {
  ...
  */
  applyTransaction(t) {
    ...
    for (let l of t.effects)
      l.is($t.reconfigure) ? (e && (s = /* @__PURE__ */ new Map(), e.compartments.forEach((h, a) => s.set(a, h)), e = null), s.set(l.value.compartment, l.value.extension)) : l.is(F.reconfigure) ? (e = null, i = l.value) : l.is(F.appendConfig) && (e = null, i = Vt(i).concat(l.value));
    let r;
    e ? r = t.startState.values.slice() : (e = Ue.resolve(i, s, this), r = new R(e, this.doc, this.selection, e.dynamicSlots.map(() => null), (h, a) => a.reconfigure(h, this), null).values);
    let o = t.startState.facet(Oi) ? t.newSelection : t.newSelection.asSingle();
    new R(e, t.newDoc, o, r, (l, h) => h.update(l, t), t);
  }
  /**
  ...
  */
  changeByRange(t) {
    let e = this.selection, i = t(e.ranges[0]), s = this.changes(i.changes), r = [i.range], o = Vt(i.effects);
    for (let l = 1; l < e.ranges.length; l++) {
      let h = t(e.ranges[l]), a = this.changes(h.changes), c = a.map(s);
      for (let u = 0; u < l; u++)
        r[u] = r[u].map(c);
      let f = s.mapDesc(a, !0);
      r.push(h.range.map(f)), s = s.compose(c), o = F.mapEffects(o, c).concat(F.mapEffects(Vt(h.effects), f));
    }
    return {
      changes: s,
  ...
  */
  changes(t = []) {
    return t instanceof q ? t : q.of(t, this.doc.length, this.facet(R.lineSeparator));
  }
  /**
  ...
  */
  toText(t) {
    return E.of(t.split(this.facet(R.lineSeparator) || Si));
  }
  /**
  ...
  */
  facet(t) {
    ...
    return e == null ? t.default : (re(this, e), _e(this, e));
  }
  /**
  ...
  */
  toJSON(t) {
    ...
    if (t)
      for (let i in t) {
        let s = t[i];
        s instanceof Ot && this.config.address[s.id] != null && (e[i] = s.spec.toJSON(this.field(t[i]), this));
      }
    return e;
  }
  /**
  ...
  */
  static create(t = {}) {
    let e = Ue.resolve(t.extensions || [], /* @__PURE__ */ new Map()), i = t.doc instanceof E ? t.doc : E.of((t.doc || "").split(e.staticFacet(R.lineSeparator) || Si)), s = t.selection ? t.selection instanceof x ? t.selection : x.single(t.selection.anchor, t.selection.head) : x.single(0);
    return Hn(s, i.length), e.staticFacet(Oi) || (s = s.asSingle()), new R(e, i, s, e.dynamicSlots.map(() => null), (r, o) => o.create(r), null);
  }
  /**
...
`;
  ...
  */
  charCategorizer(t) {
    return Io(this.languageDataAt("wordChars", t).join(""));
  }
  /**
  ...
  */
  wordAt(t) {
    ...
    for (; o > 0; ) {
      let h = ft(e, o, !1);
      if (r(e.slice(h, o)) != mt.Word)
        break;
      o = h;
    }
    for (; l < s; ) {
      let h = ft(e, l);
      if (r(e.slice(l, h)) != mt.Word)
        break;
      l = h;
    }
...
R.allowMultipleSelections = Oi;
R.tabSize = /* @__PURE__ */ M.define({
  combine: (n) => n.length ? n[0] : 4
});
R.lineSeparator = Fn;
R.readOnly = qn;
R.phrases = /* @__PURE__ */ M.define({
  compare(n, t) {
...
R.languageData = Vn;
R.changeFilter = Wn;
R.transactionFilter = zn;
R.transactionExtender = $n;
$t.reconfigure = /* @__PURE__ */ F.define();
function rs(n, t, e = {}) {
  let i = {};
  for (let s of n)
...
class os {
  ...
  map(t, e) {
    ...
    return { mapped: i.length ? new os(s, r, i, l) : null, pos: o };
  }
}
class T {
  constructor(t, e, i, s) {
  ...
  */
  update(t) {
    ...
    if (e.length == 0 && !o)
      return this;
    if (i && (e = e.slice().sort(Ei)), this.isEmpty)
      return e.length ? T.of(e) : this;
    let l = new Yn(this, null, -1).goto(0), h = 0, a = [], c = new fe();
    for (; l.value || h < e.length; )
      ...
      } else l.rangeIndex == 1 && l.chunkIndex < this.chunk.length && (h == e.length || this.chunkEnd(l.chunkIndex) < e[h].from) && (!o || s > this.chunkEnd(l.chunkIndex) || r < this.chunkPos[l.chunkIndex]) && c.addChunk(this.chunkPos[l.chunkIndex], this.chunk[l.chunkIndex]) ? l.nextChunk() : ((!o || s > l.to || r < l.from || o(l.from, l.to, l.value)) && (c.addInner(l.from, l.to, l.value) || a.push(ce.create(l.from, l.to, l.value))), l.next());
    return c.finishInner(this.nextLayer.isEmpty && !a.length ? T.empty : this.nextLayer.update({ add: a, filter: o, filterFrom: s, filterTo: r }));
  }
  /**
  ...
  */
  map(t) {
    ...
    return e.length == 0 ? r : new T(i, e, r || T.empty, s);
  }
  /**
  ...
  */
  static compare(t, e, i, s, r = -1) {
    let o = t.filter((f) => f.maxPoint > 0 || !f.isEmpty && f.maxPoint >= r), l = e.filter((f) => f.maxPoint > 0 || !f.isEmpty && f.maxPoint >= r), h = Ms(o, l, i), a = new Jt(o, h, r), c = new Jt(l, h, r);
    i.iterGaps((f, u, d) => As(a, f, c, u, d, s)), i.empty && i.length == 0 && As(a, 0, c, 0, 0, s);
  }
  /**
  ...
  */
  static eq(t, e, i = 0, s) {
    ...
    if (!r.length)
      return !0;
    let l = Ms(r, o), h = new Jt(r, l, 0).goto(i), a = new Jt(o, l, 0).goto(i);
    for (; ; ) {
      if (h.to != a.to || !Ri(h.active, a.active) || h.point && (!a.point || !h.point.eq(a.point)))
        return !1;
      if (h.to > s)
        return !0;
      h.next(), a.next();
  ...
  */
  static spans(t, e, i, s, r = -1) {
    let o = new Jt(t, null, r).goto(e), l = e, h = o.openStart;
    for (; ; ) {
      let a = Math.min(o.to, i);
      if (o.point) {
        let c = o.activeForPoint(o.to), f = o.pointFrom < e ? c.length + 1 : o.point.startSide < 0 ? c.length : Math.min(c.length, h);
        s.point(l, a, o.point, c, f, o.pointRank), h = Math.min(o.openEnd(a), c.length);
      } else a > l && (s.span(l, a, o.active, h), h = o.openEnd(a));
      if (o.to > i)
  ...
  */
  static of(t, e = !1) {
    let i = new fe();
    for (let s of t instanceof ce ? [t] : e ? Vo(t) : t)
  ...
  */
  static join(t) {
    ...
    for (let i = t.length - 2; i >= 0; i--)
      for (let s = t[i]; s != T.empty; s = s.nextLayer)
        e = new T(s.chunkPos, s.chunk, e, Math.max(s.maxPoint, e.maxPoint));
    return e;
  }
}
...
class fe {
  finishChunk(t) {
    this.chunks.push(new os(this.from, this.to, this.value, this.maxPoint)), this.chunkPos.push(this.chunkStart), this.chunkStart = -1, this.setMaxPoint = Math.max(this.setMaxPoint, this.maxPoint), this.maxPoint = -1, t && (this.from = [], this.to = [], this.value = []);
  }
  /**
  ...
  */
  finishInner(t) {
    if (this.from.length && this.finishChunk(!1), this.chunks.length == 0)
      return t;
    let e = T.create(this.chunkPos, this.chunks, this.nextLayer ? this.nextLayer.finishInner(t) : t, this.setMaxPoint);
  ...
  static from(t, e = null, i = -1) {
    ...
    for (let r = 0; r < t.length; r++)
      for (let o = t[r]; !o.isEmpty; o = o.nextLayer)
        o.maxPoint >= i && s.push(new Yn(o, e, i, r));
    return s.length == 1 ? s[0] : new ue(s);
  }
  get startSide() {
    return this.value ? this.value.startSide : 0;
  }
...
class Jt {
  constructor(t, e, i) {
    this.minPoint = i, this.active = [], this.activeTo = [], this.activeRank = [], this.minActive = -1, this.point = null, this.pointFrom = 0, this.pointRank = 0, this.to = -1e9, this.endSide = 0, this.openStart = -1, this.cursor = ue.from(t, e, i);
  }
  goto(t, e = -1e9) {
  ...
  removeActive(t) {
    Ae(this.active, t), Ae(this.activeTo, t), Ae(this.activeRank, t), this.minActive = Os(this.active, this.activeTo);
  }
  addActive(t) {
    let e = 0, { value: i, to: s, rank: r } = this.cursor;
    for (; e < this.activeRank.length && (r - this.activeRank[e] || s - this.activeTo[e]) > 0; )
      e++;
    Oe(this.active, e, i), Oe(this.activeTo, e, s), Oe(this.activeRank, e, r), t && Oe(t, e, this.cursor.from), this.minActive = Os(this.active, this.activeTo);
  }
...
function As(n, t, e, i, s, r) {
  n.goto(t), e.goto(i);
  let o = i + s, l = i, h = i - t;
  for (; ; ) {
    let a = n.to + h - e.to, c = a || n.endSide - e.endSide, f = c < 0 ? n.to + h : e.to, u = Math.min(f, o);
    if (n.point || e.point ? n.point && e.point && (n.point == e.point || n.point.eq(e.point)) && Ri(n.activeForPoint(n.to), e.activeForPoint(e.to)) || r.comparePoint(l, u, n.point, e.point) : u > l && !Ri(n.active, e.active) && r.compareRange(l, u, n.active, e.active), f > o)
      break;
    (a || n.openEnd != e.openEnd) && r.boundChange && r.boundChange(f), l = f, c <= 0 && n.next(), c >= 0 && e.next();
  }
}
function Ri(n, t) {
  if (n.length != t.length)
...
function Gn(n, t, e = n.length) {
  let i = 0;
  for (let s = 0; s < e && s < n.length; )
    n.charCodeAt(s) == 9 ? (i += t - i % t, s++) : (i++, s = ft(n, s));
  return i;
}
function Pi(n, t, e, i) {
  for (let s = 0, r = 0; ; ) {
    ...
    if (s == n.length)
      break;
    r += n.charCodeAt(s) == 9 ? e - r % e : 1, s = ft(n, s);
  }
  return i === !0 ? -1 : n.length;
}
const Li = "ͼ", Ds = typeof Symbol > "u" ? "__" + Li : Symbol.for(Li), Bi = typeof Symbol > "u" ? "__styleSet" + Math.floor(Math.random() * 1e8) : Symbol("styleSet"), Ts = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : {};
class Kt {
...
`);
  ...
  static newName() {
    let t = Ts[Ds] || 1;
    return Ts[Ds] = t + 1, Li + t.toString(36);
  }
  ...
  static mount(t, e, i) {
    let s = t[Bi], r = i && i.nonce;
    s ? r && s.setNonce(r) : s = new Fo(t, r), s.mount(Array.isArray(e) ? e : [e], t);
  }
}
let Es = /* @__PURE__ */ new Map();
class Fo {
  constructor(t, e) {
    ...
    if (!t.head && t.adoptedStyleSheets && s.CSSStyleSheet) {
      let r = Es.get(i);
      if (r) return t[Bi] = r;
      this.sheet = new s.CSSStyleSheet(), Es.set(i, this);
    } else
      this.styleTag = i.createElement("style"), e && this.styleTag.setAttribute("nonce", e);
    this.modules = [], t[Bi] = this;
  }
  mount(t, e) {
    let i = this.sheet, s = 0, r = 0;
    for (let o = 0; o < t.length; o++) {
      let l = t[o], h = this.modules.indexOf(l);
      if (h < r && h > -1 && (this.modules.splice(h, 1), r--, h = -1), h == -1) {
        if (this.modules.splice(r++, 0, l), i) for (let a = 0; a < l.rules.length; a++)
          i.insertRule(l.rules[a], s++);
      } else {
...
function oe(n, t, e, i) {
  return e ? Rs(n, t, e, i, -1) || Rs(n, t, e, i, 1) : !1;
}
function Et(n) {
  for (var t = 0; ; t++)
...
function zo(n, t, e, i, s, r, o, l) {
  let h = n.ownerDocument, a = h.defaultView || window;
  for (let c = n, f = !1; c && !f; )
    if (c.nodeType == 1) {
      let u, d = c == h.body, p = 1, g = 1;
      if (d)
        u = Wo(a);
      else {
      ...
      let m = 0, w = 0;
      if (s == "nearest")
        t.top < u.top ? (w = t.top - (u.top + o), e > 0 && t.bottom > u.bottom + w && (w = t.bottom - u.bottom + o)) : t.bottom > u.bottom && (w = t.bottom - u.bottom + o, e < 0 && t.top - w < u.top && (w = t.top - (u.top + o)));
      else {
        let b = t.bottom - t.top, S = u.bottom - u.top;
        w = (s == "center" && b <= S ? t.top + b / 2 - S / 2 : s == "start" || s == "center" && e < 0 ? t.top - o : t.bottom - S + o) - u.top;
      }
      if (i == "nearest" ? t.left < u.left ? (m = t.left - (u.left + r), e > 0 && t.right > u.right + m && (m = t.right - u.right + r)) : t.right > u.right && (m = t.right - u.right + r, e < 0 && t.left < u.left + m && (m = t.left - (u.left + r))) : m = (i == "center" ? t.left + (t.right - t.left) / 2 - (u.right - u.left) / 2 : i == "start" == l ? t.left - r : t.right - (u.right - u.left) + r) - u.left, m || w)
        if (d)
          a.scrollBy(m, w);
        else {
          let b = 0, S = 0;
          if (w) {
            let v = c.scrollTop;
            c.scrollTop += w / g, S = (c.scrollTop - v) * g;
          }
          if (m) {
            let v = c.scrollLeft;
            c.scrollLeft += m / p, b = (c.scrollLeft - v) * p;
          }
          t = {
            left: t.left - b,
            top: t.top - S,
            right: t.right - b,
            bottom: t.bottom - S
          }, b && Math.abs(b - m) < 1 && (i = "nearest"), S && Math.abs(S - w) < 1 && (s = "nearest");
        }
      if (d)
        break;
...
class qo {
  ...
  setRange(t) {
    ...
    this.set(e, Math.min(t.anchorOffset, e ? dt(e) : 0), i, Math.min(t.focusOffset, i ? dt(i) : 0));
  }
  set(t, e, i, s) {
...
let Ps;
function Rt(n, t, e = t) {
  let i = Ps || (Ps = document.createRange());
...
function jo(n, t) {
  ...
  if (!e || t.anchorNode != e || t.anchorOffset != i)
    return !1;
  for (i = Math.min(i, dt(e)); ; )
    if (i) {
      if (e.nodeType != 1)
        return !1;
      let s = e.childNodes[i - 1];
      s.contentEditable == "false" ? i-- : (e = s, i = dt(e));
    } else {
      if (e == n)
        return !0;
      i = Et(e), e = e.parentNode;
    }
}
function Jn(n) {
  ...
  for (let e = n, i = t; ; ) {
    ...
    if (e.nodeType == 1 && i > 0) {
      if (e.contentEditable == "false")
        return null;
      e = e.childNodes[i - 1], i = dt(e);
    } else if (e.parentNode && !Je(e))
      i = Et(e), e = e.parentNode;
    else
      return null;
  }
...
class G {
  ...
  static before(t, e) {
    return new G(t.parentNode, Et(t), e);
  }
  static after(t, e) {
    return new G(t.parentNode, Et(t) + 1, e);
  }
}
const ls = [];
class L {
  ...
  childCursor(t = this.length) {
    return new tr(this.children, t, this.children.length);
  }
  childPos(t, e = 1) {
...
function ir(n, t, e, i, s, r) {
  let o = n.childCursor(), { i: l, off: h } = o.findPos(e, 1), { i: a, off: c } = o.findPos(t, -1), f = t - e;
  for (let u of i)
    f += u.length;
  n.length += f, er(n, a, c, l, h, i, 0, s, r);
}
let Q = typeof navigator < "u" ? navigator : { userAgent: "", vendor: "", platform: "" }, Hi = typeof document < "u" ? document : { documentElement: { style: {} } };
const Ii = /* @__PURE__ */ /Edge\/(\d+)/.exec(Q.userAgent), sr = /* @__PURE__ */ /MSIE \d/.test(Q.userAgent), Vi = /* @__PURE__ */ /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(Q.userAgent), ni = !!(sr || Vi || Ii), Bs = !ni && /* @__PURE__ */ /gecko\/(\d+)/i.test(Q.userAgent), fi = !ni && /* @__PURE__ */ /Chrome\/(\d+)/.exec(Q.userAgent), Yo = "webkitFontSmoothing" in Hi.documentElement.style, nr = !ni && /* @__PURE__ */ /Apple Computer/.test(Q.vendor), Ns = nr && (/* @__PURE__ */ /Mobile\/\w+/.test(Q.userAgent) || Q.maxTouchPoints > 2);
var y = {
  mac: Ns || /* @__PURE__ */ /Mac/.test(Q.platform),
  windows: /* @__PURE__ */ /Win/.test(Q.platform),
  linux: /* @__PURE__ */ /Linux|X11/.test(Q.platform),
  ie: ni,
  ie_version: sr ? Hi.documentMode || 6 : Vi ? +Vi[1] : Ii ? +Ii[1] : 0,
  gecko: Bs,
  gecko_version: Bs ? +(/* @__PURE__ */ /Firefox\/(\d+)/.exec(Q.userAgent) || [0, 0])[1] : 0,
  chrome: !!fi,
  chrome_version: fi ? +fi[1] : 0,
  ios: Ns,
  android: /* @__PURE__ */ /Android\b/.test(Q.userAgent),
  safari: nr,
  webkit_version: Yo ? +(/* @__PURE__ */ /\bAppleWebKit\/(\d+)/.exec(Q.userAgent) || [0, 0])[1] : 0,
  tabSize: Hi.documentElement.style.tabSize != null ? "tab-size" : "-moz-tab-size"
};
const Go = 256;
class rt extends L {
  constructor(t) {
  ...
  merge(t, e, i) {
    return this.flags & 8 || i && (!(i instanceof rt) || this.length - (e - t) + i.length > Go || i.flags & 8) ? !1 : (this.text = this.text.slice(0, t) + (i ? i.text : "") + this.text.slice(e), this.markDirty(), !0);
  }
  split(t) {
    let e = new rt(this.text.slice(t));
  ...
  domAtPos(t) {
    return new G(this.dom, t);
  }
  domBoundsAround(t, e, i) {
    return { from: i, to: i + this.length, startDOM: this.dom, endDOM: this.dom.nextSibling };
  }
  coordsAt(t, e) {
    return Xo(this.dom, t, e);
  }
}
class yt extends L {
  constructor(t, e = [], i = 0) {
  ...
  setAttrs(t) {
    if (_n(t), this.mark.class && (t.className = this.mark.class), this.mark.attrs)
  ...
  merge(t, e, i, s, r, o) {
    return i && (!(i instanceof yt && i.mark.eq(this.mark)) || t && r <= 0 || e < this.length && o <= 0) ? !1 : (ir(this, t, e, i ? i.children.slice() : [], r - 1, o - 1), this.markDirty(), !0);
  }
  split(t) {
    let e = [], i = 0, s = -1, r = 0;
    ...
    let o = this.length - t;
    return this.length = t, s > -1 && (this.children.length = s, this.markDirty()), new yt(this.mark, e, o);
  }
  domAtPos(t) {
    return rr(this, t);
  }
...
function Xo(n, t, e) {
  ...
  return y.safari && !o && h.width == 0 && (h = Array.prototype.find.call(l, (a) => a.width) || h), o ? si(h, o < 0) : h || null;
}
class Ct extends L {
  static create(t, e, i) {
    return new Ct(t, e, i);
  ...
  split(t) {
    let e = Ct.create(this.widget, this.length - t, this.side);
  ...
  merge(t, e, i, s, r, o) {
    return i && (!(i instanceof Ct) || !this.widget.compare(i.widget) || t > 0 && r <= 0 || e < this.length && o <= 0) ? !1 : (this.length = t + (i ? i.length : 0) + (this.length - e), !0);
  }
  become(t) {
    return t instanceof Ct && t.side == this.side && this.widget.constructor == t.widget.constructor ? (this.widget.compare(t.widget) || this.markDirty(!0), this.dom && !this.prevWidget && (this.prevWidget = this.widget), this.widget = t.widget, this.length = t.length, !0) : !1;
  }
  ignoreMutation() {
    return !0;
  }
  ...
  domAtPos(t) {
    return (this.length ? t == 0 : this.side > 0) ? G.before(this.dom) : G.after(this.dom, t == this.length);
  }
  domBoundsAround() {
    return null;
  }
...
class jt extends L {
  ...
  become(t) {
    return t instanceof jt && t.side == this.side;
  }
  split() {
  ...
  domAtPos(t) {
    return this.side > 0 ? G.before(this.dom) : G.after(this.dom);
  }
  localPosFromDOM() {
    return 0;
  }
...
rt.prototype.children = Ct.prototype.children = jt.prototype.children = ls;
function rr(n, t) {
...
function or(n, t, e) {
  let i, { children: s } = n;
  e > 0 && t instanceof yt && s.length && (i = s[s.length - 1]) instanceof yt && i.mark.eq(t.mark) ? or(i, t.children[0], e - 1) : (s.push(t), t.setParent(n)), n.length += t.length;
}
function lr(n, t, e) {
  ...
  function l(a, c) {
    for (let f = 0, u = 0; f < a.children.length && u <= c; f++) {
      ...
      p >= c && (d.children.length ? l(d, c - u) : (!r || r.isHidden && (e > 0 || _o(r, d))) && (p > c || u == p && d.getSide() > 0) ? (r = d, o = c - u) : (u < c || u == p && d.getSide() < 0 && !d.isHidden) && (i = d, s = c - u)), u = p;
    }
  }
  l(n, t);
  let h = (e < 0 ? i : r) || i || r;
  return h ? h.coordsAt(Math.max(0, h == i ? s : o), e) : Uo(n);
}
function Uo(n) {
  ...
  */
  static replace(t) {
    ...
    if (t.isBlockGap)
      ...
      let { start: r, end: o } = hr(t, e);
      i = (r ? e ? -3e8 : -1 : 5e8) - 1, s = (o ? e ? 2e8 : 1 : -6e8) + 1;
    }
    return new Mt(t, i, s, e, t.widget || null, !0);
  }
  /**
...
class be extends K {
  constructor(t) {
    let { start: e, end: i } = hr(t);
    super(e ? -1 : 5e8, i ? 1 : -6e8, null, t), this.tagName = t.tagName || "span", this.class = t.class || "", this.attrs = t.attributes || null;
  }
  eq(t) {
    var e, i;
    return this == t || t instanceof be && this.tagName == t.tagName && (this.class || ((e = this.attrs) === null || e === void 0 ? void 0 : e.class)) == (t.class || ((i = t.attrs) === null || i === void 0 ? void 0 : i.class)) && Qe(this.attrs, t.attrs, "class");
  }
  range(t, e = t) {
    if (t >= e)
...
be.prototype.point = !1;
class ye extends K {
  constructor(t) {
    super(-2e8, -2e8, null, t);
  }
  eq(t) {
    return t instanceof ye && this.spec.class == t.spec.class && Qe(this.spec.attributes, t.spec.attributes);
  }
  range(t, e = t) {
    if (e != t)
...
ye.prototype.mapMode = Z.TrackBefore;
ye.prototype.point = !0;
class Mt extends K {
  constructor(t, e, i, s, r, o) {
    super(e, i, r, t), this.block = s, this.isReplace = o, this.mapMode = s ? e <= 0 ? Z.TrackBefore : Z.TrackAfter : Z.TrackDel;
  }
  ...
  eq(t) {
    return t instanceof Mt && Qo(this.widget, t.widget) && this.block == t.block && this.startSide == t.startSide && this.endSide == t.endSide;
  }
  range(t, e = t) {
...
class $ extends L {
  ...
  merge(t, e, i, s, r, o) {
    ...
    return s && this.setDeco(i ? i.attrs : null), ir(this, t, e, i ? i.children.slice() : [], r, o), !0;
  }
  split(t) {
    let e = new $();
  ...
  setDeco(t) {
    Qe(this.attrs, t) || (this.dom && (this.prevAttrs = this.attrs, this.markDirty()), this.attrs = t);
  }
  append(t, e) {
    or(this, t, e);
  }
  ...
  addLineDeco(t) {
    ...
    e && (this.attrs = Fi(e, this.attrs || {})), i && (this.attrs = Fi({ class: i }, this.attrs || {}));
  }
  domAtPos(t) {
    return rr(this, t);
  }
  ...
  sync(t, e) {
    var i;
    this.dom ? this.flags & 4 && (_n(this.dom), this.dom.className = "cm-line", this.prevAttrs = this.attrs ? null : void 0) : (this.setDOM(document.createElement("div")), this.dom.className = "cm-line", this.prevAttrs = this.attrs ? null : void 0), this.prevAttrs !== void 0 && (Wi(this.dom, this.prevAttrs, this.attrs), this.dom.classList.add("cm-line"), this.prevAttrs = void 0), super.sync(t, e);
    let s = this.dom.lastChild;
    for (; s && L.get(s) instanceof yt; )
      s = s.lastChild;
    if (!s || !this.length || s.nodeName != "BR" && ((i = L.get(s)) === null || i === void 0 ? void 0 : i.isEditable) == !1 && (!y.ios || !this.children.some((r) => r instanceof rt))) {
  ...
  become(t) {
    return t instanceof $ && this.children.length == 0 && t.children.length == 0 && Qe(this.attrs, t.attrs) && this.breakAfter == t.breakAfter;
  }
  covers() {
    return !0;
  }
...
class bt extends L {
  ...
  merge(t, e, i, s, r, o) {
    return i && (!(i instanceof bt) || !this.widget.compare(i.widget) || t > 0 && r <= 0 || e < this.length && o <= 0) ? !1 : (this.length = t + (i ? i.length : 0) + (this.length - e), !0);
  }
  domAtPos(t) {
    return t == 0 ? G.before(this.dom) : G.after(this.dom, t == this.length);
  }
  split(t) {
    let e = this.length - t;
    this.length = t;
  ...
  become(t) {
    return t instanceof bt && t.widget.constructor == this.widget.constructor ? (t.widget.compare(this.widget) || this.markDirty(!0), this.dom && !this.prevWidget && (this.prevWidget = this.widget), this.widget = t.widget, this.length = t.length, this.deco = t.deco, this.breakAfter = t.breakAfter, !0) : !1;
  }
  ignoreMutation() {
    return !0;
  }
  ...
  coordsAt(t, e) {
    let i = this.widget.coordsAt(this.dom, t, e);
    return i || (this.widget instanceof zi ? null : si(this.dom.getBoundingClientRect(), this.length ? t == 0 : e <= 0));
  }
  destroy() {
    super.destroy(), this.dom && this.widget.destroy(this.dom);
  }
...
class le {
  ...
  posCovered() {
    ...
    return !(t.breakAfter || t instanceof bt && t.deco.endSide < 0);
  }
  getLine() {
    return this.curLine || (this.content.push(this.curLine = new $()), this.atCursorPos = !0), this.curLine;
  }
  flushBuffer(t = this.bufferMarks) {
    this.pendingBuffer && (this.curLine.append(De(new jt(-1), t), t.length), this.pendingBuffer = 0);
  }
  addBlockWidget(t) {
    this.flushBuffer(), this.curLine = null, this.content.push(t);
  }
  finish(t) {
    this.pendingBuffer && t <= this.bufferMarks.length ? this.flushBuffer() : this.pendingBuffer = 0, !this.posCovered() && !(t && this.content.length && this.content[this.content.length - 1] instanceof bt) && this.getLine();
  }
  buildText(t, e, i) {
    for (; t > 0; ) {
      ...
      this.flushBuffer(e.slice(e.length - i)), this.getLine().append(De(new rt(this.text.slice(this.textOff, this.textOff + s)), e), i), this.atCursorPos = !0, this.textOff += s, t -= s, i = 0;
    }
  }
  span(t, e, i, s) {
  ...
  point(t, e, i, s, r, o) {
    ...
    if (i instanceof Mt)
      if (i.block)
        i.startSide > 0 && !this.posCovered() && this.getLine(), this.addBlockWidget(new bt(i.widget || Yt.block, l, i));
      else {
        let h = Ct.create(i.widget || Yt.inline, l, l ? 0 : i.startSide), a = this.atCursorPos && !h.isEditable && r <= s.length && (t < e || i.startSide > 0), c = !h.isEditable && (t < e || r > s.length || i.startSide <= 0), f = this.getLine();
        this.pendingBuffer == 2 && !a && !h.isEditable && (this.pendingBuffer = 0), this.flushBuffer(s), a && (f.append(De(new jt(1), s), r), r = s.length + Math.max(0, r - s.length)), f.append(De(h, s), r), this.atCursorPos = c, this.pendingBuffer = c ? t < e || r > s.length ? 1 : 2 : 0, this.pendingBuffer && (this.bufferMarks = s.slice());
      }
  ...
  static build(t, e, i, s, r) {
    let o = new le(t, e, i, r);
    return o.openEnd = T.spans(s, e, i, o), o.openStart < 0 && (o.openStart = o.openEnd), o.finish(o.openEnd), o;
  }
}
function De(n, t) {
  for (let e of t)
    n = new yt(e, [n], n.length);
  return n;
}
class Yt extends we {
  constructor(t) {
...
Yt.inline = /* @__PURE__ */ new Yt("span");
Yt.block = /* @__PURE__ */ new Yt("div");
var W = /* @__PURE__ */ function(n) {
  return n[n.LTR = 0] = "LTR", n[n.RTL = 1] = "RTL", n;
}(W || (W = {}));
const Pt = W.LTR, hs = W.RTL;
function ar(n) {
  let t = [];
  for (let e = 0; e < n.length; e++)
    t.push(1 << +n[e]);
...
const Zo = /* @__PURE__ */ ar("88888888888888888888888888888888888666888888787833333333337888888000000000000000000000000008888880000000000000000000000000088888888888888888888888888888888888887866668888088888663380888308888800000000000000000000000800000000000000000000000000000008"), tl = /* @__PURE__ */ ar("4444448826627288999999999992222222222222222222222222222222222222222222222229999999999999999999994444444444644222822222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222999999949999999229989999223333333333"), $i = /* @__PURE__ */ Object.create(null), ht = [];
for (let n of ["()", "[]", "{}"]) {
  let t = /* @__PURE__ */ n.charCodeAt(0), e = /* @__PURE__ */ n.charCodeAt(1);
  $i[t] = e, $i[e] = -t;
}
function cr(n) {
  return n <= 247 ? Zo[n] : 1424 <= n && n <= 1524 ? 2 : 1536 <= n && n <= 1785 ? tl[n - 1536] : 1774 <= n && n <= 2220 ? 4 : 8192 <= n && n <= 8204 ? 256 : 64336 <= n && n <= 65023 ? 4 : 1;
}
const el = /[\u0590-\u05f4\u0600-\u06ff\u0700-\u08ac\ufb50-\ufdff]/;
class kt {
  /**
...
function fr(n, t) {
  ...
  for (let e = 0; e < n.length; e++) {
    let i = n[e], s = t[e];
    if (i.from != s.from || i.to != s.to || i.direction != s.direction || !fr(i.inner, s.inner))
      return !1;
  }
  return !0;
}
...
function il(n, t, e, i, s) {
  for (let r = 0; r <= i.length; r++) {
    ...
    for (let a = o, c = h, f = h; a < l; a++) {
      let u = cr(n.charCodeAt(a));
      u == 512 ? u = c : u == 8 && f == 4 && (u = 16), P[a] = u == 4 ? 2 : u, u & 7 && (f = u), c = u;
    }
    for (let a = o, c = h, f = h; a < l; a++) {
      let u = P[a];
      if (u == 128)
        a < l - 1 && c == P[a + 1] && c & 24 ? u = P[a] = c : P[a] = 256;
      else if (u == 64) {
        let d = a + 1;
        for (; d < l && P[d] == 64; )
          d++;
        let p = a && c == 8 || d < e && P[d] == 8 ? f == 1 ? 1 : 8 : 256;
        for (let g = a; g < d; g++)
          P[g] = p;
        a = d - 1;
      } else u == 8 && f == 1 && (P[a] = 1);
      ...
      if (a == 256) {
        ...
        for (; ; )
          if (c == l) {
            ...
            break;
        let f = r == 1, u = (c < t ? P[c] : i) == 1, d = f == u ? f ? 1 : 2 : i;
        for (let p = c, g = s, m = g ? e[g - 1].to : n; p > h; )
          p == m && (p = e[--g].from, m = g ? e[g - 1].to : n), P[--p] = d;
        h = c;
      } else
        r = a, h++;
    }
    ...
    for (let h = t, a = 0; h < e; ) {
      ...
      t: for (; ; )
        if (a < r.length && p == r[a].from) {
          ...
          let g = r[a];
          if (!c)
            for (let m = g.to, w = a + 1; ; ) {
              if (m == e)
                break t;
              if (w < r.length && r[w].from == m)
                m = r[w++].to;
              else {
                if (P[m] == l)
                  break t;
          ...
          if (a++, u)
            ...
            g.from > h && o.push(new kt(h, g.from, d));
            let m = g.direction == Pt != !(d % 2);
            Ki(n, m ? i + 1 : i, s, g.inner, g.from, g.to, o), h = g.to;
          }
          p = g.to;
        } else {
          if (p == e || (c ? P[p] != l : P[p] == l))
            break;
          p++;
        }
      u ? qi(n, h, p, i + 1, s, u, o) : h < p && o.push(new kt(h, p, d)), h = p;
    }
  else
      ...
      t: for (; ; )
        if (a && p == r[a - 1].to) {
          ...
          if (u)
            ...
            g.to < h && o.push(new kt(g.to, h, d));
            let m = g.direction == Pt != !(d % 2);
            Ki(n, m ? i + 1 : i, s, g.inner, g.from, g.to, o), h = g.from;
          }
          p = g.from;
        } else {
          if (p == t || (c ? P[p - 1] != l : P[p - 1] == l))
            break;
          p--;
        }
      u ? qi(n, p, h, i + 1, s, u, o) : p < h && o.push(new kt(p, h, d)), h = p;
    }
}
function Ki(n, t, e, i, s, r, o) {
  let l = t % 2 ? 2 : 1;
  il(n, s, r, i, l), sl(n, s, r, i, l), nl(s, r, i, l), qi(n, s, r, t, e, i, o);
}
function rl(n, t, e) {
  if (!n)
    return [new kt(0, 0, t == hs ? 1 : 0)];
  if (t == Pt && !e.length && !el.test(n))
    return ur(n.length);
  if (e.length)
    for (; n.length > P.length; )
      P[P.length] = 256;
  let i = [], s = t == Pt ? 0 : 1;
  return Ki(n, s, s, e, 0, n.length, i), i;
}
function ur(n) {
  return [new kt(0, n, 0)];
}
...
function ol(n, t, e, i, s) {
  var r;
  let o = i.head - n.from, l = kt.find(t, o, (r = i.bidiLevel) !== null && r !== void 0 ? r : -1, i.assoc), h = t[l], a = h.side(s, e);
  if (o == a) {
    let u = l += s ? 1 : -1;
    if (u < 0 || u >= t.length)
      return null;
    h = t[l = u], o = h.side(!s, e), a = h.side(s, e);
  }
  let c = ft(n.text, o, h.forward(s, e));
  (c < h.from || c > h.to) && (c = a), dr = n.text.slice(Math.min(o, c), Math.max(o, c));
  let f = l == (s ? t.length - 1 : 0) ? null : t[l + (s ? 1 : -1)];
  return f && c == a && f.level + (s ? 0 : 1) < h.level ? x.cursor(f.side(!s, e) + n.from, f.forward(s, e) ? 1 : -1, f.level) : x.cursor(c + n.from, h.forward(s, e) ? -1 : 1, h.level);
}
function ll(n, t, e) {
  for (let i = t; i < e; i++) {
    let s = cr(n.charCodeAt(i));
    if (s == 1)
      return Pt;
    if (s == 2 || s == 4)
      return hs;
...
const pr = /* @__PURE__ */ M.define(), gr = /* @__PURE__ */ M.define(), mr = /* @__PURE__ */ M.define(), wr = /* @__PURE__ */ M.define(), ji = /* @__PURE__ */ M.define(), br = /* @__PURE__ */ M.define(), yr = /* @__PURE__ */ M.define(), as = /* @__PURE__ */ M.define(), cs = /* @__PURE__ */ M.define(), vr = /* @__PURE__ */ M.define({
  combine: (n) => n.some((t) => t)
}), xr = /* @__PURE__ */ M.define({
  combine: (n) => n.some((t) => t)
}), Sr = /* @__PURE__ */ M.define();
class Wt {
  ...
  map(t) {
    return t.empty ? this : new Wt(this.range.map(t), this.y, this.x, this.yMargin, this.xMargin, this.isSnapshot);
  }
  clip(t) {
    return this.range.to <= t.doc.length ? this : new Wt(x.cursor(t.doc.length), this.y, this.x, this.yMargin, this.xMargin, this.isSnapshot);
  }
}
const Te = /* @__PURE__ */ F.define({ map: (n, t) => n.map(t) }), Cr = /* @__PURE__ */ F.define();
function ut(n, t, e) {
  let i = n.facet(wr);
...
class tt {
  ...
  */
  static define(t, e) {
    ...
    return new tt(hl++, t, i, s, (l) => {
      let h = [Zt.of(l)];
      return o && h.push(ge.of((a) => {
        let c = a.plugin(l);
        return c ? o(c) : K.none;
      })), r && h.push(r(l)), h;
    });
      ...
      if (this.mustUpdate) {
        ...
        if (this.mustUpdate = null, this.value.update)
          try {
            ...
            if (ut(e.state, i, "CodeMirror plugin crashed"), this.value.destroy)
              try {
                this.value.destroy();
              } catch {
              }
...
const kr = /* @__PURE__ */ M.define(), fs = /* @__PURE__ */ M.define(), ge = /* @__PURE__ */ M.define(), Mr = /* @__PURE__ */ M.define(), us = /* @__PURE__ */ M.define(), Ar = /* @__PURE__ */ M.define();
function Is(n, t) {
  let e = n.state.facet(Ar);
  if (!e.length)
    return e;
  let i = e.map((r) => r instanceof Function ? r(n) : r), s = [];
  return T.spans(i, t.from, t.to, {
    point() {
    },
    span(r, o, l, h) {
      let a = r - t.from, c = o - t.from, f = s;
      for (let u = l.length - 1; u >= 0; u--, h--) {
        let d = l[u].spec.bidiIsolate, p;
        if (d == null && (d = ll(t.text, a, c)), h > 0 && f.length && (p = f[f.length - 1]).to == a && p.direction == d)
          p.to = c, f = p.inner;
        else {
          let g = { from: a, to: c, direction: d, inner: [] };
          f.push(g), f = g.inner;
        }
      }
    }
...
const Or = /* @__PURE__ */ M.define();
function ds(n) {
  let t = 0, e = 0, i = 0, s = 0;
  for (let r of n.state.facet(Or)) {
    let o = r(n);
...
class st {
  ...
  join(t) {
    return new st(Math.min(this.fromA, t.fromA), Math.max(this.toA, t.toA), Math.min(this.fromB, t.fromB), Math.max(this.toB, t.toB));
  }
  addToSet(t) {
  ...
  static extendWithRanges(t, e) {
    ...
    for (let s = 0, r = 0, o = 0, l = 0; ; s++) {
      ...
      for (; r < e.length && e[r] < c; ) {
        ...
        if (d <= p && new st(d + a, p + a, d, p).addToSet(i), u > c)
          break;
        r += 2;
      }
      if (!h)
        return i;
      new st(h.fromA, h.toA, h.fromB, h.toB).addToSet(i), o = h.toA, l = h.toB;
    }
  }
}
class Ze {
  constructor(t, e, i) {
    ...
    let s = [];
    this.changes.iterChangedRanges((r, o, l, h) => s.push(new st(r, o, l, h))), this.changedRanges = s;
  }
  /**
  @internal
  */
...
class Vs extends L {
  ...
  constructor(t) {
    super(), this.view = t, this.decorations = [], this.dynamicDecorationMap = [!1], this.domChanged = null, this.hasComposition = null, this.markedForComposition = /* @__PURE__ */ new Set(), this.editContextFormatting = K.none, this.lastCompositionAfterCursor = !1, this.minWidth = 0, this.minWidthFrom = 0, this.minWidthTo = 0, this.impreciseAnchor = null, this.impreciseHead = null, this.forceSelection = !1, this.lastUpdate = Date.now(), this.setDOM(t.contentDOM), this.children = [new $()], this.children[0].setParent(this), this.updateDeco(), this.updateInner([new st(0, 0, 0, t.state.doc.length)], 0, null);
  }
  // Update the document view to a given state.
  update(t) {
    var e;
    let i = t.changedRanges;
    this.minWidth > 0 && i.length && (i.every(({ fromA: a, toA: c }) => c < this.minWidthFrom || a > this.minWidthTo) ? (this.minWidthFrom = t.changes.mapPos(this.minWidthFrom, 1), this.minWidthTo = t.changes.mapPos(this.minWidthTo, 1)) : this.minWidth = this.minWidthFrom = this.minWidthTo = 0), this.updateEditContextFormatting(t);
    let s = -1;
    this.view.inputState.composing >= 0 && !this.view.observer.editContext && (!((e = this.domChanged) === null || e === void 0) && e.newSel ? s = this.domChanged.newSel.head : !gl(t.changes, this.hasComposition) && !t.selectionSet && (s = t.state.selection.main.head));
    let r = s > -1 ? cl(this.view, t.changes, s) : null;
    if (this.domChanged = null, this.hasComposition) {
      this.markedForComposition.clear();
      let { from: a, to: c } = this.hasComposition;
      i = new st(a, c, t.changes.mapPos(a, -1), t.changes.mapPos(c, 1)).addToSet(i.slice());
    }
    ...
    let o = this.decorations, l = this.updateDeco(), h = dl(o, l, t.changes);
    return i = st.extendWithRanges(i, h), !(this.flags & 7) && i.length == 0 ? !1 : (this.updateInner(i, t.startState.doc.length, r), t.transactions.length && (this.lastUpdate = Date.now()), !0);
  }
  ...
  updateInner(t, e, i) {
    ...
    if (this.view.viewport.from || this.view.viewport.to < this.view.state.doc.length)
      for (let o of this.children)
        o instanceof bt && o.widget instanceof zi && r.push(o.dom);
    s.updateGaps(r);
  }
  updateChildren(t, e, i) {
    ...
    for (let o = s.length - 1; ; o--) {
      ...
      if (!l)
        break;
      let { fromA: h, toA: a, fromB: c, toB: f } = l, u, d, p, g;
      if (i && i.range.fromB < f && i.range.toB > c) {
        let v = le.build(this.view.state.doc, c, i.range.fromB, this.decorations, this.dynamicDecorationMap), k = le.build(this.view.state.doc, i.range.toB, f, this.decorations, this.dynamicDecorationMap);
        d = v.breakAtStart, p = v.openStart, g = k.openEnd;
        let C = this.compositionView(i);
        k.breakAtStart ? C.breakAfter = 1 : k.content.length && C.merge(C.length, C.length, k.content[0], !1, k.openStart, 0) && (C.breakAfter = k.content[0].breakAfter, k.content.shift()), v.content.length && C.merge(0, 0, v.content[v.content.length - 1], !0, 0, v.openEnd) && v.content.pop(), u = v.content.concat(C).concat(k.content);
      } else
        ({ content: u, breakAtStart: d, openStart: p, openEnd: g } = le.build(this.view.state.doc, c, f, this.decorations, this.dynamicDecorationMap));
      let { i: m, off: w } = r.findPos(a, 1), { i: b, off: S } = r.findPos(h, -1);
      er(this, b, S, m, w, u, d, p, g);
    }
  ...
  updateEditContextFormatting(t) {
    ...
    for (let e of t.transactions)
      for (let i of e.effects)
        i.is(Cr) && (this.editContextFormatting = i.value);
  }
  compositionView(t) {
    let e = new rt(t.text.nodeValue);
    e.flags |= 8;
    for (let { deco: s } of t.marks)
      e = new yt(s, [e], e.length);
    let i = new $();
  ...
  updateSelection(t = !1, e = !1) {
    ...
    let i = this.view.root.activeElement, s = i == this.dom, r = !s && !(this.view.state.facet(gt) || this.dom.tabIndex > -1) && $e(this.dom, this.view.observer.selectionRange) && !(i && this.dom.contains(i));
    if (!(s || e || r))
      return;
    ...
    if (y.gecko && l.empty && !this.hasComposition && al(h)) {
      let f = document.createTextNode("");
      this.view.observer.ignore(() => h.node.insertBefore(f, h.node.childNodes[h.offset] || null)), h = a = new G(f, 0), o = !0;
    }
    let c = this.view.observer.selectionRange;
    (o || !c.focusNode || (!oe(h.node, h.offset, c.anchorNode, c.anchorOffset) || !oe(a.node, a.offset, c.focusNode, c.focusOffset)) && !this.suppressWidgetCursorChange(c, l)) && (this.view.observer.ignore(() => {
      y.android && y.chrome && this.dom.contains(c.focusNode) && pl(c.focusNode, this.dom) && (this.dom.blur(), this.dom.focus({ preventScroll: !0 }));
      let f = de(this.view.root);
      if (f) if (l.empty) {
        if (y.gecko) {
          let u = fl(h.node, h.offset);
          if (u && u != 3) {
            let d = (u == 1 ? Qn : Zn)(h.node, h.offset);
            d && (h = new G(d.node, d.offset));
          }
        }
    ...
    }), this.view.observer.setSelectionRange(h, a)), this.impreciseAnchor = h.precise ? null : new G(c.anchorNode, c.anchorOffset), this.impreciseHead = a.precise ? null : new G(c.focusNode, c.focusOffset);
  }
  // If a zero-length widget is inserted next to the cursor during
  // composition, avoid moving it across it and disrupting the
  // composition.
  suppressWidgetCursorChange(t, e) {
    return this.hasComposition && e.empty && oe(t.focusNode, t.focusOffset, t.anchorNode, t.anchorOffset) && this.posFromDOM(t.focusNode, t.focusOffset) == e.head;
  }
  enforceCursorAssoc() {
    if (this.hasComposition)
      return;
    let { view: t } = this, e = t.state.selection.main, i = de(t.root), { anchorNode: s, anchorOffset: r } = t.observer.selectionRange;
    if (!i || !e.empty || !e.assoc || !i.modify)
      return;
    let o = $.find(this, e.head);
    if (!o)
      return;
    let l = o.posAtStart;
  ...
  moveToLine(t) {
    ...
    for (let s = t.offset; !i && s < e.childNodes.length; s++) {
      let r = L.get(e.childNodes[s]);
      r instanceof $ && (i = r.domAtPos(0));
    }
    for (let s = t.offset - 1; !i && s >= 0; s--) {
      let r = L.get(e.childNodes[s]);
      r instanceof $ && (i = r.domAtPos(r.length));
    }
    return i ? new G(i.node, i.offset, !0) : t;
  }
  nearest(t) {
    for (let e = t; e; ) {
      let i = L.get(e);
  ...
  coordsAt(t, e) {
    ...
    for (let r = this.length, o = this.children.length - 1; o >= 0; o--) {
      ...
      if (h < t)
        break;
      if (a <= t && (a < t || l.covers(-1)) && (h > t || l.covers(1)) && (!i || l instanceof $ && !(i instanceof $ && e >= 0)))
        i = l, s = a;
      else if (i && a == t && h == t && l instanceof bt && Math.abs(e) < 2) {
  ...
  measureVisibleLineHeights(t) {
    let e = [], { from: i, to: s } = t, r = this.view.contentDOM.clientWidth, o = r > Math.max(this.view.scrollDOM.clientWidth, this.minWidth) + 1, l = -1, h = this.view.textDirection == W.LTR;
    for (let a = 0, c = 0; c < this.children.length; c++) {
      ...
      if (a >= i) {
        ...
        if (e.push(d.height), o) {
          let p = f.dom.lastChild, g = p ? pe(p) : [];
          if (g.length) {
            let m = g[g.length - 1], w = h ? m.right - d.left : d.right - m.left;
            w > l && (l = w, this.minWidth = r, this.minWidthFrom = a, this.minWidthTo = u);
          }
        }
      }
      a = u + f.breakAfter;
  ...
  updateDeco() {
    let t = 1, e = this.view.state.facet(ge).map((r) => (this.dynamicDecorationMap[t++] = typeof r == "function") ? r(this.view) : r), i = !1, s = this.view.state.facet(Mr).map((r, o) => {
      let l = typeof r == "function";
      return l && (i = !0), l ? r(this.view) : r;
    });
    for (s.length && (this.dynamicDecorationMap[t++] = i, e.push(T.join(s))), this.decorations = [
  ...
  scrollIntoView(t) {
    ...
    for (let a of this.view.state.facet(Sr))
      try {
    ...
    let r = ds(this.view), o = {
      left: i.left - r.left,
      top: i.top - r.top,
      right: i.right + r.right,
      bottom: i.bottom + r.bottom
    }, { offsetWidth: l, offsetHeight: h } = this.view.scrollDOM;
    zo(this.view.scrollDOM, o, e.head < e.anchor ? -1 : 1, t.x, t.y, Math.max(Math.min(t.xMargin, l), -l), Math.max(Math.min(t.yMargin, h), -h), this.view.textDirection == W.LTR);
  }
}
function al(n) {
...
function Dr(n, t) {
  ...
  if (!e.focusNode)
    return null;
  let i = Qn(e.focusNode, e.focusOffset), s = Zn(e.focusNode, e.focusOffset), r = i || s;
  if (s && i && s.node != i.node) {
    let l = L.get(s.node);
    if (!l || l instanceof rt && l.text != s.node.nodeValue)
      r = s;
    else if (n.docView.lastCompositionAfterCursor) {
      let h = L.get(i.node);
      !h || h instanceof rt && h.text != i.node.nodeValue || (r = s);
    }
  }
...
function cl(n, t, e) {
  ...
  if (/[\n\r]/.test(l) || n.state.doc.sliceString(i.from, i.to) != l)
    return null;
  let h = t.invertedDesc, a = new st(h.mapPos(r), h.mapPos(o), r, o), c = [];
  for (let f = s.parentNode; ; f = f.parentNode) {
    let u = L.get(f);
    if (u instanceof yt)
      c.push({ node: f, deco: u.mark });
    else {
      if (u instanceof $ || f.nodeName == "DIV" && f.parentNode == n.contentDOM)
        return { range: a, text: s, marks: c, line: f };
      if (f != n.contentDOM)
        c.push({ node: f, deco: new be({
          inclusive: !0,
          attributes: Jo(f),
...
function dl(n, t, e) {
  let i = new ul();
  return T.compare(n, t, e, i), i.changes;
}
function pl(n, t) {
...
function ml(n, t, e = 1) {
  ...
  let o = r, l = r;
  e < 0 ? o = ft(s.text, r, !1) : l = ft(s.text, r);
...
function Yi(n, t, e) {
  ...
  for (let p = n.firstChild; p; p = p.nextSibling) {
    ...
    for (let m = 0; m < g.length; m++) {
      let w = g[m];
      s && di(s, w) && (w = Fs(Ws(w, s.bottom), s.top));
      let b = wl(t, w), S = bl(e, w);
      if (b == 0 && S == 0)
        return p.nodeType == 3 ? zs(p, t, e) : Yi(p, t, e);
      if (!i || o > S || o == S && r > b) {
        i = p, s = w, r = b, o = S;
        let v = S ? e < w.top ? -1 : 1 : b ? t < w.left ? -1 : 1 : 0;
        l = !v || (v > 0 ? m < g.length - 1 : m > 0);
      }
      b == 0 ? e > w.bottom && (!c || c.bottom < w.bottom) ? (h = p, c = w) : e < w.top && (!f || f.top > w.top) && (a = p, f = w) : c && di(c, w) ? c = Ws(c, w.bottom) : f && di(f, w) && (f = Fs(f, w.top));
    }
  }
...
function zs(n, t, e) {
  ...
  for (let l = 0; l < i; l++) {
    let h = Rt(n, l, l + 1).getClientRects();
    for (let a = 0; a < h.length; a++) {
      ...
      if (c.left - 1 <= t && c.right + 1 >= t && f < r) {
        ...
        if ((y.chrome || y.gecko) && Rt(n, l).getBoundingClientRect().left == c.right && (d = !u), f <= 0)
...
function Tr(n, t, e, i = -1) {
  ...
  for (let v = n.viewState.heightOracle.textHeight / 2, k = !1; h = n.elementAtHeight(u), h.type != _.Text; )
  ...
  if (d < n.viewport.from)
    return n.viewport.from == 0 ? 0 : e ? null : $s(n, o, h, c, f);
  if (d > n.viewport.to)
    return n.viewport.to == n.state.doc.length ? n.state.doc.length : e ? null : $s(n, o, h, c, f);
  ...
  if (m && ((s = n.docView.nearest(m)) === null || s === void 0 ? void 0 : s.isEditable) != !1) {
    if (p.caretPositionFromPoint) {
      ...
      v && ({ offsetNode: w, offset: b } = v);
    } else if (p.caretRangeFromPoint) {
      let v = p.caretRangeFromPoint(c, f);
      v && ({ startContainer: w, startOffset: b } = v, (!n.contentDOM.contains(w) || y.safari && yl(w, b, c) || y.chrome && vl(w, b, c)) && (w = void 0));
    }
    w && (b = Math.min(dt(w), b));
  }
  if (!w || !n.docView.dom.contains(w)) {
    let v = $.find(n.docView, d);
    if (!v)
      return u > h.top + h.height / 2 ? h.to : h.from;
    ({ node: w, offset: b } = Yi(v.dom, c, f));
  }
  let S = n.docView.nearest(w);
  if (!S)
    return null;
  if (S.isWidget && ((r = S.dom) === null || r === void 0 ? void 0 : r.nodeType) == 1) {
    ...
    return S.localPosFromDOM(w, b) + S.posAtStart;
}
function $s(n, t, e, i, s) {
  ...
  return e.from + Pi(o, r, n.state.tabSize);
}
function yl(n, t, e) {
  let i;
  ...
  for (let s = n.nextSibling; s; s = s.nextSibling)
    if (s.nodeType != 1 || s.nodeName != "BR")
      return !1;
  return Rt(n, i - 1, i).getBoundingClientRect().left > e;
}
function vl(n, t, e) {
  if (t != 0)
    return !1;
...
function xl(n, t, e, i) {
  let s = Gi(n, t.head), r = !i || s.type != _.Text || !(n.lineWrapping || s.widgetLineBreaks) ? null : n.coordsAtPos(t.assoc < 0 && t.head > s.from ? t.head - 1 : t.head);
  if (r) {
...
function Cl(n, t, e, i) {
  ...
  for (let d = 0; ; d += 10) {
    let p = l + (u + d) * r, g = Tr(n, { x: f, y: p }, !1, r);
    if (p < h.top || p > h.bottom || (r < 0 ? g < s : g > s)) {
      let m = n.docView.coordsForChar(g), w = !m || p < m.top ? -1 : 1;
      return x.cursor(g, w, void 0, o);
    }
  }
}
function Ke(n, t, e) {
...
function pi(n, t, e) {
  let i = Ke(n.state.facet(us).map((s) => s(n)), e.from, t.head > e.from ? -1 : 1);
...
class kl {
  ...
  readRange(t, e) {
    ...
    for (let s = t; ; ) {
      ...
      if (o == e)
        break;
      let l = L.get(s), h = L.get(o);
      (l && h ? l.breakAfter : (l ? l.breakAfter : Je(s)) || Je(o) && (s.nodeName != "BR" || s.cmIgnore) && this.text.length > r) && this.lineBreak(), s = o;
    }
  ...
  readNode(t) {
    if (t.cmIgnore)
      return;
    let e = L.get(t), i = e && e.overrideDOMText;
    if (i != null) {
  ...
  findPointInside(t, e) {
    for (let i of this.points)
      (t.nodeType == 3 ? i.node == t : t.contains(i.node)) && (i.pos = this.text.length + (Ml(t, i.node, i.offset) ? e : 0));
  }
}
function Ml(n, t, e) {
  for (; ; ) {
...
class Al {
  constructor(t, e, i, s) {
    ...
    if (t.state.readOnly && e > -1)
      ...
      let l = r || o ? [] : Tl(t), h = new kl(l, t.state);
      h.readRange(this.bounds.startDOM, this.bounds.endDOM), this.text = h.text, this.newSel = El(l, this.bounds.from);
    } else {
      let l = t.observer.selectionRange, h = r && r.node == l.focusNode && r.offset == l.focusOffset || !Ni(t.contentDOM, l.focusNode) ? t.state.selection.main.head : t.docView.posFromDOM(l.focusNode, l.focusOffset), a = o && o.node == l.anchorNode && o.offset == l.anchorOffset || !Ni(t.contentDOM, l.anchorNode) ? t.state.selection.main.anchor : t.docView.posFromDOM(l.anchorNode, l.anchorOffset), c = t.viewport;
      if ((y.ios || y.chrome) && t.state.selection.main.empty && h != a && (c.from > 0 || c.to < t.state.doc.length)) {
        let f = Math.min(h, a), u = Math.max(h, a), d = c.from - f, p = c.to - u;
        (d == 0 || d == 1 || f == 0) && (p == 0 || p == -1 || u == t.state.doc.length) && (h = 0, a = t.state.doc.length);
      }
      this.newSel = x.single(a, h);
    }
  }
}
function Er(n, t) {
  ...
  if (t.bounds) {
    ...
    let c = Dl(n.state.doc.sliceString(o, l, ee), t.text, h - o, a);
    c && (y.chrome && r == 13 && c.toB == c.from + 2 && t.text.slice(c.from, c.toB) == ee + ee && c.toB--, e = {
      from: o + c.from,
      to: o + c.toA,
      insert: E.of(t.text.slice(c.from, c.toB).split(ee))
    });
  } else i && (!n.hasFocus && n.state.facet(gt) || i.main.eq(s)) && (i = null);
  if (!e && !i)
    return !1;
 ...
 ` && n.lineWrapping && (i && (i = x.single(i.main.anchor - 1, i.main.head - 1)), e = { from: s.from, to: s.to, insert: E.of([" "]) }), e)
    return ps(n, e, i, r);
  if (i && !i.main.eq(s)) {
    let o = !1, l = "select";
...
function ps(n, t, e, i = -1) {
  ...
  let o, l = () => o || (o = Ol(n, t, e));
  return n.state.facet(br).some((h) => h(n, t.from, t.to, r, l)) || n.dispatch(l()), !0;
}
function Ol(n, t, e) {
  ...
  if (t.from >= r.from && t.to <= r.to && t.to - t.from >= (r.to - r.from) / 3 && (!e || e.main.empty && e.main.from == t.from + t.insert.length) && n.inputState.composing < 0) {
    ...
    if (s.selection.ranges.length > 1 && n.inputState.composing >= 0 && t.to <= r.to && t.to >= r.to - 10) {
      let a = n.state.sliceDoc(t.from, t.to), c, f = e && Dr(n, e.main.head);
      if (f) {
      ...
      i = s.changeByRange((p) => {
        ...
        let g = p.to - u, m = g - a.length;
        if (p.to - p.from != d || n.state.sliceDoc(m, g) != a || // Unfortunately, there's no way to make multiple
        // changes in the same node work without aborting
        // composition, so cursors in the composition range are
        // ignored.
        p.to >= c.from && p.from <= c.to)
          return { range: p };
        let w = s.changes({ from: m, to: g, insert: t.insert }), b = p.to - r.to;
        return {
          changes: w,
          range: h ? x.range(Math.max(0, h.anchor + b), Math.max(0, h.head + b)) : p.map(w)
        };
      });
    } else
      i = {
...
function Tl(n) {
  ...
  return e && (t.push(new Ks(e, i)), (s != e || r != i) && t.push(new Ks(s, r))), t;
}
function El(n, t) {
  if (n.length == 0)
    return null;
...
class Rl {
  ...
  ensureHandlers(t) {
    let e = Pl(t), i = this.handlers, s = this.view.contentDOM;
    for (let r in e)
      if (r != "scroll") {
  ...
  keydown(t) {
    if (this.lastKeyCode = t.keyCode, this.lastKeyTime = Date.now(), t.keyCode == 9 && this.tabFocusMode > -1 && (!this.tabFocusMode || Date.now() <= this.tabFocusMode))
      return !0;
    if (this.tabFocusMode > 0 && t.keyCode != 27 && Pr.indexOf(t.keyCode) < 0 && (this.tabFocusMode = -1), y.android && y.chrome && !t.synthetic && (t.keyCode == 13 || t.keyCode == 8))
      return this.view.observer.delayAndroidKey(t.key, t.keyCode), !0;
    let e;
    return y.ios && !t.synthetic && !t.altKey && !t.metaKey && ((e = Rr.find((i) => i.keyCode == t.keyCode)) && !t.ctrlKey || Ll.indexOf(t.key) > -1 && t.ctrlKey && !t.shiftKey) ? (this.pendingIOSKey = e || t, setTimeout(() => this.flushIOSKey(), 250), !0) : (t.keyCode != 229 && this.view.observer.forceFlush(), !1);
  }
  flushIOSKey(t) {
...
], Ll = "dthko", Pr = [16, 17, 18, 20, 91, 92, 224, 225], Ee = 6;
function Re(n) {
...
class Nl {
  constructor(t, e, i, s) {
    this.view = t, this.startEvent = e, this.style = i, this.mustSelect = s, this.scrollSpeed = { x: 0, y: 0 }, this.scrolling = -1, this.lastEvent = e, this.scrollParents = $o(t.contentDOM), this.atoms = t.state.facet(us).map((o) => o(t));
    let r = t.contentDOM.ownerDocument;
    r.addEventListener("mousemove", this.move = this.move.bind(this)), r.addEventListener("mouseup", this.up = this.up.bind(this)), this.extend = e.shiftKey, this.multiple = t.state.facet(R.allowMultipleSelections) && Hl(t, e), this.dragging = Vl(t, e) && Nr(e) == 1 ? null : !1;
  }
  start(t) {
  ...
  move(t) {
    if (t.buttons == 0)
      return this.destroy();
    if (this.dragging || this.dragging == null && Bl(this.startEvent, t) < 10)
      return;
    ...
    let h = ds(this.view);
    t.clientX - h.left <= s + Ee ? e = -Re(s - t.clientX) : t.clientX + h.right >= o - Ee && (e = Re(t.clientX - o)), t.clientY - h.top <= r + Ee ? i = -Re(r - t.clientY) : t.clientY + h.bottom >= l - Ee && (i = Re(t.clientY - l)), this.setScrollSpeed(e, i);
  }
  up(t) {
  ...
  skipAtoms(t) {
    ...
    for (let i = 0; i < t.ranges.length; i++) {
      ...
      if (s.empty) {
        let o = Ke(this.atoms, s.from, 0);
        o != s.from && (r = x.cursor(o, -1));
      } else {
        let o = Ke(this.atoms, s.from, -1), l = Ke(this.atoms, s.to, 1);
...
function Fl(n, t) {
  ...
  for (let e = t.target, i; e != n.contentDOM; e = e.parentNode)
    if (!e || e.nodeType == 11 || (i = L.get(e)) && i.ignoreEvent(t))
      return !1;
  return !0;
}
const ot = /* @__PURE__ */ Object.create(null), nt = /* @__PURE__ */ Object.create(null), Lr = y.ie && y.ie_version < 15 || y.ios && y.webkit_version < 604;
function Wl(n) {
...
function Br(n, t) {
  ...
  if (Xi != null && e.selection.ranges.every((h) => h.empty) && Xi == r.toString()) {
    let h = -1;
    i = e.changeByRange((a) => {
      ...
      return {
        ...
        range: x.cursor(a.from + f.length)
      };
    });
    ...
    return {
      ...
      range: x.cursor(h.from + a.length)
    };
...
ot.keydown = (n, t) => (n.inputState.setSelectionOrigin("select"), t.keyCode == 27 && n.inputState.tabFocusMode != 0 && (n.inputState.tabFocusMode = Date.now() + 2e3), !1);
nt.touchstart = (n, t) => {
...
ot.mousedown = (n, t) => {
  if (n.observer.flush(), n.inputState.lastTouchTime > Date.now() - 2e3)
    return !1;
  let e = null;
  for (let i of n.state.facet(mr))
    if (e = i(n, t), e)
      break;
  if (!e && t.button == 0 && (e = ql(n, t)), e) {
    let i = !n.hasFocus;
    n.inputState.startMouseSelection(new Nl(n, t, e, i)), i && n.observer.ignore(() => {
      Un(n.contentDOM);
...
function Ys(n, t, e, i) {
  if (i == 1)
    return x.cursor(t, e);
  if (i == 2)
    return ml(n.state, t, e);
  {
    let s = $.find(n.docView, t), r = n.state.doc.lineAt(s ? s.posAtEnd : t), o = s ? s.posAtStart : r.from, l = s ? s.posAtEnd : r.to;
    return l < n.state.doc.length && l == r.to && l++, x.range(o, l);
  }
}
let Gs = (n, t, e) => t >= e.top && t <= e.bottom && n >= e.left && n <= e.right;
function zl(n, t, e, i) {
  let s = $.find(n.docView, t);
  if (!s)
    return 1;
  ...
  return l && Gs(e, i, l) ? 1 : o && o.bottom >= i ? -1 : 1;
}
function Xs(n, t) {
  let e = n.posAtCoords({ x: t.clientX, y: t.clientY }, !1);
  return { pos: e, bias: zl(n, e, t.clientX, t.clientY) };
}
const $l = y.ie && y.ie_version <= 11;
let Us = null, _s = 0, Js = 0;
function Nr(n) {
  if (!$l)
    return n.detail;
  let t = Us, e = Js;
  return Us = n, Js = Date.now(), _s = !t || e > Date.now() - 400 && Math.abs(t.clientX - n.clientX) < 2 && Math.abs(t.clientY - n.clientY) < 2 ? (_s + 1) % 3 : 1;
}
function ql(n, t) {
  let e = Xs(n, t), i = Nr(t), s = n.state.selection;
  return {
    update(r) {
      r.docChanged && (e.pos = r.changes.mapPos(e.pos), s = s.map(r.changes));
    },
    get(r, o, l) {
      let h = Xs(n, r), a, c = Ys(n, h.pos, h.bias, i);
      if (e.pos != h.pos && !o) {
        let f = Ys(n, e.pos, e.bias, i), u = Math.min(f.from, c.from), d = Math.max(f.to, c.to);
        c = u < c.from ? x.range(u, d) : x.range(d, u);
      }
      return o ? s.replaceRange(s.main.extend(c.from, c.to)) : l && i == 1 && s.ranges.length > 1 && (a = Kl(s, h.pos)) ? a : l ? s.addRange(c) : x.create([c]);
    }
  };
}
function Kl(n, t) {
...
ot.dragstart = (n, t) => {
  ...
  let { inputState: i } = n;
  return i.mouseSelection && (i.mouseSelection.dragging = !0), i.draggedContent = e, t.dataTransfer && (t.dataTransfer.setData("Text", ri(n.state, cs, n.state.sliceDoc(e.from, e.to))), t.dataTransfer.effectAllowed = "copyMove"), !1;
};
ot.dragend = (n) => (n.inputState.draggedContent = null, !1);
function Qs(n, t, e, i) {
  if (e = ri(n.state, as, e), !e)
    return;
  let s = n.posAtCoords({ x: t.clientX, y: t.clientY }, !1), { draggedContent: r } = n.inputState, o = i && r && Il(n, t) ? { from: r.from, to: r.to } : null, l = { from: s, insert: e }, h = n.state.changes(o ? [o, l] : l);
  n.focus(), n.dispatch({
    changes: h,
...
ot.drop = (n, t) => {
  ...
  if (e && e.length) {
    let i = Array(e.length), s = 0, r = () => {
      ++s == e.length && Qs(n, t, i.filter((o) => o != null).join(n.state.lineBreak), !1);
    };
...
ot.paste = (n, t) => {
  if (n.state.readOnly)
    return !0;
  n.observer.flush();
  let e = Lr ? null : t.clipboardData;
  return e ? (Br(n, e.getData("text/plain") || e.getData("text/uri-list")), !0) : (Wl(n), !1);
};
function jl(n, t) {
...
function Yl(n) {
  ...
  return { text: ri(n, cs, t.join(n.lineBreak)), ranges: e, linewise: i };
}
let Xi = null;
ot.copy = ot.cut = (n, t) => {
  let { text: e, ranges: i, linewise: s } = Yl(n.state);
  if (!e && !s)
    return !1;
  Xi = s ? e : null, t.type == "cut" && !n.state.readOnly && n.dispatch({
    changes: i,
    scrollIntoView: !0,
    userEvent: "delete.cut"
  });
  let r = Lr ? null : t.clipboardData;
  return r ? (r.clearData(), r.setData("text/plain", e), !0) : (jl(n, e), !1);
};
const Hr = /* @__PURE__ */ Xt.define();
function Ir(n, t) {
  let e = [];
  for (let i of n.facet(yr)) {
    let s = i(n, t);
    s && e.push(s);
  }
  return e ? n.update({ effects: e, annotations: Hr.of(!0) }) : null;
}
function Vr(n) {
  setTimeout(() => {
    let t = n.hasFocus;
...
nt.focus = (n) => {
  n.inputState.lastFocusTime = Date.now(), !n.scrollDOM.scrollTop && (n.inputState.lastScrollTop || n.inputState.lastScrollLeft) && (n.scrollDOM.scrollTop = n.inputState.lastScrollTop, n.scrollDOM.scrollLeft = n.inputState.lastScrollLeft), Vr(n);
};
nt.blur = (n) => {
  n.observer.clearSelectionRange(), Vr(n);
};
...
ot.beforeinput = (n, t) => {
  ...
  if (t.inputType == "insertReplacementText" && n.observer.editContext) {
    ...
    if (r && o.length) {
      ...
      return ps(n, { from: h, to: a, insert: n.state.toText(r) }, null), !0;
    }
  }
  let s;
  if (y.chrome && y.android && (s = Rr.find((r) => r.inputType == t.inputType)) && (n.observer.delayAndroidKey(s.key, s.keyCode), s.key == "Backspace" || s.key == "Delete")) {
  ...
  return y.ios && t.inputType == "deleteContentForward" && n.observer.flushSoon(), y.safari && t.inputType == "insertText" && n.inputState.composing >= 0 && setTimeout(() => nt.compositionend(n, t), 20), !1;
};
const Zs = /* @__PURE__ */ new Set();
function Gl(n) {
  Zs.has(n) || (Zs.add(n), n.addEventListener("copy", () => {
  }), n.addEventListener("cut", () => {
  }));
}
const tn = ["pre-wrap", "normal", "pre-line", "break-spaces"];
let Gt = !1;
function en() {
  Gt = !1;
}
class Xl {
  ...
  mustRefreshForWrapping(t) {
    return tn.indexOf(t) > -1 != this.lineWrapping;
  }
  ...
  refresh(t, e, i, s, r, o) {
    let l = tn.indexOf(t) > -1, h = Math.round(e) != Math.round(this.lineHeight) || this.lineWrapping != l;
...
class ct {
  ...
  */
  join(t) {
    ...
    return new ct(this.from, this.length + t.length, this.top, this.height + t.height, e);
  }
}
...
class J {
  ...
  setHeight(t) {
    this.height != t && (Math.abs(this.height - t) > je && (Gt = !0), this.height = t);
  }
  ...
  applyChanges(t, e, i, s) {
    ...
    for (let l = s.length - 1; l >= 0; l--) {
      let { fromA: h, toA: a, fromB: c, toB: f } = s[l], u = r.lineAt(h, N.ByPosNoHeight, i.setDoc(e), 0, 0), d = u.to >= a ? u : r.lineAt(a, N.ByPosNoHeight, i, 0, 0);
      for (f += d.to - a, a = d.to; l > 0 && u.from <= s[l - 1].toA; )
        h = s[l - 1].fromA, c = s[l - 1].fromB, l--, h < u.from && (u = r.lineAt(h, N.ByPosNoHeight, i, 0, 0));
      c += u.from - h, h = u.from;
      let p = gs.build(i.setDoc(o), t, c, f);
      r = ti(r, r.replace(h, a, p));
    }
  ...
  static of(t) {
    ...
    let o = 0;
    return t[e - 1] == null ? (o = 1, e--) : t[e] == null && (o = 1, i++), new _l(J.of(t.slice(0, e)), o, J.of(t.slice(i)));
  }
}
function ti(n, t) {
  return n == t ? n : (n.constructor != t.constructor && (Gt = !0), t);
}
J.prototype.size = 1;
class Fr extends J {
  constructor(t, e, i) {
  ...
  blockAt(t, e, i, s) {
    return new ct(s, this.length, i, this.height, this.deco || 0);
  }
  lineAt(t, e, i, s, r) {
...
class it extends Fr {
  ...
  blockAt(t, e, i, s) {
    return new ct(s, this.length, i, this.height, this.breaks);
  }
  replace(t, e, i) {
    let s = i[0];
    return i.length == 1 && (s instanceof it || s instanceof j && s.flags & 4) && Math.abs(this.length - s.length) < 10 ? (s instanceof j ? s = new it(s.length, this.height) : s.height = this.height, this.outdated || (s.outdated = !1), s) : J.of(i);
  }
  updateHeight(t, e = 0, i = !1, s) {
...
class j extends J {
  ...
  blockAt(t, e, i, s) {
    ...
    if (e.lineWrapping) {
      let a = s + (t < e.lineHeight ? 0 : Math.round(Math.max(0, Math.min(1, (t - i) / this.height)) * this.length)), c = e.doc.lineAt(a), f = l + c.length * h, u = Math.max(i, t - f / 2);
      return new ct(c.from, c.length, u, f, 0);
    } else {
      let a = Math.max(0, Math.min(o - r, Math.floor((t - i) / l))), { from: c, length: f } = e.doc.line(r + a);
      return new ct(c, f, i + l * a, l, 0);
    }
  }
  lineAt(t, e, i, s, r) {
    if (e == N.ByHeight)
    ...
    return new ct(a.from, a.length, Math.max(s, Math.min(u, s + this.height - c)), c, 0);
  }
  forEachLine(t, e, i, s, r, o) {
    ...
    for (let c = t, f = s; c <= e; ) {
      ...
      let d = h + a * u.length;
      o(new ct(u.from, u.length, f, d, 0)), f += d, c = u.to + 1;
    }
  }
  replace(t, e, i) {
    let s = this.length - e;
    ...
    if (t > 0) {
      let r = i[0];
      r instanceof j ? i[0] = new j(t + r.length) : i.unshift(new j(t - 1), null);
    }
    return J.of(i);
  }
  decomposeLeft(t, e) {
    e.push(new j(t - 1), null);
  }
  decomposeRight(t, e) {
    e.push(null, new j(this.length - t - 1));
  }
  updateHeight(t, e = 0, i = !1, s) {
    let r = e + this.length;
    if (s && s.from <= e + this.length && s.more) {
      let o = [], l = Math.max(e, s.from), h = -1;
      for (s.from > e && o.push(new j(s.from - e - 1).updateHeight(t, e)); l <= r && s.more; ) {
        let c = t.doc.lineAt(l).length;
        o.length && o.push(null);
        let f = s.heights[s.index++];
        h == -1 ? h = f : Math.abs(f - h) >= je && (h = -2);
        let u = new it(c, f);
        u.outdated = !1, o.push(u), l += c + 1;
      }
      l <= r && o.push(null, new j(r - l).updateHeight(t, l));
      let a = J.of(o);
      return (h < 0 || Math.abs(a.height - this.height) >= je || Math.abs(h - this.heightMetrics(t, e).perLine) >= je) && (Gt = !0), ti(this, a);
...
class _l extends J {
  ...
  lineAt(t, e, i, s, r) {
    let o = s + this.left.height, l = r + this.left.length + this.break, h = e == N.ByHeight ? t < o : t < l, a = h ? this.left.lineAt(t, e, i, s, r) : this.right.lineAt(t, e, i, o, l);
    if (this.break || (h ? a.to < l : a.from > l))
      return a;
    let c = e == N.ByPosNoHeight ? N.ByPosNoHeight : N.ByPos;
  ...
  forEachLine(t, e, i, s, r, o) {
    ...
    if (this.break)
      ...
      let a = this.lineAt(h, N.ByPos, i, s, r);
  ...
  replace(t, e, i) {
    ...
    for (let l of i)
      r.push(l);
    if (t > 0 && sn(r, o - 1), e < this.length) {
      let l = r.length;
      this.decomposeRight(e, r), sn(r, l);
    }
    return J.of(r);
  }
  decomposeLeft(t, e) {
  ...
  balanced(t, e) {
    return t.size > 2 * e.size || e.size > 2 * t.size ? J.of(this.break ? [t, null, e] : [t, e]) : (this.left = ti(this.left, t), this.right = ti(this.right, e), this.setHeight(t.height + e.height), this.outdated = t.outdated || e.outdated, this.size = t.size + e.size, this.length = t.length + this.break + e.length, this);
  }
  updateHeight(t, e = 0, i = !1, s) {
...
function sn(n, t) {
  let e, i;
  n[t] == null && (e = n[t - 1]) instanceof j && (i = n[t + 1]) instanceof j && n.splice(t - 1, 3, new j(e.length + 1 + i.length));
}
const Jl = 5;
class gs {
  constructor(t, e) {
  ...
  span(t, e) {
    if (this.lineStart > -1) {
      ...
      s instanceof it ? s.length += i - this.pos : (i > this.pos || !this.isCovered) && this.nodes.push(new it(i - this.pos, -1)), this.writtenTo = i, e > i && (this.nodes.push(null), this.writtenTo++, this.lineStart = -1);
    }
    this.pos = e;
  }
  point(t, e, i) {
    if (t < e || i.heightRelevant) {
      ...
      let o = e - t;
      i.block ? this.addBlock(new Fr(o, s, i)) : (o || r || s >= Jl) && this.addLineDeco(s, r, o);
  ...
  enterLine() {
    ...
    this.lineStart = t, this.lineEnd = e, this.writtenTo < t && ((this.writtenTo < t - 1 || this.nodes[this.nodes.length - 1] == null) && this.nodes.push(this.blankContent(this.writtenTo, t - 1)), this.nodes.push(null)), this.pos > t && this.nodes.push(new it(this.pos - t, -1)), this.writtenTo = this.pos;
  }
  blankContent(t, e) {
    let i = new j(e - t);
  ...
  finish(t) {
    ...
    this.lineStart > -1 && !(e instanceof it) && !this.isCovered ? this.nodes.push(new it(0, -1)) : (this.writtenTo < this.pos || e == null) && this.nodes.push(this.blankContent(this.writtenTo, this.pos));
    let i = t;
    for (let s of this.nodes)
      s instanceof it && s.updateHeight(this.oracle, i), i += s ? s.length : 1;
    return this.nodes;
  }
  ...
  static build(t, e, i, s) {
    let r = new gs(i, t);
    return T.spans(e, i, s, r, 0), r.finish(i);
  }
}
function Ql(n, t, e) {
  let i = new Zl();
  return T.compare(n, t, e, i, 0), i.changes;
}
class Zl {
  constructor() {
    this.changes = [];
  ...
  for (let a = n.parentNode; a && a != i.body; )
    if (a.nodeType == 1) {
      ...
      if ((c.scrollHeight > c.clientHeight || c.scrollWidth > c.clientWidth) && f.overflow != "visible") {
        ...
        r = Math.max(r, u.left), o = Math.min(o, u.right), l = Math.max(l, u.top), h = Math.min(a == n.parentNode ? s.innerHeight : h, u.bottom);
      }
...
class gi {
  ...
  draw(t, e) {
    return K.replace({
      widget: new sh(this.displaySize * (e ? t.scaleY : t.scaleX), e)
...
class nn {
  constructor(t) {
    this.state = t, this.pixelViewport = { left: 0, right: window.innerWidth, top: 0, bottom: 0 }, this.inView = !0, this.paddingTop = 0, this.paddingBottom = 0, this.contentDOMWidth = 0, this.contentDOMHeight = 0, this.editorHeight = 0, this.editorWidth = 0, this.scrollTop = 0, this.scrolledToBottom = !1, this.scaleX = 1, this.scaleY = 1, this.scrollAnchorPos = 0, this.scrollAnchorHeight = -1, this.scaler = rn, this.scrollTarget = null, this.printing = !1, this.mustMeasureContent = !0, this.defaultTextDirection = W.LTR, this.visibleRanges = [], this.mustEnforceCursorAssoc = !1;
    let e = t.facet(fs).some((i) => typeof i != "function" && i.class == "cm-lineWrapping");
    this.heightOracle = new Xl(e), this.stateDeco = t.facet(ge).filter((i) => typeof i != "function"), this.heightMap = J.empty().applyChanges(this.stateDeco, E.empty, this.heightOracle.setDoc(t.doc), [new st(0, 0, 0, t.doc.length)]);
    for (let i = 0; i < 2 && (this.viewport = this.getViewport(0, null), !!this.updateForViewport()); i++)
      ;
    this.updateViewportLines(), this.lineGaps = this.ensureLineGaps([]), this.lineGapDeco = K.set(this.lineGaps.map((i) => i.draw(this, !1))), this.computeVisibleRanges();
  }
  updateForViewport() {
  ...
  updateScaler() {
    let t = this.scaler;
    return this.scaler = this.heightMap.height <= 7e6 ? rn : new ms(this.heightOracle, this.heightMap, this.viewports), t.eq(this.scaler) ? 0 : 2;
  }
  updateViewportLines() {
    this.viewportLines = [], this.heightMap.forEachLine(this.viewport.from, this.viewport.to, this.heightOracle.setDoc(this.state.doc), 0, 0, (t) => {
      this.viewportLines.push(ie(t, this.scaler));
    });
  }
  update(t, e = null) {
    this.state = t.state;
    let i = this.stateDeco;
    this.stateDeco = this.state.facet(ge).filter((c) => typeof c != "function");
    let s = t.changedRanges, r = st.extendWithRanges(s, Ql(i, this.stateDeco, t ? t.changes : q.empty(this.state.doc.length))), o = this.heightMap.height, l = this.scrolledToBottom ? null : this.scrollAnchorAt(this.scrollTop);
    en(), this.heightMap = this.heightMap.applyChanges(this.stateDeco, t.startState.doc, this.heightOracle.setDoc(this.state.doc), r), (this.heightMap.height != o || Gt) && (t.flags |= 2), l ? (this.scrollAnchorPos = t.changes.mapPos(l.from, -1), this.scrollAnchorHeight = l.top) : (this.scrollAnchorPos = -1, this.scrollAnchorHeight = this.heightMap.height);
  ...
  measure(t) {
    ...
    let a = 0, c = 0;
    if (l.width && l.height) {
      let { scaleX: v, scaleY: k } = Xn(e, l);
      (v > 5e-3 && Math.abs(this.scaleX - v) > 5e-3 || k > 5e-3 && Math.abs(this.scaleY - k) > 5e-3) && (this.scaleX = v, this.scaleY = k, a |= 16, o = h = !0);
    }
    let f = (parseInt(i.paddingTop) || 0) * this.scaleY, u = (parseInt(i.paddingBottom) || 0) * this.scaleY;
    (this.paddingTop != f || this.paddingBottom != u) && (this.paddingTop = f, this.paddingBottom = u, a |= 18), this.editorWidth != t.scrollDOM.clientWidth && (s.lineWrapping && (h = !0), this.editorWidth = t.scrollDOM.clientWidth, a |= 16);
    let d = t.scrollDOM.scrollTop * this.scaleY;
    this.scrollTop != d && (this.scrollAnchorHeight = -1, this.scrollTop = d), this.scrolledToBottom = Jn(t.scrollDOM);
    let p = (this.printing ? ih : th)(e, this.paddingTop), g = p.top - this.pixelViewport.top, m = p.bottom - this.pixelViewport.bottom;
    this.pixelViewport = p;
    let w = this.pixelViewport.bottom > this.pixelViewport.top && this.pixelViewport.right > this.pixelViewport.left;
    if (w != this.inView && (this.inView = w, w && (h = !0)), !this.inView && !this.scrollTarget && !eh(t.dom))
      return 0;
    let b = l.width;
    if ((this.contentDOMWidth != b || this.editorHeight != t.scrollDOM.clientHeight) && (this.contentDOMWidth = l.width, this.editorHeight = t.scrollDOM.clientHeight, a |= 16), h) {
      ...
      if (s.mustRefreshForHeights(v) && (o = !0), o || s.lineWrapping && Math.abs(b - this.contentDOMWidth) > s.charWidth) {
        let { lineHeight: k, charWidth: C, textHeight: B } = t.docView.measureTextSize();
        o = k > 0 && s.refresh(r, k, C, B, b / C, v), o && (t.docView.minWidth = 0, a |= 16);
      }
      g > 0 && m > 0 ? c = Math.max(g, m) : g < 0 && m < 0 && (c = Math.min(g, m)), en();
      for (let k of this.viewports) {
        let C = k.from == this.viewport.from ? v : t.docView.measureVisibleLineHeights(k);
        this.heightMap = (o ? J.empty().applyChanges(this.stateDeco, E.empty, this.heightOracle, [new st(0, 0, 0, t.state.doc.length)]) : this.heightMap).updateHeight(s, 0, o, new Ul(k.from, C));
      }
      Gt && (a |= 2);
    }
    ...
    return S && (a & 2 && (a |= this.updateScaler()), this.viewport = this.getViewport(c, this.scrollTarget), a |= this.updateForViewport()), (a & 2 || S) && this.updateViewportLines(), (this.lineGaps.length || this.viewport.to - this.viewport.from > 4e3) && this.updateLineGaps(this.ensureLineGaps(o ? [] : this.lineGaps, t)), a |= this.computeVisibleRanges(), this.mustEnforceCursorAssoc && (this.mustEnforceCursorAssoc = !1, t.docView.enforceCursorAssoc()), a;
  }
  get visibleTop() {
  ...
  getViewport(t, e) {
    let i = 0.5 - Math.max(-0.5, Math.min(0.5, t / 1e3 / 2)), s = this.heightMap, r = this.heightOracle, { visibleTop: o, visibleBottom: l } = this, h = new Pe(s.lineAt(o - i * 1e3, N.ByHeight, r, 0, 0).from, s.lineAt(l + (1 - i) * 1e3, N.ByHeight, r, 0, 0).to);
    if (e) {
      let { head: a } = e.range;
      if (a < h.from || a > h.to) {
        let c = Math.min(this.editorHeight, this.pixelViewport.bottom - this.pixelViewport.top), f = s.lineAt(a, N.ByPos, r, 0, 0), u;
        e.y == "center" ? u = (f.top + f.bottom) / 2 - c / 2 : e.y == "start" || e.y == "nearest" && a < h.from ? u = f.top : u = f.bottom - c, h = new Pe(s.lineAt(u - 1e3 / 2, N.ByHeight, r, 0, 0).from, s.lineAt(u + c + 1e3 / 2, N.ByHeight, r, 0, 0).to);
      }
    }
    return h;
  }
  mapViewport(t, e) {
    ...
    return new Pe(this.heightMap.lineAt(i, N.ByPos, this.heightOracle, 0, 0).from, this.heightMap.lineAt(s, N.ByPos, this.heightOracle, 0, 0).to);
  }
  ...
  viewportIsAppropriate({ from: t, to: e }, i = 0) {
    if (!this.inView)
      return !0;
    let { top: s } = this.heightMap.lineAt(t, N.ByPos, this.heightOracle, 0, 0), { bottom: r } = this.heightMap.lineAt(e, N.ByPos, this.heightOracle, 0, 0), { visibleTop: o, visibleBottom: l } = this;
  ...
  mapLineGaps(t, e) {
    ...
    let i = [];
    for (let s of t)
      e.touchesRange(s.from, s.to) || i.push(new gi(e.mapPos(s.from), e.mapPos(s.to), s.size, s.displaySize));
    return i;
  }
  ...
  ensureLineGaps(t, e) {
    ...
    let l = [], h = (c, f, u, d) => {
      ...
      for (let w of g)
        if (w > c && w < f) {
          h(c, w - 10, u, d), h(w + 10, f, u, d);
          return;
        }
      let m = rh(t, (w) => w.from >= u.from && w.to <= u.to && Math.abs(w.from - c) < r && Math.abs(w.to - f) < r && !g.some((b) => w.from < b && w.to > b));
      if (!m) {
        if (f < u.to && e && i && e.visibleRanges.some((S) => S.from <= f && S.to >= f)) {
          let S = e.moveToLineBoundary(x.cursor(f), !1, !0).head;
          S > c && (f = S);
        }
        let w = this.gapSize(u, c, f, d), b = i || w < 2e6 ? w : 2e6;
        m = new gi(c, f, w, b);
      }
      l.push(m);
    }, a = (c) => {
      if (c.length < o || c.type != _.Text)
        return;
      let f = nh(c.from, c.to, this.stateDeco);
      if (f.total < o)
        return;
      let u = this.scrollTarget ? this.scrollTarget.range.head : null, d, p;
      if (i) {
        let g = s / this.heightOracle.lineLength * this.heightOracle.lineHeight, m, w;
        if (u != null) {
          let b = Be(f, u), S = ((this.visibleBottom - this.visibleTop) / 2 + g) / c.height;
          m = b - S, w = b + S;
        } else
          m = (this.visibleTop - c.top - g) / c.height, w = (this.visibleBottom - c.top + g) / c.height;
        d = Le(f, m), p = Le(f, w);
      } else {
        let g = f.total * this.heightOracle.charWidth, m = s * this.heightOracle.charWidth, w = 0;
        if (g > 2e6)
          for (let C of t)
            C.from >= c.from && C.from < c.to && C.size != C.displaySize && C.from * this.heightOracle.charWidth + w < this.pixelViewport.left && (w = C.size - C.displaySize);
        let b = this.pixelViewport.left + w, S = this.pixelViewport.right + w, v, k;
        if (u != null) {
          let C = Be(f, u), B = ((S - b) / 2 + m) / g;
          v = C - B, k = C + B;
        } else
          v = (b - m) / g, k = (S + m) / g;
        d = Le(f, v), p = Le(f, k);
      }
      d > c.from && h(c.from, d, c, f), p < c.to && h(p, c.to, c, f);
    };
    for (let c of this.viewportLines)
      Array.isArray(c.type) ? c.type.forEach(a) : a(c);
    return l;
  }
  gapSize(t, e, i, s) {
    let r = Be(s, i) - Be(s, e);
  ...
  updateLineGaps(t) {
    gi.same(t, this.lineGaps) || (this.lineGaps = t, this.lineGapDeco = K.set(t.map((e) => e.draw(this, this.heightOracle.lineWrapping))));
  }
  computeVisibleRanges(t) {
    let e = this.stateDeco;
    this.lineGaps.length && (e = e.concat(this.lineGapDeco));
    let i = [];
    T.spans(e, this.viewport.from, this.viewport.to, {
      span(r, o) {
        i.push({ from: r, to: o });
      },
      point() {
  ...
  lineBlockAt(t) {
    return t >= this.viewport.from && t <= this.viewport.to && this.viewportLines.find((e) => e.from <= t && e.to >= t) || ie(this.heightMap.lineAt(t, N.ByPos, this.heightOracle, 0, 0), this.scaler);
  }
  lineBlockAtHeight(t) {
    return t >= this.viewportLines[0].top && t <= this.viewportLines[this.viewportLines.length - 1].bottom && this.viewportLines.find((e) => e.top <= t && e.bottom >= t) || ie(this.heightMap.lineAt(this.scaler.fromDOM(t), N.ByHeight, this.heightOracle, 0, 0), this.scaler);
  }
  scrollAnchorAt(t) {
  ...
  elementAtHeight(t) {
    return ie(this.heightMap.blockAt(this.scaler.fromDOM(t), this.heightOracle, 0, 0), this.scaler);
  }
  get docHeight() {
...
function Le({ total: n, ranges: t }, e) {
  if (e <= 0)
    return t[0].from;
  if (e >= 1)
...
class ms {
  constructor(t, e, i) {
    ...
    this.viewports = i.map(({ from: l, to: h }) => {
      let a = e.lineAt(l, N.ByPos, t, 0, 0).top, c = e.lineAt(h, N.ByPos, t, 0, 0).bottom;
  ...
  eq(t) {
    return t instanceof ms ? this.scale == t.scale && this.viewports.length == t.viewports.length && this.viewports.every((e, i) => e.from == t.viewports[i].from && e.to == t.viewports[i].to) : !1;
  }
}
function ie(n, t) {
  if (t.scale == 1)
  ...
  return new ct(n.from, n.length, e, i - e, Array.isArray(n._content) ? n._content.map((s) => ie(s, t)) : n._content);
}
const Ne = /* @__PURE__ */ M.define({ combine: (n) => n.join(" ") }), Ui = /* @__PURE__ */ M.define({ combine: (n) => n.indexOf(!0) > -1 }), _i = /* @__PURE__ */ Kt.newName(), Wr = /* @__PURE__ */ Kt.newName(), zr = /* @__PURE__ */ Kt.newName(), $r = { "&light": "." + Wr, "&dark": "." + zr };
function Ji(n, t, e) {
  return new Kt(t, {
    finish(i) {
...
class hh {
  constructor(t) {
    ...
    !(y.chrome && y.chrome_version < 126) && (this.editContext = new ch(t), t.state.facet(gt) && (t.contentDOM.editContext = this.editContext.editContext)), mi && (this.onCharData = (e) => {
      this.queue.push({
        target: e.target,
        type: "characterData",
  ...
  onSelectionChange(t) {
    ...
    if (i.state.facet(gt) ? i.root.activeElement != this.dom : !$e(this.dom, s))
      return;
    ...
    s.focusNode && oe(s.focusNode, s.focusOffset, s.anchorNode, s.anchorOffset) ? this.flushSoon() : this.flush(!1);
  }
  readSelectionRange() {
    let { view: t } = this, e = de(t.root);
    if (!e)
      return !1;
    let i = y.safari && t.root.nodeType == 11 && t.root.activeElement == this.dom && ah(this.view, e) || e;
    if (!i || this.selectionRange.eq(i))
      return !1;
    let s = $e(this.dom, i);
    return s && !this.selectionChanged && t.inputState.lastFocusTime > Date.now() - 200 && t.inputState.lastTouchTime < Date.now() - 300 && jo(this.dom, i) ? (this.view.inputState.lastFocusTime = 0, t.docView.updateSelection(), !1) : (this.selectionRange.setRange(i), s && (this.selectionChanged = !0), !0);
  }
  ...
  start() {
    this.active || (this.observer.observe(this.dom, lh), mi && this.dom.addEventListener("DOMCharacterDataModified", this.onCharData), this.active = !0);
  }
  stop() {
    this.active && (this.active = !1, this.observer.disconnect(), mi && this.dom.removeEventListener("DOMCharacterDataModified", this.onCharData));
  }
  ...
  readChange() {
    let { from: t, to: e, typeOver: i } = this.processRecords(), s = this.selectionChanged && $e(this.dom, this.selectionRange);
    if (t < 0 && !s)
      return null;
    t > -1 && (this.lastChange = Date.now()), this.view.inputState.lastFocusTime = 0, this.selectionChanged = !1;
    let r = new Al(this.view, t, e, i);
  ...
  flush(t = !0) {
    ...
    let i = this.view.state, s = Er(this.view, e);
  ...
  readMutation(t) {
    ...
    if (e.markDirty(t.type == "attributes"), t.type == "attributes" && (e.flags |= 4), t.type == "childList") {
      let i = on(e, t.previousSibling || t.target.previousSibling, -1), s = on(e, t.nextSibling || t.target.nextSibling, 1);
      return {
...
function ln(n, t) {
  ...
  return oe(o.node, o.offset, s, r) && ([e, i, s, r] = [s, r, e, i]), { anchorNode: e, anchorOffset: i, focusNode: s, focusOffset: r };
}
function ah(n, t) {
  ...
  return n.contentDOM.addEventListener("beforeinput", i, !0), n.dom.ownerDocument.execCommand("indent"), n.contentDOM.removeEventListener("beforeinput", i, !0), e ? ln(n, e) : null;
}
class ch {
  constructor(t) {
    ...
    this.handlers.textupdate = (i) => {
      ...
      let a = { from: l, to: h, insert: E.of(i.text.split(`
`)) };
      if (a.from == this.from && r < this.from ? a.from = r : a.to == this.to && r > this.to && (a.to = r), a.from == a.to && !a.insert.length) {
        let c = x.single(this.toEditorPos(i.selectionStart), this.toEditorPos(i.selectionEnd));
        c.main.eq(s) || t.dispatch({ selection: c, userEvent: "select" });
        return;
      }
      if ((y.mac || y.android) && a.from == o - 1 && /^\. ?$/.test(i.text) && t.contentDOM.getAttribute("autocorrect") == "off" && (a = { from: l, to: h, insert: E.of([i.text.replace(".", " ")]) }), this.pendingContextChange = a, !t.state.readOnly) {
        let c = this.to - this.from + (a.to - a.from + a.insert.length);
        ps(t, a, x.single(this.toEditorPos(i.selectionStart, c), this.toEditorPos(i.selectionEnd, c)));
      }
      ...
      for (let r of i.getTextFormats()) {
        ...
        if (o != "None" && l != "None") {
          ...
          if (h < a) {
            ...
            s.push(K.mark({ attributes: { style: c } }).range(h, a));
          }
        }
      }
      t.dispatch({ effects: Cr.of(K.set(s)) });
  ...
  applyEdits(t) {
    ...
    return t.changes.iterChanges((r, o, l, h, a) => {
      ...
      if (r += e, o += e, o <= this.from)
        ...
        this.editContext.updateText(this.toContextPos(r), this.toContextPos(o), a.toString()), this.to += c;
      }
      e += c;
...
class O {
  ...
  */
  constructor(t = {}) {
    ...
    let { dispatch: i } = t;
    this.dispatchTransactions = t.dispatchTransactions || i && ((s) => s.forEach((r) => i(r, this))) || ((s) => this.update(s)), this.dispatch = this.dispatch.bind(this), this._root = t.root || Ko(t.parent) || document, this.viewState = new nn(t.state || R.create(t)), t.scrollTo && t.scrollTo.is(Te) && (this.viewState.scrollTarget = t.scrollTo.value.clip(this.viewState.state)), this.plugins = this.state.facet(Zt).map((s) => new ui(s));
    for (let s of this.plugins)
      s.update(this);
    this.observer = new hh(this), this.inputState = new Rl(this), this.inputState.ensureHandlers(this.plugins), this.docView = new Vs(this), this.mountStyles(), this.updateAttrs(), this.updateState = 0, this.requestMeasure(), !((e = document.fonts) === null || e === void 0) && e.ready && document.fonts.ready.then(() => this.requestMeasure());
  }
  dispatch(...t) {
    let e = t.length == 1 && t[0] instanceof X ? t : t.length == 1 && Array.isArray(t[0]) ? t[0] : [this.state.update(...t)];
  ...
  */
  update(t) {
    ...
    t.some((u) => u.annotation(Hr)) ? (this.inputState.notifiedFocused = o, l = 1) : o != this.inputState.notifiedFocused && (this.inputState.notifiedFocused = o, h = Ir(r, o), h || (l = 1));
    let a = this.observer.delayedAndroidKey, c = null;
    if (a ? (this.observer.clearDelayedAndroidKey(), c = this.observer.readChange(), (c && !this.state.doc.eq(r.doc) || !this.state.selection.eq(r.selection)) && (c = null)) : this.observer.clear(), r.facet(R.phrases) != this.state.facet(R.phrases))
    ...
    try {
      ...
      for (let u of t) {
        if (f && (f = f.map(u.changes)), u.scrollIntoView) {
          ...
          f = new Wt(d.empty ? d : x.cursor(d.head, d.head > d.anchor ? -1 : 1));
        }
        for (let d of u.effects)
          d.is(Te) && (f = d.value.clip(this.state));
      }
      this.viewState.update(s, f), this.bidiCache = ei.update(this.bidiCache, s.changes), s.empty || (this.updatePlugins(s), this.inputState.update(s)), e = this.docView.update(s), this.state.facet(te) != this.styleModules && this.mountStyles(), i = this.updateAttrs(), this.showAnnouncements(t), this.docView.updateSelection(e, t.some((u) => u.isUserEvent("select.pointer")));
    } finally {
      this.updateState = 0;
    }
    if (s.startState.facet(Ne) != s.state.facet(Ne) && (this.viewState.mustMeasureContent = !0), (e || i || f || this.viewState.mustEnforceCursorAssoc || this.viewState.mustMeasureContent) && this.requestMeasure(), e && this.docViewUpdate(), !s.empty)
      for (let u of this.state.facet(ji))
        try {
          u(s);
        } catch (d) {
    ...
    (h || c) && Promise.resolve().then(() => {
      h && this.state == h.startState && this.dispatch(h), c && !Er(this, c) && a.force && Ft(this.contentDOM, a.key, a.keyCode);
    });
  }
  /**
  ...
  */
  setState(t) {
    ...
    try {
      for (let i of this.plugins)
        i.destroy(this);
      this.viewState = new nn(t), this.plugins = t.facet(Zt).map((i) => new ui(i)), this.pluginMap.clear();
      for (let i of this.plugins)
        i.update(this);
      this.docView.destroy(), this.docView = new Vs(this), this.inputState.ensureHandlers(this.plugins), this.mountStyles(), this.updateAttrs(), this.bidiCache = [];
    } finally {
      this.updateState = 0;
    }
  ...
  updatePlugins(t) {
    let e = t.startState.facet(Zt), i = t.state.facet(Zt);
    if (e != i) {
      let s = [];
      for (let r of i) {
        let o = e.indexOf(r);
  ...
  */
  measure(t = !0) {
      ...
      for (let l = 0; ; l++) {
        ...
        let c = a.map((d) => {
          try {
            ...
            return ut(this.state, p), hn;
          }
        }), f = Ze.create(this, this.state, []), u = !1;
    ...
    if (e && !e.empty)
      for (let l of this.state.facet(ji))
        l(e);
  }
  /**
  ...
  */
  get themeClasses() {
    return _i + " " + (this.state.facet(Ui) ? zr : Wr) + " " + this.state.facet(Ne);
  }
  updateAttrs() {
    let t = an(this, kr, {
    ...
    this.state.readOnly && (e["aria-readonly"] = "true"), an(this, fs, e);
    let i = this.observer.ignore(() => {
      let s = Wi(this.contentDOM, this.contentAttrs, e), r = Wi(this.dom, this.editorAttrs, t);
      return s || r;
    });
  ...
  mountStyles() {
    this.styleModules = this.state.facet(te);
    let t = this.state.facet(O.cspNonce);
    Kt.mount(this.root, this.styleModules.concat(oh).reverse(), t ? { nonce: t } : void 0);
  }
  readMeasured() {
  ...
  */
  moveByChar(t, e, i) {
    return pi(this, t, qs(this, t, e, i));
  }
  /**
  ...
  */
  moveByGroup(t, e) {
    return pi(this, t, qs(this, t, e, (i) => Sl(this, t.head, i)));
  }
  /**
  ...
  */
  moveVertically(t, e, i) {
    return pi(this, t, Cl(this, t, e, i));
  }
  /**
  ...
  */
  ...
  posAtCoords(t, e = !0) {
    return this.readMeasured(), Tr(this, t, e);
  }
  /**
  ...
  */
  coordsAtPos(t, e = 1) {
    ...
    if (!i || i.left == i.right)
      return i;
    let s = this.state.doc.lineAt(t), r = this.bidiSpans(s), o = r[kt.find(r, t - s.from, -1, e)];
    return si(i, o.dir == W.LTR == e > 0);
  }
  /**
  ...
  */
  textDirectionAt(t) {
    return !this.state.facet(vr) || t < this.viewport.from || t > this.viewport.to ? this.textDirection : (this.readMeasured(), this.docView.textDirectionAt(t));
  }
  /**
  ...
  */
  bidiSpans(t) {
    ...
    for (let r of this.bidiCache)
      if (r.from == t.from && r.dir == e && (r.fresh || fr(r.isolates, i = Is(this, t))))
        return r.order;
    i || (i = Is(this, t));
    let s = rl(t.text, e, i);
    return this.bidiCache.push(new ei(t.from, t.to, e, i, !0, s)), s;
  }
  /**
  ...
  */
  focus() {
    this.observer.ignore(() => {
      Un(this.contentDOM), this.docView.updateSelection();
    });
  }
  /**
  ...
  */
  static scrollIntoView(t, e = {}) {
    return Te.of(new Wt(typeof t == "number" ? x.cursor(t) : t, e.y, e.x, e.yMargin, e.xMargin));
  }
  /**
  ...
  */
  scrollSnapshot() {
    ...
    return Te.of(new Wt(x.cursor(i.from), "start", "start", i.top - t, e, !0));
  }
  /**
  ...
  */
  static domEventObservers(t) {
    return tt.define(() => ({}), { eventObservers: t });
  }
  /**
  ...
  */
  static theme(t, e) {
    let i = Kt.newName(), s = [Ne.of(i), te.of(Ji(`.${i}`, t))];
    return e && e.dark && s.push(Ui.of(!0)), s;
  }
  /**
  ...
  */
  static baseTheme(t) {
    return ns.lowest(te.of(Ji("." + _i, t, $r)));
  }
  /**
  ...
  */
  static findFromDOM(t) {
    var e;
    let i = t.querySelector(".cm-content"), s = i && L.get(i) || L.get(t);
    return ((e = s == null ? void 0 : s.rootView) === null || e === void 0 ? void 0 : e.view) || null;
  }
}
O.styleModule = te;
O.inputHandler = br;
O.clipboardInputFilter = as;
O.clipboardOutputFilter = cs;
O.scrollHandler = Sr;
O.focusChangeEffect = yr;
O.perLineTextDirection = vr;
O.exceptionSink = wr;
O.updateListener = ji;
O.editable = gt;
O.mouseSelectionStyle = mr;
O.dragMovesSelection = gr;
O.clickAddsSelectionRange = pr;
O.decorations = ge;
O.outerDecorations = Mr;
O.atomicRanges = us;
O.bidiIsolatedRanges = Ar;
O.scrollMargins = Or;
O.darkTheme = Ui;
O.cspNonce = /* @__PURE__ */ M.define({ combine: (n) => n.length ? n[0] : "" });
O.contentAttributes = fs;
O.editorAttributes = kr;
...
class ei {
  ...
  static update(t, e) {
    if (e.empty && !t.some((r) => r.fresh))
      return t;
    let i = [], s = t.length ? t[t.length - 1].dir : W.LTR;
    for (let r = Math.max(0, t.length - 10); r < t.length; r++) {
      let o = t[r];
      o.dir == s && !e.touchesRange(o.from, o.to) && i.push(new ei(e.mapPos(o.from, 1), e.mapPos(o.to, -1), o.dir, o.isolates, !1, o.order));
    }
    return i;
  }
}
...
const uh = y.mac ? "mac" : y.windows ? "win" : y.linux ? "linux" : "key";
function dh(n, t) {
  const e = n.split(/-(?!$)/);
  let i = e[e.length - 1];
  i == "Space" && (i = " ");
...
const ph = /* @__PURE__ */ ns.default(/* @__PURE__ */ O.domEventHandlers({
  keydown(n, t) {
    return jr(Kr(t.state), n, t, "editor");
  }
})), qr = /* @__PURE__ */ M.define({ enables: ph }), cn = /* @__PURE__ */ new WeakMap();
function Kr(n) {
  let t = n.facet(qr), e = cn.get(t);
  return e || cn.set(t, e = mh(t.reduce((i, s) => i.concat(s), []))), e;
}
function ka(n, t, e) {
  return jr(Kr(n.state), t, n, e);
}
let xt = null;
const gh = 4e3;
function mh(n, t = uh) {
  let e = /* @__PURE__ */ Object.create(null), i = /* @__PURE__ */ Object.create(null), s = (o, l) => {
    ...
    var f, u;
    let d = e[o] || (e[o] = /* @__PURE__ */ Object.create(null)), p = l.split(/ (?!$)/).map((w) => dh(w, t));
    for (let w = 1; w < p.length; w++) {
      let b = p.slice(0, w).join(" ");
      s(b, !0), d[b] || (d[b] = {
        preventDefault: !0,
        stopPropagation: !1,
        run: [(S) => {
          let v = xt = { view: S, prefix: b, scope: o };
          return setTimeout(() => {
            xt == v && (xt = null);
          }, gh), !0;
        }]
    ...
    h && m.run.push(h), a && (m.preventDefault = !0), c && (m.stopPropagation = !0);
  };
  for (let o of n) {
...
function jr(n, t, e, i) {
  Qi = t;
  let s = ro(t), r = Bn(s, 0), o = Ao(r) == s.length && s != " ", l = "", h = !1, a = !1, c = !1;
  xt && xt.view == e && xt.scope == i && (l = xt.prefix + " ", Pr.indexOf(t.keyCode) < 0 && (a = !0, xt = null));
  let f = /* @__PURE__ */ new Set(), u = (m) => {
    if (m) {
      for (let w of m.run)
        if (!f.has(w) && (f.add(w), w(e)))
          return m.stopPropagation && (c = !0), !0;
      m.preventDefault && (m.stopPropagation && (c = !0), a = !0);
    }
    return !1;
  }, d = n[i], p, g;
  return d && (u(d[l + He(s, t, !o)]) ? h = !0 : o && (t.altKey || t.metaKey || t.ctrlKey) && // Ctrl-Alt may be used for AltGr on Windows
  !(y.windows && t.ctrlKey && t.altKey) && (p = oo[t.keyCode]) && p != s ? (u(d[l + He(p, t, !0)]) || t.shiftKey && (g = lo[t.keyCode]) != s && g != p && u(d[l + He(g, t, !1)])) && (h = !0) : o && t.shiftKey && u(d[l + He(s, t, !0)]) && (h = !0), !h && u(d._any) && (h = !0)), a && (h = !0), h && c && t.stopPropagation(), Qi = null, h;
}
class ve {
  /**
  ...
  static forRange(t, e, i) {
    if (i.empty) {
      ...
      if (!s)
        return [];
      let r = Yr(t);
      return [new ve(e, s.left - r.left, s.top - r.top, null, s.bottom - s.top)];
    } else
      return wh(t, e, i);
  }
}
function Yr(n) {
  ...
  return { left: (n.textDirection == W.LTR ? t.left : t.right - n.scrollDOM.clientWidth * n.scaleX) - n.scrollDOM.scrollLeft * n.scaleX, top: t.top - n.scrollDOM.scrollTop * n.scaleY };
}
function fn(n, t, e, i) {
  let s = n.coordsAtPos(t, e * 2);
  if (!s)
    return i;
  let r = n.dom.getBoundingClientRect(), o = (s.top + s.bottom) / 2, l = n.posAtCoords({ x: r.left + 1, y: o }), h = n.posAtCoords({ x: r.right - 1, y: o });
...
function wh(n, t, e) {
  if (e.to <= n.viewport.from || e.from >= n.viewport.to)
    return [];
  let i = Math.max(e.from, n.viewport.from), s = Math.min(e.to, n.viewport.to), r = n.textDirection == W.LTR, o = n.contentDOM, l = o.getBoundingClientRect(), h = Yr(n), a = o.querySelector(".cm-line"), c = a && window.getComputedStyle(a), f = l.left + (c ? parseInt(c.paddingLeft) + Math.min(0, parseInt(c.textIndent)) : 0), u = l.right - (c ? parseInt(c.paddingRight) : 0), d = Gi(n, i), p = Gi(n, s), g = d.type == _.Text ? d : null, m = p.type == _.Text ? p : null;
  if (g && (n.lineWrapping || d.widgetLineBreaks) && (g = fn(n, i, 1, g)), m && (n.lineWrapping || p.widgetLineBreaks) && (m = fn(n, s, -1, m)), g && m && g.from == m.from && g.to == m.to)
    return b(S(e.from, e.to, g));
  {
    let k = g ? S(e.from, null, g) : v(d, !1), C = m ? S(null, e.to, m) : v(p, !0), B = [];
    return (g || d).to < (m || p).from - (g && m ? 1 : 0) || d.widgetLineBreaks > 1 && k.bottom + n.defaultLineHeight / 2 < C.top ? B.push(w(f, k.bottom, u, C.top)) : k.bottom < C.top && n.elementAtHeight((k.bottom + C.top) / 2).type == _.Text && (k.bottom = C.top = (k.bottom + C.top) / 2), b(k).concat(B).concat(b(C));
  }
  function w(k, C, B, z) {
    return new ve(t, k - h.left, C - h.top, B - k, z - C);
  }
  function b({ top: k, bottom: C, horizontal: B }) {
    let z = [];
    for (let et = 0; et < B.length; et += 2)
      z.push(w(B[et], k, B[et + 1], C));
    return z;
  }
  function S(k, C, B) {
    let z = 1e9, et = -1e9, Lt = [];
    function xe(pt, lt, U, A, D) {
      let H = n.coordsAtPos(pt, pt == B.to ? -2 : 2), I = n.coordsAtPos(U, U == B.from ? 2 : -2);
      !H || !I || (z = Math.min(H.top, I.top, z), et = Math.max(H.bottom, I.bottom, et), D == W.LTR ? Lt.push(r && lt ? f : H.left, r && A ? u : I.right) : Lt.push(!r && A ? f : I.left, !r && lt ? u : H.right));
    }
    let Bt = k ?? B.from, Nt = C ?? B.to;
    for (let pt of n.visibleRanges)
      if (pt.to > Bt && pt.from < Nt)
        for (let lt = Math.max(pt.from, Bt), U = Math.min(pt.to, Nt); ; ) {
          let A = n.state.doc.lineAt(lt);
          for (let D of n.bidiSpans(A)) {
            let H = D.from + A.from, I = D.to + A.from;
            if (H >= U)
              break;
            I > lt && xe(Math.max(H, lt), k == null && H <= Bt, Math.min(I, U), C == null && I >= Nt, D.dir);
          }
          if (lt = A.to + 1, lt >= U)
            break;
        }
    return Lt.length == 0 && xe(Bt, k == null, Nt, C == null, n.textDirection), { top: z, bottom: et, horizontal: Lt };
  }
  function v(k, C) {
    let B = l.top + (C ? k.top : k.bottom);
...
class yh {
  ...
  update(t) {
    t.startState.facet(Ye) != t.state.facet(Ye) && this.setOrder(t.state), (this.layer.update(t, this.dom) || t.geometryChanged) && (this.scale(), t.view.requestMeasure(this.measureReq));
  }
  docViewUpdate(t) {
    this.layer.updateOnDocViewUpdate !== !1 && t.requestMeasure(this.measureReq);
  }
  setOrder(t) {
    let e = 0, i = t.facet(Ye);
  ...
  draw(t) {
    if (t.length != this.drawn.length || t.some((e, i) => !bh(e, this.drawn[i]))) {
...
const Ye = /* @__PURE__ */ M.define();
function Gr(n) {
  return [
    tt.define((t) => new yh(t, n)),
    Ye.of(n)
  ];
}
const me = /* @__PURE__ */ M.define({
  combine(n) {
    return rs(n, {
...
function Xr(n) {
  return n.startState.facet(me) != n.state.facet(me);
}
const vh = /* @__PURE__ */ Gr({
  above: !0,
  markers(n) {
    let { state: t } = n, e = t.facet(me), i = [];
    for (let s of t.selection.ranges) {
      ...
      if (s.empty || e.drawRangeCursor) {
        ...
        for (let h of ve.forRange(n, o, l))
          i.push(h);
      }
    }
    return i;
  ...
  update(n, t) {
    ...
    let e = Xr(n);
    return e && un(n.state, t), n.docChanged || n.selectionSet || e;
  },
  mount(n, t) {
    un(t.state, n);
  },
...
function un(n, t) {
  t.style.animationDuration = n.facet(me).cursorBlinkRate + "ms";
}
const xh = /* @__PURE__ */ Gr({
  above: !1,
  markers(n) {
    return n.state.selection.ranges.map((t) => t.empty ? [] : ve.forRange(n, "cm-selectionBackground", t)).reduce((t, e) => t.concat(e));
  },
  update(n, t) {
    return n.docChanged || n.selectionSet || n.viewportChanged || Xr(n);
  },
  class: "cm-selectionLayer"
}), Sh = /* @__PURE__ */ ns.highest(/* @__PURE__ */ O.theme({
  ".cm-line": {
...
})), Ur = /* @__PURE__ */ F.define({
  map(n, t) {
    return n == null ? null : t.mapPos(n);
  }
}), se = /* @__PURE__ */ Ot.define({
  create() {
    return null;
  },
  update(n, t) {
    return n != null && (n = t.changes.mapPos(n)), t.effects.reduce((e, i) => i.is(Ur) ? i.value : e, n);
  }
}), Ch = /* @__PURE__ */ tt.fromClass(class {
  constructor(n) {
  ...
  update(n) {
    ...
    e == null ? this.cursor != null && ((t = this.cursor) === null || t === void 0 || t.remove(), this.cursor = null) : (this.cursor || (this.cursor = this.view.scrollDOM.appendChild(document.createElement("div")), this.cursor.className = "cm-dropCursor"), (n.startState.field(se) != e || n.docChanged || n.geometryChanged) && this.view.requestMeasure(this.measureReq));
  }
  readPos() {
    let { view: n } = this, t = n.state.field(se), e = t != null && n.coordsAtPos(t);
    if (!e)
      return null;
  ...
  setDropPos(n) {
    this.view.state.field(se) != n && this.view.dispatch({ effects: Ur.of(n) });
  }
}, {
  eventObservers: {
    dragover(n) {
...
class Mh {
  ...
  */
  createDeco(t) {
    ...
    for (let { from: s, to: r } of kh(t, this.maxLength))
      dn(t.state.doc, this.regexp, s, r, (o, l) => this.addMatch(l, t, o, i));
    return e.finish();
  }
  /**
...
const Zi = /x/.unicode != null ? "gu" : "g", Ah = /* @__PURE__ */ new RegExp(`[\0-\b
--­؜​‎‏\u2028\u2029‭‮⁦⁧⁩\uFEFF￹-￼]`, Zi), Oh = {
  0: "null",
  7: "bell",
  8: "backspace",
...
function Dh() {
  var n;
  if (wi == null && typeof document < "u" && document.body) {
    let t = document.body.style;
    wi = ((n = t.tabSize) !== null && n !== void 0 ? n : t.MozTabSize) != null;
  }
  return wi || !1;
}
const Ge = /* @__PURE__ */ M.define({
  combine(n) {
    let t = rs(n, {
      render: null,
      specialChars: Ah,
    ...
    return (t.replaceTabs = !Dh()) && (t.specialChars = new RegExp("	|" + t.specialChars.source, Zi)), t.addSpecialChars && (t.specialChars = new RegExp(t.specialChars.source + "|" + t.addSpecialChars.source, Zi)), t;
  }
});
function Oa(n = {}) {
  return [Ge.of(n), Th()];
...
let pn = null;
function Th() {
  return pn || (pn = tt.fromClass(class {
    constructor(n) {
      this.view = n, this.decorations = K.none, this.decorationCache = /* @__PURE__ */ Object.create(null), this.decorator = this.makeDecorator(n.state.facet(Ge)), this.decorations = this.decorator.createDeco(n);
    }
    makeDecorator(n) {
      return new Mh({
        regexp: n.specialChars,
        decoration: (t, e, i) => {
          let { doc: s } = e.state, r = Bn(t[0], 0);
          if (r == 9) {
            let o = s.lineAt(i), l = e.state.tabSize, h = Gn(o.text, l, i - o.from);
            return K.replace({
              widget: new Lh((l - h % l) * this.view.defaultCharacterWidth / this.view.scaleX)
            });
          }
          return this.decorationCache[r] || (this.decorationCache[r] = K.replace({ widget: new Ph(n, r) }));
        },
    ...
    update(n) {
      ...
      n.startState.facet(Ge) != t ? (this.decorator = this.makeDecorator(t), this.decorations = this.decorator.createDeco(n.view)) : this.decorations = this.decorator.updateDeco(n, this.decorations);
    }
  }, {
...
const Eh = "•";
function Rh(n) {
  return n >= 32 ? Eh : n == 10 ? "␤" : String.fromCharCode(9216 + n);
}
class Ph extends we {
  constructor(t, e) {
  ...
  toDOM(t) {
    let e = Rh(this.code), i = t.state.phrase("Control character") + " " + (Oh[this.code] || "0x" + this.code.toString(16)), s = this.options.render && this.options.render(this.code, i, e);
    if (s)
      return s;
...
const Bh = /* @__PURE__ */ K.line({ class: "cm-activeLine" }), Nh = /* @__PURE__ */ tt.fromClass(class {
  constructor(n) {
  ...
  getDeco(n) {
    ...
    for (let i of n.state.selection.ranges) {
      ...
      s.from > t && (e.push(Bh.range(s.from)), t = s.from);
    }
    return K.set(e);
  }
}, {
...
function Hh(n, t, e) {
  ...
  if (t.off > ts || e.off > ts || t.col < 0 || e.col < 0) {
    let o = Math.min(t.off, e.off), l = Math.max(t.off, e.off);
    for (let h = i; h <= s; h++) {
      let a = n.doc.line(h);
      a.length <= l && r.push(x.range(a.from + o, a.to + l));
    }
  } else {
    let o = Math.min(t.col, e.col), l = Math.max(t.col, e.col);
    for (let h = i; h <= s; h++) {
      let a = n.doc.line(h), c = Pi(a.text, o, n.tabSize, !0);
      if (c < 0)
        r.push(x.cursor(a.to));
      else {
        let f = Pi(a.text, l, n.tabSize);
        r.push(x.range(a.from + c, a.from + f));
      }
    }
  }
  return r;
...
function gn(n, t) {
  let e = n.posAtCoords({ x: t.clientX, y: t.clientY }, !1), i = n.state.doc.lineAt(e), s = e - i.from, r = s > ts ? -1 : s == i.length ? Ih(n, t.clientX) : Gn(i.text, n.state.tabSize, e - i.from);
  return { line: i.number, col: r, off: s };
}
function Vh(n, t) {
  let e = gn(n, t), i = n.state.selection;
  return e ? {
    update(s) {
      if (s.docChanged) {
    ...
    get(s, r, o) {
      ...
      if (!l)
        return i;
      let h = Hh(n.state, e, l);
      return h.length ? o ? x.create(h.concat(i.ranges)) : x.create(h) : i;
    }
  } : null;
}
function Ta(n) {
  let t = (e) => e.altKey && e.button == 0;
  return O.mouseSelectionStyle.of((e, i) => t(i) ? Vh(e, i) : null);
}
const Fh = {
  Alt: [18, (n) => !!n.altKey],
  ...
  Meta: [91, (n) => !!n.metaKey]
}, Wh = { style: "cursor: crosshair" };
function Ea(n = {}) {
  let [t, e] = Fh[n.key || "Alt"], i = tt.fromClass(class {
    constructor(s) {
  ...
  return [
    ...
    O.contentAttributes.of((s) => {
      var r;
      return !((r = s.plugin(i)) === null || r === void 0) && r.isDown ? Wh : null;
    })
  ];
}
const Qt = "-10000px";
  ...
  update(t, e) {
    ...
    for (let h = 0; h < r.length; h++) {
      ...
      if (a) {
        ...
        if (c < 0)
          o[h] = this.createTooltipView(a, h ? o[h - 1] : null), l && (l[h] = !!a.above);
        else {
...
const bi = /* @__PURE__ */ M.define({
  combine: (n) => {
    ...
    return {
      ...
      tooltipSpace: ((i = n.find((s) => s.tooltipSpace)) === null || i === void 0 ? void 0 : i.tooltipSpace) || zh
    };
  }
}), mn = /* @__PURE__ */ new WeakMap(), ws = /* @__PURE__ */ tt.fromClass(class {
  constructor(n) {
    this.view = n, this.above = [], this.inView = !0, this.madeAbsolute = !1, this.lastTransaction = 0, this.measureTimeout = -1;
    let t = n.state.facet(bi);
    this.position = t.position, this.parent = t.parent, this.classes = n.themeClasses, this.createContainer(), this.measureReq = { read: this.readMeasure.bind(this), write: this.writeMeasure.bind(this), key: this }, this.resizeObserver = typeof ResizeObserver == "function" ? new ResizeObserver(() => this.measureSoon()) : null, this.manager = new _r(n, Jr, (e, i) => this.createTooltip(e, i), (e) => {
  ...
  update(n) {
    ...
    let e = t || n.geometryChanged, i = n.state.facet(bi);
  ...
  createTooltip(n, t) {
    ...
    return e.dom.style.position = this.position, e.dom.style.top = Qt, e.dom.style.left = "0px", this.container.insertBefore(e.dom, i), e.mount && e.mount(this.view), this.resizeObserver && this.resizeObserver.observe(e.dom), e;
  }
  destroy() {
    var n, t, e;
  ...
  readMeasure() {
    ...
    if (this.position == "fixed" && this.manager.tooltipViews.length) {
      ...
      else if (r.style.top == Qt && r.style.left == "0px") {
    ...
    let i = this.view.scrollDOM.getBoundingClientRect(), s = ds(this.view);
    return {
      visible: {
        left: i.left + s.left,
        top: i.top + s.top,
      ...
      space: this.view.state.facet(bi).tooltipSpace(this.view),
      scaleX: n,
      scaleY: t,
      makeAbsolute: e
    };
  ...
  writeMeasure(n) {
    ...
    for (let l = 0; l < this.manager.tooltips.length; l++) {
      ...
      if (!f || h.clip !== !1 && (f.bottom <= Math.max(e.top, i.top) || f.top >= Math.min(e.bottom, i.bottom) || f.right < Math.max(e.left, i.left) - 0.1 || f.left > Math.min(e.right, i.right) + 0.1)) {
        c.style.top = Qt;
        continue;
      }
      let d = h.arrow ? a.dom.querySelector(".cm-tooltip-arrow") : null, p = d ? 7 : 0, g = u.right - u.left, m = (t = mn.get(a)) !== null && t !== void 0 ? t : u.bottom - u.top, w = a.offset || qh, b = this.view.textDirection == W.LTR, S = u.width > i.right - i.left ? b ? i.left : i.right - u.width : b ? Math.max(i.left, Math.min(f.left - (d ? 14 : 0) + w.x, i.right - g)) : Math.min(Math.max(i.left, f.left - g + (d ? 14 : 0) - w.x), i.right - g), v = this.above[l];
      !h.strictSide && (v ? f.top - m - p - w.y < i.top : f.bottom + m + p + w.y > i.bottom) && v == i.bottom - f.bottom > f.top - i.top && (v = this.above[l] = !v);
      ...
      if (k < m && a.resize !== !1) {
        ...
        mn.set(a, m), c.style.height = (m = k) / r + "px";
      } else c.style.height && (c.style.height = "");
      let C = v ? f.top - m - p - w.y : f.bottom + p + w.y, B = S + g;
      if (a.overlap !== !0)
        for (let z of o)
          z.left < B && z.right > S && z.top < C + m && z.bottom > C && (C = v ? z.top - m - 2 - p : z.bottom + p + 2);
      if (this.position == "absolute" ? (c.style.top = (C - n.parent.top) / r + "px", wn(c, (S - n.parent.left) / s)) : (c.style.top = C / r + "px", wn(c, S / s)), d) {
        let z = f.left + (b ? w.x : -w.x) - (S + 14 - 7);
        d.style.left = z / s + "px";
      }
      a.overlap !== !0 && o.push({ left: S, top: C, right: B, bottom: C + m }), c.classList.toggle("cm-tooltip-above", v), c.classList.toggle("cm-tooltip-below", !v), a.positioned && a.positioned(n.space);
    }
  }
  maybeMeasure() {
...
}), qh = { x: 0, y: 0 }, Jr = /* @__PURE__ */ M.define({
  enables: [ws, $h]
...
class oi {
  ...
  constructor(t) {
    this.view = t, this.mounted = !1, this.dom = document.createElement("div"), this.dom.classList.add("cm-tooltip-hover"), this.manager = new _r(t, ii, (e, i) => this.createHostedView(e, i), (e) => e.dom.remove());
  }
...
const Kh = /* @__PURE__ */ Jr.compute([ii], (n) => {
  let t = n.facet(ii);
...
class jh {
  ...
  startHover() {
    ...
    if (i instanceof Ct)
      ...
      if (!l || e.y < l.top || e.y > l.bottom || e.x < l.left - t.defaultCharacterWidth || e.x > l.right + t.defaultCharacterWidth)
        return;
      let h = t.bidiSpans(t.state.doc.lineAt(s)).find((c) => c.from <= s && c.to >= s), a = h && h.dir == W.RTL ? -1 : 1;
      r = e.x < l.left ? -a : a;
    }
    ...
    if (o != null && o.then) {
      ...
      }, (h) => ut(t.state, h, "hover tooltip"));
    } else o && !(Array.isArray(o) && !o.length) && t.dispatch({ effects: this.setHover.of(Array.isArray(o) ? o : [o]) });
  }
  get tooltip() {
    let t = this.view.plugin(ws), e = t ? t.manager.tooltips.findIndex((i) => i.create == oi.create) : -1;
  ...
  mousemove(t) {
    ...
    if (s.length && r && !Yh(r.dom, t) || this.pending) {
      let { pos: o } = s[0] || this.pending, l = (i = (e = s[0]) === null || e === void 0 ? void 0 : e.end) !== null && i !== void 0 ? i : o;
      (o == l ? this.view.posAtCoords(this.lastMove) != o : !Gh(this.view, o, l, t.clientX, t.clientY)) && (this.view.dispatch({ effects: this.setHover.of([]) }), this.pending = null);
    }
  }
  mouseleave(t) {
...
function Yh(n, t) {
  ...
  return t.clientX >= e - Ie && t.clientX <= i + Ie && t.clientY >= s - Ie && t.clientY <= r + Ie;
}
function Gh(n, t, e, i, s, r) {
  ...
  let e = F.define(), i = Ot.define({
    ...
    update(s, r) {
      if (s.length && (t.hideOnChange && (r.docChanged || r.selection) ? s = [] : t.hideOn && (s = s.filter((o) => !t.hideOn(r, o))), r.docChanged)) {
        let o = [];
        for (let l of s) {
          let h = r.changes.mapPos(l.pos, -1, Z.TrackDel);
          if (h != null) {
            let a = Object.assign(/* @__PURE__ */ Object.create(null), l);
            a.pos = h, a.end != null && (a.end = r.changes.mapPos(a.end)), o.push(a);
          }
        }
        s = o;
      }
      for (let o of r.effects)
        o.is(e) && (s = o.value), o.is(Xh) && (s = []);
      return s;
    },
    provide: (s) => ii.from(s)
  });
...
const Xh = /* @__PURE__ */ F.define(), bn = /* @__PURE__ */ M.define({
  combine(n) {
    let t, e;
    for (let i of n)
...
function La(n, t) {
  let e = n.plugin(Qr), i = e ? e.specs.indexOf(t) : -1;
  return i > -1 ? e.panels[i] : null;
}
const Qr = /* @__PURE__ */ tt.fromClass(class {
  constructor(n) {
    this.input = n.state.facet(vn), this.specs = this.input.filter((e) => e), this.panels = this.specs.map((e) => e(n));
    let t = n.state.facet(bn);
    this.top = new Ve(n, !0, t.topContainer), this.bottom = new Ve(n, !1, t.bottomContainer), this.top.sync(this.panels.filter((e) => e.top)), this.bottom.sync(this.panels.filter((e) => !e.top));
    for (let e of this.panels)
      e.dom.classList.add("cm-panel"), e.mount && e.mount();
  }
  update(n) {
    let t = n.state.facet(bn);
    this.top.container != t.topContainer && (this.top.sync([]), this.top = new Ve(n.view, !0, t.topContainer)), this.bottom.container != t.bottomContainer && (this.bottom.sync([]), this.bottom = new Ve(n.view, !1, t.bottomContainer)), this.top.syncClasses(), this.bottom.syncClasses();
    let e = n.state.facet(vn);
    if (e != this.input) {
  ...
  provide: (n) => O.scrollMargins.of((t) => {
    let e = t.plugin(n);
...
At.prototype.mapMode = Z.TrackBefore;
At.prototype.startSide = At.prototype.endSide = -1;
At.prototype.point = !0;
const Xe = /* @__PURE__ */ M.define(), Uh = /* @__PURE__ */ M.define(), _h = {
  class: "",
  ...
  updateSpacer: null,
  domEventHandlers: {}
}, he = /* @__PURE__ */ M.define();
function Ba(n) {
  return [Zr(), he.of(Object.assign(Object.assign({}, _h), n))];
}
...
const Jh = /* @__PURE__ */ tt.fromClass(class {
  constructor(n) {
    this.view = n, this.prevViewport = n.viewport, this.dom = document.createElement("div"), this.dom.className = "cm-gutters", this.dom.setAttribute("aria-hidden", "true"), this.dom.style.minHeight = this.view.contentHeight / this.view.scaleY + "px", this.gutters = n.state.facet(he).map((t) => new Cn(n, t));
    for (let t of this.gutters)
      this.dom.appendChild(t.dom);
    this.fixed = !n.state.facet(xn), this.fixed && (this.dom.style.position = "sticky"), this.syncGutters(!1), n.scrollDOM.insertBefore(this.dom, n.contentDOM);
  }
  update(n) {
    ...
    n.geometryChanged && (this.dom.style.minHeight = this.view.contentHeight / this.view.scaleY + "px"), this.view.state.facet(xn) != !this.fixed && (this.fixed = !this.fixed, this.dom.style.position = this.fixed ? "sticky" : ""), this.prevViewport = n.view.viewport;
  }
  syncGutters(n) {
    let t = this.dom.nextSibling;
    n && this.dom.remove();
    let e = T.iter(this.view.state.facet(Xe), this.view.viewport.from), i = [], s = this.gutters.map((r) => new Qh(r, this.view.viewport, -this.view.documentPadding.top));
  ...
  updateGutters(n) {
    let t = n.startState.facet(he), e = n.state.facet(he), i = n.docChanged || n.heightChanged || n.viewportChanged || !T.eq(n.startState.facet(Xe), n.state.facet(Xe), n.view.viewport.from, n.view.viewport.to);
    if (t == e)
      ...
      for (let r of e) {
        let o = t.indexOf(r);
        o < 0 ? s.push(new Cn(this.view, r)) : (this.gutters[o].update(n), s.push(this.gutters[o]));
      }
  ...
  provide: (n) => O.scrollMargins.of((t) => {
    let e = t.plugin(n);
    return !e || e.gutters.length == 0 || !e.fixed ? null : t.textDirection == W.LTR ? { left: e.dom.offsetWidth * t.scaleX } : { right: e.dom.offsetWidth * t.scaleX };
  })
});
function Sn(n) {
...
class Qh {
  constructor(t, e, i) {
    this.gutter = t, this.height = i, this.i = 0, this.cursor = T.iter(t.markers, e.from);
  }
  addElement(t, e, i) {
    let { gutter: s } = this, r = (e.top - this.height) / t.scaleY, o = e.height / t.scaleY;
    if (this.i == s.elements.length) {
      let l = new to(t, o, r, i);
  ...
  line(t, e, i) {
    let s = [];
    es(this.cursor, s, e.from), i.length && (s = s.concat(i));
...
class Cn {
  constructor(t, e) {
    ...
    this.markers = Sn(e.markers(t)), e.initialSpacer && (this.spacer = new to(t, 0, 0, [e.initialSpacer(t)]), this.dom.appendChild(this.spacer.dom), this.spacer.dom.style.cssText += "visibility: hidden; pointer-events: none");
  }
  update(t) {
    let e = this.markers;
    if (this.markers = Sn(this.config.markers(t.view)), this.spacer && this.config.updateSpacer) {
    ...
    return !T.eq(this.markers, e, i.from, i.to) || (this.config.lineMarkerChange ? this.config.lineMarkerChange(t) : !1);
  }
  destroy() {
...
class to {
  ...
  update(t, e, i, s) {
    this.height != e && (this.height = e, this.dom.style.height = e + "px"), this.above != i && (this.dom.style.marginTop = (this.above = i) ? i + "px" : ""), Zh(this.markers, s) || this.setMarkers(t, s);
  }
  setMarkers(t, e) {
...
const ta = /* @__PURE__ */ M.define(), ea = /* @__PURE__ */ M.define(), It = /* @__PURE__ */ M.define({
  combine(n) {
    return rs(n, { formatNumber: String, domEventHandlers: {} }, {
...
function vi(n, t) {
  return n.state.facet(It).formatNumber(t, n.state);
}
const ia = /* @__PURE__ */ he.compute([It], (n) => ({
  class: "cm-lineNumbers",
  renderEmptyElements: !1,
  markers(t) {
    return t.state.facet(ta);
  },
  lineMarker(t, e, i) {
    return i.some((s) => s.toDOM) ? null : new yi(vi(t, t.state.doc.lineAt(e.from).number));
  },
  widgetMarker: (t, e, i) => {
    for (let s of t.state.facet(ea)) {
      let r = s(t, e, i);
      if (r)
        return r;
    }
  ...
  lineMarkerChange: (t) => t.startState.facet(It) != t.state.facet(It),
  initialSpacer(t) {
    return new yi(vi(t, kn(t.state.doc.lines)));
  },
  updateSpacer(t, e) {
    let i = vi(e.view, kn(e.view.state.doc.lines));
    return i == t.number ? t : new yi(i);
  },
  domEventHandlers: n.facet(It).domEventHandlers
}));
function Na(n = {}) {
  return [
    It.of(n),
...
const sa = /* @__PURE__ */ new class extends At {
  constructor() {
    super(...arguments), this.elementClass = "cm-activeLineGutter";
  }
}(), na = /* @__PURE__ */ Xe.compute(["selection"], (n) => {
  let t = [], e = -1;
  for (let i of n.selection.ranges) {
    let s = n.doc.lineAt(i.head).from;
    s > e && (e = s, t.push(sa.range(s)));
  }
  return T.of(t);
});
function Ha() {
...
var ra = Object.defineProperty, Mn = Object.getOwnPropertySymbols, oa = Object.prototype.hasOwnProperty, la = Object.prototype.propertyIsEnumerable, An = (n, t, e) => t in n ? ra(n, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : n[t] = e, ha = (n, t) => {
  for (var e in t || (t = {}))
    oa.call(t, e) && An(n, e, t[e]);
  if (Mn)
    for (var e of Mn(t))
      la.call(t, e) && An(n, e, t[e]);
  return n;
};
function eo(n, t) {
...
const aa = {
  ...
  renderLanguage: (n) => Fe`${n}`,
  renderPreview: () => null,
  previewToggleButton: (n) => n ? "Edit" : "Hide",
  previewLabel: () => "Preview"
}, bs = ho(aa, "codeBlockConfigCtx");
eo(bs, {
...
function ca(n, t) {
  ...
  e !== t && console.warn(`Custom element ${n} has been defined before.`);
}
var On = Object.getOwnPropertySymbols, fa = Object.prototype.hasOwnProperty, ua = Object.prototype.propertyIsEnumerable, da = (n, t) => {
  var e = {};
  for (var i in n)
    fa.call(n, i) && t.indexOf(i) < 0 && (e[i] = n[i]);
  if (n != null && On)
    for (var i of On(n))
      t.indexOf(i) < 0 && ua.call(n, i) && (e[i] = n[i]);
  return e;
};
class pa {
  constructor(t, e, i, s, r) {
    this.node = t, this.view = e, this.getPos = i, this.loader = s, this.config = r, this.updating = !1, this.languageName = "", this.forwardUpdate = (o) => {
      var l;
      if (this.updating || !this.cm.hasFocus) return;
      let h = ((l = this.getPos()) != null ? l : 0) + 1;
      const { main: a } = o.state.selection, c = h + a.from, f = h + a.to, u = this.view.state.selection;
      if (o.docChanged || u.from !== c || u.to !== f) {
        const d = this.view.state.tr;
        o.changes.iterChanges((p, g, m, w, b) => {
          b.length ? d.replaceWith(
            h + p,
            h + g,
            this.view.state.schema.text(b.toString())
          ) : d.delete(h + p, h + g), h += w - m - (g - p);
        }), d.setSelection(li.create(d.doc, c, f)), this.view.dispatch(d);
      }
      ...
      return [
        ...
        {
          key: "Mod-Enter",
          run: () => uo(o.state, o.dispatch) ? (o.focus(), !0) : !1
        },
        { key: "Mod-z", run: () => fo(o.state, o.dispatch) },
        { key: "Shift-Mod-z", run: () => ys(o.state, o.dispatch) },
        { key: "Mod-y", run: () => ys(o.state, o.dispatch) },
        {
          key: "Backspace",
          run: () => {
            var l;
            const h = this.cm.state.selection.ranges;
            if (h.length > 1) return !1;
            const a = h[0];
            if (a && (!a.empty || a.anchor > 0) || this.cm.state.doc.lines >= 2) return !1;
            const c = this.view.state, f = (l = this.getPos()) != null ? l : 0, u = c.tr.replaceWith(
              f,
              f + this.node.nodeSize,
              c.schema.nodes.paragraph.createChecked({}, this.node.content)
            );
            return u.setSelection(li.near(u.doc.resolve(f))), this.view.dispatch(u), this.view.focus(), !0;
          }
        }
      ];
    }, this.maybeEscape = (o, l) => {
      var h;
      const { state: a } = this.cm;
      let c = a.selection.main;
      if (!c.empty || (o === "line" && (c = a.doc.lineAt(c.head)), l < 0 ? c.from > 0 : c.to < a.doc.length)) return !1;
      const f = ((h = this.getPos()) != null ? h : 0) + (l < 0 ? 0 : this.node.nodeSize), u = li.near(
        this.view.state.doc.resolve(f),
        l
      ), d = this.view.state.tr.setSelection(u).scrollIntoView();
    ...
    }, this.getAllLanguages = () => this.loader.getAll(), this.languageConf = new $t(), this.readOnlyConf = new $t(), this.cm = new O({
      doc: this.node.textContent,
      root: this.view.root,
      extensions: [
        this.readOnlyConf.of(R.readOnly.of(!this.view.editable)),
        qr.of(this.codeMirrorKeymap()),
        this.languageConf.of([]),
        ...r.extensions,
        O.updateListener.of(this.forwardUpdate)
      ]
    }), this.dom = this.createDom(), this.updateLanguage();
  }
  createDom() {
    const t = document.createElement("milkdown-code-block");
    t.codemirror = this.cm, t.getAllLanguages = this.getAllLanguages, t.setLanguage = this.setLanguage, t.isEditorReadonly = () => !this.view.editable, t.text = this.node.textContent;
    const e = this.config, {
      languages: i,
      extensions: s
    } = e, r = da(e, [
  ...
  updateLanguage() {
    const t = this.node.attrs.language;
    if (t === this.languageName) return;
    this.dom.language = t, this.loader.load(t ?? "").then((i) => {
      i && (this.cm.dispatch({
        effects: this.languageConf.reconfigure(i)
      }), this.languageName = t);
    });
  }
  setSelection(t, e) {
    this.cm.dom.isConnected && (this.cm.focus(), this.updating = !0, this.cm.dispatch({ selection: { anchor: t, head: e } }), this.updating = !1);
  }
  update(t) {
    if (t.type !== this.node.type) return !1;
    if (this.updating) return !0;
    this.node = t, this.dom.text = t.textContent, this.updateLanguage(), this.view.editable === this.cm.state.readOnly && this.cm.dispatch({
      effects: this.readOnlyConf.reconfigure(
        R.readOnly.of(!this.view.editable)
      )
    });
    const e = ga(this.cm.state.doc.toString(), t.textContent);
    return e && (this.updating = !0, this.cm.dispatch({
      changes: { from: e.from, to: e.to, insert: e.text }
    }), this.updating = !1), !0;
  }
  selectNode() {
...
function ga(n, t) {
  ...
  for (; e < i && n.charCodeAt(e) === t.charCodeAt(e); )
    ++e;
  for (; i > e && s > e && n.charCodeAt(i - 1) === t.charCodeAt(s - 1); )
    i--, s--;
  return { from: e, to: i, text: t.slice(e, s) };
}
class ma {
  constructor(t) {
    this.languages = t, this.map = {}, t.forEach((e) => {
      e.alias.forEach((i) => {
        this.map[i] = e;
      });
    });
  ...
  getAll() {
    return this.languages.map((t) => ({
      name: t.name,
      alias: t.alias
    }));
  }
  load(t) {
    const i = this.map[t.toLowerCase()];
    return i ? i.support ? Promise.resolve(i.support) : i.load() : Promise.resolve(void 0);
  }
}
const io = ({
  selected: n = !1,
  ...
  var h, a, c, f, u;
  const d = go(), p = Se(), g = Se(), m = Se(), w = Se(), [b, S] = hi(""), [v, k] = hi(!1), [C, B] = hi(!1), z = ke(() => d.current.getRootNode(), [d]);
  Ce(() => {
    var A;
    const D = (A = e == null ? void 0 : e()) == null ? void 0 : A.find(
      (H) => H.alias.some(
        (I) => I.toLowerCase() === (s == null ? void 0 : s.toLowerCase())
      )
    );
    D && D.name !== s && (i == null || i(D.name));
  }, [s]), Ce(() => {
    k(!1);
  }, [s]), Ce(() => {
    const A = (D) => {
      const H = D.target;
      if (p.current && p.current.contains(H)) return;
      const I = g.current;
      I && I.dataset.expanded === "true" && (I.contains(H) || k(!1));
    };
    return z.addEventListener("click", A), () => {
      z.removeEventListener("click", A);
    };
  }, []), mo(() => {
    S("");
    const A = p.current, D = g.current;
    !A || !D || bo(A, D, {
  ...
  const et = ke(() => {
    var A;
    if (!v) return [];
    const D = (A = e == null ? void 0 : e()) != null ? A : [], H = D.find(
      (Ut) => Ut.name.toLowerCase() === (s == null ? void 0 : s.toLowerCase())
    ), I = D.filter((Ut) => (Ut.name.toLowerCase().includes(b.toLowerCase()) || Ut.alias.some(
      (no) => no.toLowerCase().includes(b.toLowerCase())
    )) && Ut !== H);
    return I.length === 0 ? [] : H ? [H, ...I] : I;
  }, [b, v, s]), Lt = (A) => {
    const D = A.target;
    S(D.value);
  }, xe = (A) => {
    A.preventDefault(), A.stopPropagation(), !(o != null && o()) && k((D) => (D || setTimeout(() => {
      var H;
    ...
    if (A.key === "Enter") {
      ...
      D instanceof HTMLElement && D.dataset.language && (i == null || i(D.dataset.language));
    }
  }, lt = ke(() => et != null && et.length ? et.map(
    (A) => {
      var D;
      return Fe`<li
          role="listitem"
          ...
          aria-selected=${A.name.toLowerCase() === (s == null ? void 0 : s.toLowerCase())}
          data-language=${A.name}
          onclick=${() => i == null ? void 0 : i(A.name)}
        >
          ${(D = r == null ? void 0 : r.renderLanguage) == null ? void 0 : D.call(
        r,
        A.name,
        A.name.toLowerCase() === (s == null ? void 0 : s.toLowerCase())
      )}
        </li>`;
    }
  ) : Fe`<li class="language-list-item no-result">
        ${r == null ? void 0 : r.noResultText}
      </li>`, [et]), U = ke(() => {
    var A;
    return (A = r == null ? void 0 : r.renderPreview) == null ? void 0 : A.call(r, s ?? "", l ?? "");
  }, [s, l]);
  return Ce(() => {
    if (w.current) {
      for (; w.current.firstChild; )
        w.current.removeChild(w.current.firstChild);
      typeof U == "string" ? w.current.innerHTML = U : U instanceof HTMLElement && w.current.appendChild(U);
    }
  }, [U]), Fe`<host class=${vt(n && "selected")}>
    <div class="tools">
      <button
        type="button"
        ref=${p}
      ...
      >
        ${s || "Text"}
        <div class="expand-icon">${(h = r == null ? void 0 : r.expandIcon) == null ? void 0 : h.call(r)}</div>
      </button>
      <div
        ref=${g}
        data-expanded=${v}
        class=${vt("language-picker", v && "show")}
      >
        <div class="list-wrapper">
          <div class="search-box">
            <div class="search-icon">${(a = r == null ? void 0 : r.searchIcon) == null ? void 0 : a.call(r)}</div>
            <input
              ref=${m}
              class="search-input"
            ...
            />
            <div
              class=${vt("clear-icon", b.length === 0 && "hidden")}
              onmousedown=${Bt}
            >
              ${(c = r == null ? void 0 : r.clearSearchIcon) == null ? void 0 : c.call(r)}
            </div>
          </div>
          <ul class="language-list" role="listbox" onkeydown=${pt}>
            ${lt}
          </ul>
        </div>
      </div>
      <button
        class=${vt("preview-toggle-button", !U && "hidden")}
        onclick=${() => B(!C)}
      >
        ${(f = r == null ? void 0 : r.previewToggleButton) == null ? void 0 : f.call(r, C)}
      </button>
    </div>
    <div
      class=${vt("codemirror-host", U && C && "hidden")}
    >
      ${wo(t == null ? void 0 : t.dom, {})}
    </div>
    <div class=${vt("preview-panel", !U && "hidden")}>
      <div class=${vt("preview-divider", C && "hidden")}></div>
      <div class=${vt("preview-label", C && "hidden")}>
        ${(u = r == null ? void 0 : r.previewLabel) == null ? void 0 : u.call(r)}
      </div>
      <div ref=${w} class="preview"></div>
    </div>
  </host>`;
};
io.props = {
...
const wa = po(io);
ca("milkdown-code-block", wa);
const so = ao(
  co.node,
  (n) => {
    const t = n.get(bs.key), e = new ma(t.languages);
    return (i, s, r) => new pa(i, s, r, e, t);
  }
);
eo(so, {
