import { a as h, b, p as v, h as y, c as k, i as u, f as T, j as _, t } from "./index-B3KiKTSt-Dla4yOC_.js";
import { html as W } from "./index-BXEC2rDE.js";
import { L as R, E as P } from "./index-Crfuao6v.js";
import { E as Y, i as w } from "./index.es-Dganzb1x.js";
const j = 1, U = 2, X = 3, G = 180, S = 4, z = 181, x = 5, Z = 182, E = 6;
function V(O) {
  return O >= 65 && O <= 90 || O >= 97 && O <= 122;
}
const D = /* @__PURE__ */ new P((O) => {
  let a = O.pos;
  for (; ; ) {
    let { next: e } = O;
    if (e < 0)
...
const F = /* @__PURE__ */ f("endcomment", Z, x), C = /* @__PURE__ */ f("endraw", z, S), N = /* @__PURE__ */ new P((O) => {
  ...
  tokenizers: [D, C, F, N, 0, 1, 2, 3],
  topRules: { Template: [0, 7] },
  specialized: [{ term: 187, get: (O) => I[O] || -1 }, { term: 37, get: (O) => L[O] || -1 }],
  tokenPrec: 0
});
function s(O, a) {
  return O.split(" ").map((e) => ({ label: e, type: a }));
}
const q = /* @__PURE__ */ s("abs append at_least at_most capitalize ceil compact concat date default divided_by downcase escape escape_once first floor join last lstrip map minus modulo newline_to_br plus prepend remove remove_first replace replace_first reverse round rstrip size slice sort sort_natural split strip strip_html strip_newlines sum times truncate truncatewords uniq upcase url_decode url_encode where", "function"), p = /* @__PURE__ */ s("cycle comment endcomment raw endraw echo increment decrement liquid if elsif else endif unless endunless case endcase for endfor tablerow endtablerow break continue assign capture endcapture render include", "keyword"), d = /* @__PURE__ */ s("empty forloop tablerowloop in with as contains", "keyword"), B = /* @__PURE__ */ s("first index index0 last length rindex", "property"), H = /* @__PURE__ */ s("col col0 col_first col_last first index index0 last length rindex rindex0 row", "property");
function M(O) {
  var a;
  let { state: e, pos: r } = O, $ = y(e).resolveInner(r, -1).enterUnfinishedNodesBefore(r), i = ((a = $.childBefore(r)) === null || a === void 0 ? void 0 : a.name) || $.name;
  if ($.name == "FilterName")
...
function J(O = {}) {
  let a = O.filters ? O.filters.concat(q) : q, e = O.tags ? O.tags.concat(p) : p, r = O.variables ? O.variables.concat(d) : d, { properties: $ } = O;
  return (i) => {
    var n;
    let Q = M(i);
    if (!Q)
      return null;
    let o = (n = Q.from) !== null && n !== void 0 ? n : Q.node ? Q.node.from : i.pos, l;
    return Q.type == "filter" ? l = a : Q.type == "tag" ? l = e : Q.type == "expression" ? l = r : l = K(i.state, Q.target, i, $), l.length ? { options: l, from: o, validFor: /^[\w\u00c0-\uffff]*$/ } : null;
  };
}
const OO = /* @__PURE__ */ Y.inputHandler.of((O, a, e, r) => r != "%" || a != e || O.state.doc.sliceString(a - 1, e + 1) != "{}" ? !1 : (O.dispatch(O.state.changeByRange(($) => ({
  changes: { from: $.from, to: $.to, insert: "%%" },
  range: w.cursor($.from + 1)
})), {
  scrollIntoView: !0,
...
function g(O) {
  return $O.configure({
    wrap: v((a) => a.type.isTop ? {
      parser: O.parser,
      overlay: (e) => e.name == "Text" || e.name == "RawText"
    } : null)
  }, "liquid");
}
const aO = /* @__PURE__ */ g(m.language);
function nO(O = {}) {
  let a = O.base || m, e = a.language == m.language ? aO : g(a.language);
  return new h(e, [
    a.support,
