...
async function OT(t, e, n) {
  switch (t) {
    case "code-mirror": {
      const { defineFeature: r } = await import("./index-B3KiKTSt-CYq2_6is.js").then((i) => i.E);
      return r(e, n);
    }
    case "list-item": {
      const { defineFeature: r } = await import("./index-Cuk7cL-r-Dk9S2Q0O.js");
      return r(e, n);
    }
    case "link-tooltip": {
      const { defineFeature: r } = await import("./index-DcRgwPLd-BSRiT_sQ.js");
      return r(e, n);
    }
    case "image-block": {
      const { defineFeature: r } = await import("./index-BFsG6770-CniGins1.js");
      return r(e, n);
    }
    case "cursor": {
      const { defineFeature: r } = await import("./index-CxJ9fxJm-By3TWkcW.js");
      return r(e, n);
    }
    case "block-edit": {
      const { defineFeature: r } = await import("./index-uHWmZXqe-mop04kPK.js");
      return r(e, n);
    }
    case "placeholder": {
      const { defineFeature: r } = await import("./index-DOrkOhki-CZkiYyj1.js");
      return r(e, n);
    }
    case "toolbar": {
      const { defineFeature: r } = await import("./index-CsEtSFhk-5P6K11Nu.js");
      return r(e, n);
    }
    case "table": {
      const { defineFeature: r } = await import("./index-CBrOT1fW-LQbPxo7A.js");
      return r(e, n);
    }
    case "latex": {
      const { defineFeature: r } = await import("./index-s33c_M2f-Bc3Gy2ZJ.js");
      return r(e, n);
    }
  }
}
...
class bg extends HTMLElement {
    ...
    if (n === "markdown" && r !== i) {
      ...
      if (this.editorContainer)
        try {
          ...
          this.editor.destroy(), this.editor = null, s && this.editorContainer && s.removeChild(this.editorContainer), this.editorContainer = document.createElement("div"), this.editorContainer.className = "docs-pilot-editor", (o = this.shadowRoot) == null || o.appendChild(this.editorContainer);
          const l = this.sanitizeMarkdown(i);
          this.editor = new ua({
            ...
            console.error("Errore nella ricostruzione dell'editor:", a), this.isInitializing = !1;
          });
        } catch (s) {
  ...
  // Sanitizza il markdown per evitare problemi di parsing con Milkdown
  sanitizeMarkdown(n) {
    if (!n) return n;
    let r = n.replace(/^\s*<br\s*\/?>\s*$/gm, "");
    return r = r.replace(/^(\s*[-*+]\s+.*?)<br\s*\/?>$/gm, "$1"), r = r.replace(/<br\s*\/?>/g, `  
`), r;
  }
  ...
  async initEditor() {
    if (this.editorContainer)
      try {
        ...
        const n = this.sanitizeMarkdown(this.markdown);
        console.log(
          "Inizializzazione editor con markdown:",
          n && n.substring(0, 20) + "..." || "vuoto"
        ), this.editor = new ua({
          root: this.editorContainer,
          defaultValue: n
