...
async function OT(t, e, n) {
  switch (t) {
    case "code-mirror": {
      const { defineFeature: r } = await import("./index-B3KiKTSt-DyCDxK2T.js").then((i) => i.E);
      return r(e, n);
    }
    case "list-item": {
      const { defineFeature: r } = await import("./index-Cuk7cL-r-Da4axNLz.js");
      return r(e, n);
    }
    case "link-tooltip": {
      const { defineFeature: r } = await import("./index-DcRgwPLd-Cp1f2oXj.js");
      return r(e, n);
    }
    case "image-block": {
      const { defineFeature: r } = await import("./index-BFsG6770-CjyW0xe5.js");
      return r(e, n);
    }
    case "cursor": {
      const { defineFeature: r } = await import("./index-CxJ9fxJm-BOl8Hvjm.js");
      return r(e, n);
    }
    case "block-edit": {
      const { defineFeature: r } = await import("./index-uHWmZXqe-CtznoYh6.js");
      return r(e, n);
    }
    case "placeholder": {
      const { defineFeature: r } = await import("./index-DOrkOhki-C1dRxOSv.js");
      return r(e, n);
    }
    case "toolbar": {
      const { defineFeature: r } = await import("./index-CsEtSFhk-7YYuzbq8.js");
      return r(e, n);
    }
    case "table": {
      const { defineFeature: r } = await import("./index-CBrOT1fW-DdWZ8yIJ.js");
      return r(e, n);
    }
    case "latex": {
      const { defineFeature: r } = await import("./index-s33c_M2f-BYxepDz0.js");
      return r(e, n);
    }
  }
}
    ...
    this.editor && this.editor.on((n) => {
      n.markdownUpdated(() => {
        if (this.editor && typeof this.editor.getMarkdown == "function") {
          ...
          this.lastKnownEditorMarkdown = r;
          const i = new CustomEvent("markdownChange", {
            detail: { markdown: r },
            bubbles: !0,
            composed: !0
          });
