import { L as G, E as R, C as u } from "./index-BVBa9No8.js";
import { s as w, t as $, L as v, a as V, f as g, i as U, j as b, c as q } from "./integration-or-DeK2G.js";
import { defineCSSCompletionSource as E } from "./index-Cdy3rPM_.js";
const j = 154, X = 155, C = 156, N = 1, D = 2, f = 3, I = 157, F = 158, Z = 4, K = 5, L = 159, p = 160, W = 161, s = 162, T = 6, h = 7, A = 8, B = 9, c = 0, i = [
  9,
  10,
  11,
  12,
  ...
  8287,
  12288
], M = 58, J = 40, P = 95, H = 91, l = 45, OO = 46, m = 35, $O = 37, z = 123, eO = 125, o = 47, S = 42, r = 10, _ = 61, aO = 43, QO = 38;
function d(O) {
...
const tO = new R((O, e) => {
  ...
  if (O.peek(-1) == r) {
    ...
    for (; O.next != r && i.includes(O.next); )
      O.advance(), t++;
    t != a && O.next != r && !k(O) && (t < a ? O.acceptToken(X, -t) : O.acceptToken(j));
  }
}), RO = new R((O, e) => {
  ...
  if (O.next == eO) {
    for (O.advance(); d(O.next) || O.next == l || O.next == P || x(O.next); )
      O.advance();
    O.next == m && O.peek(1) == z ? O.acceptToken(D, 2) : O.acceptToken(N);
  }
}), oO = new R((O) => {
...
const SO = new Y(null, 0), cO = new u({
  start: SO,
  shift(O, e, a, Q) {
    return e == j ? new Y(O, a.pos - Q.pos) : e == X ? O.parent : O;
  },
  hash(O) {
    return O.hash;
  }
