import { L as n, a, S as s } from "./index-B3KiKTSt-B8kPUIPo.js";
function t(e) {
  return new a(s.define(e));
}
function o(e) {
  return import("./index-SZmZzzx8.js").then((r) => r.sql({ dialect: r[e] }));
}
const m = [
  ...
  /* @__PURE__ */ n.of({
    ...
    extensions: ["c", "h", "ino"],
    load() {
      return import("./index-M9PqoD68.js").then((e) => e.cpp());
    }
  }),
  /* @__PURE__ */ n.of({
    name: "C++",
  ...
  /* @__PURE__ */ n.of({
    ...
    extensions: ["css"],
    load() {
      return import("./index-Bxxhd7p3.js").then((e) => e.css());
    }
  }),
  /* @__PURE__ */ n.of({
    name: "Go",
    extensions: ["go"],
    load() {
      return import("./index-BTzEbdrP.js").then((e) => e.go());
    }
  }),
  /* @__PURE__ */ n.of({
    name: "HTML",
    ...
    load() {
      return import("./index-BnAgapeZ.js").then((e) => e.html());
    }
  }),
  /* @__PURE__ */ n.of({
    name: "Java",
    extensions: ["java"],
    load() {
      return import("./index-DfpawJ04.js").then((e) => e.java());
    }
  }),
  /* @__PURE__ */ n.of({
    name: "JavaScript",
    ...
    load() {
      return import("./index-Dhm1JJGi.js").then((e) => e.javascript());
    }
  }),
  /* @__PURE__ */ n.of({
    name: "JSON",
    ...
    extensions: ["json", "map"],
    load() {
      return import("./index-BfyQ55gn.js").then((e) => e.json());
    }
  }),
  /* @__PURE__ */ n.of({
    name: "JSX",
    extensions: ["jsx"],
    load() {
      return import("./index-Dhm1JJGi.js").then((e) => e.javascript({ jsx: !0 }));
    }
  }),
  /* @__PURE__ */ n.of({
    name: "LESS",
    extensions: ["less"],
    load() {
      return import("./index-PveTBfyX.js").then((e) => e.less());
    }
  }),
  /* @__PURE__ */ n.of({
    name: "Liquid",
    extensions: ["liquid"],
    load() {
      return import("./index-CkGdr5nj.js").then((e) => e.liquid());
    }
  }),
  /* @__PURE__ */ n.of({
    name: "MariaDB SQL",
  ...
  /* @__PURE__ */ n.of({
    ...
    load() {
      return import("./index-D4f9LuTm.js").then((e) => e.markdown());
    }
  }),
  /* @__PURE__ */ n.of({
    name: "MS SQL",
  ...
  /* @__PURE__ */ n.of({
    ...
    load() {
      return import("./index-C7FTs5_-.js").then((e) => e.php());
    }
  }),
  /* @__PURE__ */ n.of({
    name: "PLSQL",
  ...
  /* @__PURE__ */ n.of({
    ...
    filename: /^(BUCK|BUILD)$/,
    load() {
      return import("./index-CiBl4cSR.js").then((e) => e.python());
    }
  }),
  /* @__PURE__ */ n.of({
    name: "Rust",
    extensions: ["rs"],
    load() {
      return import("./index-BRINrtbk.js").then((e) => e.rust());
    }
  }),
  /* @__PURE__ */ n.of({
    name: "Sass",
    extensions: ["sass"],
    load() {
      return import("./index-BR6KCebn.js").then((e) => e.sass({ indented: !0 }));
    }
  }),
  /* @__PURE__ */ n.of({
    name: "SCSS",
    extensions: ["scss"],
    load() {
      return import("./index-BR6KCebn.js").then((e) => e.sass());
    }
  }),
  /* @__PURE__ */ n.of({
    name: "SQL",
  ...
  /* @__PURE__ */ n.of({
    ...
    extensions: ["tsx"],
    load() {
      return import("./index-Dhm1JJGi.js").then((e) => e.javascript({ jsx: !0, typescript: !0 }));
    }
  }),
  /* @__PURE__ */ n.of({
    name: "TypeScript",
    ...
    load() {
      return import("./index-Dhm1JJGi.js").then((e) => e.javascript({ typescript: !0 }));
    }
  }),
  /* @__PURE__ */ n.of({
    name: "WebAssembly",
    extensions: ["wat", "wast"],
    load() {
      return import("./index-C9XttQNr.js").then((e) => e.wast());
    }
  }),
  /* @__PURE__ */ n.of({
    name: "XML",
    ...
    load() {
      return import("./index-Cth5QsV6.js").then((e) => e.xml());
    }
  }),
  /* @__PURE__ */ n.of({
    name: "YAML",
    ...
    extensions: ["yaml", "yml"],
    load() {
      return import("./index-BDF_161L.js").then((e) => e.yaml());
    }
  }),
  ...
  /* @__PURE__ */ n.of({
    ...
    extensions: ["vue"],
    load() {
      return import("./index-DSqsCbUx.js").then((e) => e.vue());
    }
  }),
  /* @__PURE__ */ n.of({
    name: "Angular Template",
    load() {
      return import("./index-YuWtOSRI.js").then((e) => e.angular());
    }
  })
];
export {
