...
async function OT(t, e, n) {
  switch (t) {
    case "code-mirror": {
      const { defineFeature: r } = await import("./index-B3KiKTSt-DanlTtJN.js").then((i) => i.E);
      return r(e, n);
    }
    case "list-item": {
      const { defineFeature: r } = await import("./index-Cuk7cL-r-BINzJuko.js");
      return r(e, n);
    }
    case "link-tooltip": {
      const { defineFeature: r } = await import("./index-DcRgwPLd-Cj8B1fQH.js");
      return r(e, n);
    }
    case "image-block": {
      const { defineFeature: r } = await import("./index-BFsG6770-DfBLtRoQ.js");
      return r(e, n);
    }
    case "cursor": {
      const { defineFeature: r } = await import("./index-CxJ9fxJm-Lx0lAx3c.js");
      return r(e, n);
    }
    case "block-edit": {
      const { defineFeature: r } = await import("./index-uHWmZXqe-CZ1O4pBC.js");
      return r(e, n);
    }
    case "placeholder": {
      const { defineFeature: r } = await import("./index-DOrkOhki-8oh1GExA.js");
      return r(e, n);
    }
    case "toolbar": {
      const { defineFeature: r } = await import("./index-CsEtSFhk-Cc6QyP_S.js");
      return r(e, n);
    }
    case "table": {
      const { defineFeature: r } = await import("./index-CBrOT1fW-CuO4lUxw.js");
      return r(e, n);
    }
    case "latex": {
      const { defineFeature: r } = await import("./index-s33c_M2f-BHJajLNm.js");
      return r(e, n);
    }
  }
}
  ...
  setupEditorListeners() {
    this.editor && this.editor.on((n) => {
      n.markdownUpdated((r) => {
        ...
        this.lastKnownEditorMarkdown = i, this.getAttribute("markdown") !== i && (this.isInternalUpdate = !0, this.setAttribute("markdown", i), this.isInternalUpdate = !1);
