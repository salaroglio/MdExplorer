import { L as n, a, S as s } from "./index-B3KiKTSt-DanlTtJN.js";
function t(e) {
  return new a(s.define(e));
}
function o(e) {
  return import("./index-vKwOYtdA.js").then((r) => r.sql({ dialect: r[e] }));
}
const m = [
  ...
  /* @__PURE__ */ n.of({
    ...
    extensions: ["c", "h", "ino"],
    load() {
      return import("./index-jOE6b2QN.js").then((e) => e.cpp());
    }
  }),
  /* @__PURE__ */ n.of({
    name: "C++",
  ...
  /* @__PURE__ */ n.of({
    ...
    extensions: ["css"],
    load() {
      return import("./index-CksgRCDu.js").then((e) => e.css());
    }
  }),
  /* @__PURE__ */ n.of({
    name: "Go",
    extensions: ["go"],
    load() {
      return import("./index-BuA2WEtt.js").then((e) => e.go());
    }
  }),
  /* @__PURE__ */ n.of({
    name: "HTML",
    ...
    load() {
      return import("./index-B0uVq8qI.js").then((e) => e.html());
    }
  }),
  /* @__PURE__ */ n.of({
    name: "Java",
    extensions: ["java"],
    load() {
      return import("./index-BMzPDVmC.js").then((e) => e.java());
    }
  }),
  /* @__PURE__ */ n.of({
    name: "JavaScript",
    ...
    load() {
      return import("./index-NRHHqdBe.js").then((e) => e.javascript());
    }
  }),
  /* @__PURE__ */ n.of({
    name: "JSON",
    ...
    extensions: ["json", "map"],
    load() {
      return import("./index-pQhOpUJE.js").then((e) => e.json());
    }
  }),
  /* @__PURE__ */ n.of({
    name: "JSX",
    extensions: ["jsx"],
    load() {
      return import("./index-NRHHqdBe.js").then((e) => e.javascript({ jsx: !0 }));
    }
  }),
  /* @__PURE__ */ n.of({
    name: "LESS",
    extensions: ["less"],
    load() {
      return import("./index-DcyRVqt1.js").then((e) => e.less());
    }
  }),
  /* @__PURE__ */ n.of({
    name: "Liquid",
    extensions: ["liquid"],
    load() {
      return import("./index-C-kyQfBM.js").then((e) => e.liquid());
    }
  }),
  /* @__PURE__ */ n.of({
    name: "MariaDB SQL",
  ...
  /* @__PURE__ */ n.of({
    ...
    load() {
      return import("./index-BroN2Yxa.js").then((e) => e.markdown());
    }
  }),
  /* @__PURE__ */ n.of({
    name: "MS SQL",
  ...
  /* @__PURE__ */ n.of({
    ...
    load() {
      return import("./index-BgYx3cPV.js").then((e) => e.php());
    }
  }),
  /* @__PURE__ */ n.of({
    name: "PLSQL",
  ...
  /* @__PURE__ */ n.of({
    ...
    filename: /^(BUCK|BUILD)$/,
    load() {
      return import("./index-I3BUsBFH.js").then((e) => e.python());
    }
  }),
  /* @__PURE__ */ n.of({
    name: "Rust",
    extensions: ["rs"],
    load() {
      return import("./index-BW7iYwrG.js").then((e) => e.rust());
    }
  }),
  /* @__PURE__ */ n.of({
    name: "Sass",
    extensions: ["sass"],
    load() {
      return import("./index-sdsPy5IN.js").then((e) => e.sass({ indented: !0 }));
    }
  }),
  /* @__PURE__ */ n.of({
    name: "SCSS",
    extensions: ["scss"],
    load() {
      return import("./index-sdsPy5IN.js").then((e) => e.sass());
    }
  }),
  /* @__PURE__ */ n.of({
    name: "SQL",
  ...
  /* @__PURE__ */ n.of({
    ...
    extensions: ["tsx"],
    load() {
      return import("./index-NRHHqdBe.js").then((e) => e.javascript({ jsx: !0, typescript: !0 }));
    }
  }),
  /* @__PURE__ */ n.of({
    name: "TypeScript",
    ...
    load() {
      return import("./index-NRHHqdBe.js").then((e) => e.javascript({ typescript: !0 }));
    }
  }),
  /* @__PURE__ */ n.of({
    name: "WebAssembly",
    extensions: ["wat", "wast"],
    load() {
      return import("./index-j96G6cN5.js").then((e) => e.wast());
    }
  }),
  /* @__PURE__ */ n.of({
    name: "XML",
    ...
    load() {
      return import("./index-CxKLg9LG.js").then((e) => e.xml());
    }
  }),
  /* @__PURE__ */ n.of({
    name: "YAML",
    ...
    extensions: ["yaml", "yml"],
    load() {
      return import("./index-DYpwLwac.js").then((e) => e.yaml());
    }
  }),
  ...
  /* @__PURE__ */ n.of({
    ...
    extensions: ["vue"],
    load() {
      return import("./index-CeSsECzb.js").then((e) => e.vue());
    }
  }),
  /* @__PURE__ */ n.of({
    name: "Angular Template",
    load() {
      return import("./index-C-bKWDEH.js").then((e) => e.angular());
    }
  })
];
export {
