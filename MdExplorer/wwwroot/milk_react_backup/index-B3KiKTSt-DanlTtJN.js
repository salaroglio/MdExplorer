...
`, bf = (n, e = {}) => {
  n.config(async (t) => {
    ...
    if (!i) {
      const { languages: s } = await import("./index-1xDavme3.js");
      i = s;
    }
    if (!r) {
      const { oneDark: s } = await import("./index-C-HvbaR7.js");
      r = s;
    }
    t.update(Zs.key, (s) => {
      var o;
