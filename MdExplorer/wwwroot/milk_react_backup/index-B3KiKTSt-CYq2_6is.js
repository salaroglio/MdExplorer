...
`, bf = (n, e = {}) => {
  n.config(async (t) => {
    ...
    if (!i) {
      const { languages: s } = await import("./index-y-Z43nXI.js");
      i = s;
    }
    if (!r) {
      const { oneDark: s } = await import("./index-DIW82bWm.js");
      r = s;
    }
    t.update(Zs.key, (s) => {
      var o;
