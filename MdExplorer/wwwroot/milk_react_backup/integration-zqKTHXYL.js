...
var Cn = (t, e, n) => Og(t, typeof e != "symbol" ? e + "" : e, n);
...
class Jg {
  /// @internal
  constructor(e, n) {
    ue(this, tr), ue(this, Tn), ue(this, jr), ue(this, Gt), ue(this, qr), ue(this, uo), Q(this, tr, null), Q(this, Tn, null), Q(this, Gt, "pending"), this.start = () => (P(this, tr) ?? Q(this, tr, new Promise((r, i) => {
      Q(this, Tn, (o) => {
      ...
      }), Q(this, Gt, "pending"), addEventListener(this.type.name, P(this, Tn));
    })), P(this, tr)), this.done = () => {
    ...
    for (; ++U <= V; ) {
      ...
      if (!ne && je[0] === "enter" && je[1].type === "listItemPrefix" || ne === -1 && je[0] === "exit" && (je[1].type === "listUnordered" || je[1].type === "listOrdered")) {
        ...
        if (je[1].type === "listItemPrefix") {
          ...
          xn = Qn, M.splice(U, 0, ["enter", Qn, je[2]]), U++, V++, Pr = void 0, zr = !0;
        }
      }
    }
...
var Tp = (t) => {
  throw TypeError(t);
}, Ip = (t, e, n) => e.has(t) || Tp("Cannot " + n), L = (t, e, n) => (Ip(t, e, "read from private field"), n ? n.call(t) : e.get(t)), be = (t, e, n) => e.has(t) ? Tp("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, n), ae = (t, e, n, r) => (Ip(t, e, "write to private field"), e.set(t, n), n), or, An, sr, Xe, Qt, ni, To, Io, qe, Xt, lr, Ao, ar, ri, Eo, En, ii;
function kn(t, e) {
  return t.meta = {
...
const wC = class _p {
  constructor() {
    be(this, sr), be(this, Xe), be(this, Qt), be(this, ni), be(this, To), be(this, Io), be(this, qe), be(this, Xt), be(this, lr), be(this, Ao), be(this, ar), be(this, ri), be(this, Eo), be(this, En), be(this, ii), ae(this, sr, !1), ae(this, Xe, "Idle"), ae(this, Qt, []), ae(this, ni, () => {
    ...
    }) : (e && ae(this, Qt, []), L(this, En).call(this, "OnDestroy"), await L(this, ri).call(this, [...L(this, qe).keys()], e), await L(this, Eo).call(this), L(this, En).call(this, "Destroyed"), this), this.action = (e) => e(L(this, lr)), this.inspect = () => L(this, sr) ? [...L(this, Xt).values(), ...L(this, qe).values()].map(({ ctx: e }) => {
      var n;
...
const en = j("WrapInHeading", (t) => (e) => (e ?? (e = 1), e < 1 ? xi(bn.type(t)) : xi(Yn.type(t), { level: e })));
S(en, {
...
function mT(t, e, n, r) {
  ...
  if (n.steps.length == 0)
    return t;
  if (s && s.getMeta(Vn))
    return s.getMeta(Vn).redo ? new tn(t.done.addTransform(n, void 0, r, Bo(e)), t.undone, lf(n.mapping.maps), t.prevTime, t.prevComposition) : new tn(t.done, t.undone.addTransform(n, void 0, r, Bo(e)), null, t.prevTime, t.prevComposition);
...
async function OT(t, e, n) {
  switch (t) {
    case "code-mirror": {
      const { defineFeature: r } = await import("./index-B3KiKTSt-B8kPUIPo.js").then((i) => i.E);
      return r(e, n);
    }
    case "list-item": {
      const { defineFeature: r } = await import("./index-Cuk7cL-r-CGgxOdiZ.js");
      return r(e, n);
    }
    case "link-tooltip": {
      const { defineFeature: r } = await import("./index-DcRgwPLd-Wm1OrS1O.js");
      return r(e, n);
    }
    case "image-block": {
      const { defineFeature: r } = await import("./index-BFsG6770-U7L21Emq.js");
      return r(e, n);
    }
    case "cursor": {
      const { defineFeature: r } = await import("./index-CxJ9fxJm-BYjvt6zP.js");
      return r(e, n);
    }
    case "block-edit": {
      const { defineFeature: r } = await import("./index-uHWmZXqe-DDpqekkU.js");
      return r(e, n);
    }
    case "placeholder": {
      const { defineFeature: r } = await import("./index-DOrkOhki-DeUPN9r4.js");
      return r(e, n);
    }
    case "toolbar": {
      const { defineFeature: r } = await import("./index-CsEtSFhk-84DCfoNF.js");
      return r(e, n);
    }
    case "table": {
      const { defineFeature: r } = await import("./index-CBrOT1fW-Ct0b9uUy.js");
      return r(e, n);
    }
    case "latex": {
      const { defineFeature: r } = await import("./index-s33c_M2f-BEYDMXZP.js");
      return r(e, n);
    }
  }
}
...
class bg extends HTMLElement {
  constructor() {
    super(...arguments);
    Cn(this, "editor", null);
    Cn(this, "editorContainer", null);
    Cn(this, "shadowRoot", null);
    Cn(this, "defaultMarkdown", "<calc>");
  ...
  attributeChangedCallback(n, r, i) {
    var o;
    if (n === "markdown" && r !== i) {
      if (this.isInternalUpdate || this.isInitializing || typeof i != "string" || !this.editor)
        return;
  ...
  setupEditorListeners() {
    this.editor && this.editor.on((n) => {
      n.markdownUpdated((r) => {
        ...
        this.getAttribute("markdown") !== i && (this.isInternalUpdate = !0, this.setAttribute("markdown", i), this.isInternalUpdate = !1);
