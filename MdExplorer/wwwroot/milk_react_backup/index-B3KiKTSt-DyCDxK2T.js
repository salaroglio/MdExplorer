...
`, bf = (n, e = {}) => {
  n.config(async (t) => {
    ...
    if (!i) {
      const { languages: s } = await import("./index-Ck_7LE19.js");
      i = s;
    }
    if (!r) {
      const { oneDark: s } = await import("./index-DgVv93QH.js");
      r = s;
    }
    t.update(Zs.key, (s) => {
      var o;
