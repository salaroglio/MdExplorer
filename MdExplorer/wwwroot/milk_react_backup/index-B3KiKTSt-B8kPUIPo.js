...
`, bf = (n, e = {}) => {
  n.config(async (t) => {
    ...
    if (!i) {
      const { languages: s } = await import("./index-BWk4hHcn.js");
      i = s;
    }
    if (!r) {
      const { oneDark: s } = await import("./index-B0dt5zln.js");
      r = s;
    }
    t.update(Zs.key, (s) => {
      var o;
