...
@Component({
  selector: 'app-rules',
  templateUrl: './good-rules.component.html',
  styleUrls: ['./good-rules.component.scss']
})
export class GoodRulesComponent implements OnInit {

  constructor(
    private dialogRef: MatDialogRef<GoodRulesComponent>,
