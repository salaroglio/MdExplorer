    ...
    return {
        ...
        closeBundle: function () {
            ...
            if (fs.existsSync(mainCssSource)) {
                ...
                console.log("[vite-plugin-copy-css] Copied ".concat(mainCssSource, " to dist/css/milkdown-all.css"));
                // For very-simple-test.html convenience (if served from root)
                fs.copyFileSync(mainCssSource, 'milkdown-all.css');
                console.log("[vite-plugin-copy-css] Copied ".concat(mainCssSource, " to project root/milkdown-all.css"));
            }
            else {
                console.warn("[vite-plugin-copy-css] Main CSS file ".concat(mainCssSource, " not found."));
            }
